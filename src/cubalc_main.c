...
int main(int argc, char **argv) {
  ...
  if (strcmp(cmd, "selftest") == 0 || strcmp(cmd, "smoke") == 0 ||
    ...
    static const struct {
      ...
      {"sys_parsems", "programs/proof/847_sys_parsems.cubalc", "SYS PARSEMS/DURATION human duration to ms"},
  ...
  if (strcmp(cmd, "forms") == 0 || strcmp(cmd, "ops") == 0 ||
    ...
    static const struct { const char *name; const char *plane; const char *hint; } forms[] = {
      ...
      {"SYS PARSEMS", "host", "SYS PARSEMS|DURATION|TOMS [str] — 5s/2m/1h → ms"},
      ...
      {"SYS WAITFILE", "host", "SYS WAITFILE|WAITPATH path [ms] — poll until path exists"},
  ...
  if (strcmp(cmd, "examples") == 0 || strcmp(cmd, "example") == 0 ||
    ...
    static const struct {
      ...
      {"programs/proof/847_sys_parsems.cubalc", "sys_parsems",
       "SYS PARSEMS/DURATION human duration to ms"},
...
{"SYS ISROOT", "host", "SYS ISROOT|AMROOT euid==0 privilege probe"},
      ...
      {"SYS WAITFILE", "host", "SYS WAITFILE poll until path exists"},
      {"SYS WAITPATH", "host", "SYS WAITPATH alias of SYS WAITFILE"},
  ...
  if (strcmp(cmd, "search") == 0 || strcmp(cmd, "find") == 0 ||
    ...
    static const struct { const char *name; const char *plane; const char *hint; } forms[] = {
      ...
      {"SYS WAITFILE", "host", "SYS WAITFILE|WAITPATH path [ms] poll until exists"},
      {"SYS WAITPATH", "host", "SYS WAITPATH alias of SYS WAITFILE"},
...
{"SYS ISROOT", "host", "SYS ISROOT|AMROOT euid==0 privilege probe"},
    ...
    static const struct { const char *path; const char *tag; const char *hint; } examples[] = {
      ...
      {"programs/proof/847_sys_parsems.cubalc", "sys_parsems", "SYS PARSEMS/DURATION human duration to ms"},
