...
int main(int argc, char **argv) {
  ...
  if (strcmp(cmd, "selftest") == 0 || strcmp(cmd, "smoke") == 0 ||
    ...
    static const struct {
      ...
      {"require_bin", "programs/proof/810_require_bin.cubalc", "REQUIRE BIN/SYS WHICHBIN PATH tool gates"},
    };
  ...
  if (strcmp(cmd, "examples") == 0 || strcmp(cmd, "example") == 0 ||
    ...
    static const struct {
      ...
      {"programs/proof/810_require_bin.cubalc", "require_bin",
       "REQUIRE BIN/SYS WHICHBIN PATH tool gates"},
  ...
  if (strcmp(cmd, "search") == 0 || strcmp(cmd, "find") == 0 ||
    ...
    static const struct { const char *path; const char *tag; const char *hint; } examples[] = {
      ...
      {"programs/proof/810_require_bin.cubalc", "require_bin", "REQUIRE BIN/SYS WHICHBIN PATH tool gates"},
