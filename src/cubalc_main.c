...
int main(int argc, char **argv) {
  ...
  if (strcmp(cmd, "selftest") == 0 || strcmp(cmd, "smoke") == 0 ||
    ...
    static const struct {
      ...
      {"life_engine", "programs/proof/864_life_engine_division.cubalc", "COP life engine cell division mitosis demo"},
...
{"SYS ISROOT", "host", "SYS ISROOT|AMROOT euid==0 privilege probe"},
    ...
    static const struct { const char *path; const char *tag; const char *hint; } examples[] = {
      ...
      {"programs/proof/864_life_engine_division.cubalc", "life_engine", "COP life engine cell division mitosis demo"},
