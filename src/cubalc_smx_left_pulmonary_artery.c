 ...
 * Proof: programs/proof/88_smx_left_pulmonary_artery.cubalc · 1823_smx_mesh_left_pulmonary_artery_life.cubalc
...
const char *cubalc_smx_left_pulmonary_artery_ship(void) {
  return "1823_smx_mesh_left_pulmonary_artery_life";
}
