 ...
 * Proof: programs/proof/99_smx_central_retinal.cubalc · 1844_smx_mesh_central_retinal_life.cubalc
 * Energy path: ophthalmic artery origin → central retinal artery takeoff → optic nerve sheath
 * transit → lamina cribrosa pierce → inner retinal life-force join · central retinal mesh seal.
 * Pure C. No SYS glue.
 */
#include <string.h>
