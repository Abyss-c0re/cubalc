 ...
 * Proof: programs/proof/99_smx_posterior_ciliary.cubalc · 1845_smx_mesh_posterior_ciliary_life.cubalc
 * Energy path: ophthalmic artery origin → posterior ciliary artery takeoff → scleral canal pierce →
 * choroidal capillary bed → outer retinal / photoreceptor life-force seal · posterior ciliary mesh.
 * Pure C. No SYS glue.
 */
#include <string.h>
