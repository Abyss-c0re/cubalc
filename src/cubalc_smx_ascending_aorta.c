 ...
 * Energy path: aortic valve leaflets → ascending aorta root / sinuses of Valsalva →
 * aortic arch approach → systemic free-energy readiness (oxygenated trunk conduit seal).
 * Pure C. No SYS glue.
 */
#include <string.h>
