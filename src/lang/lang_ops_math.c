...
int cubalc_lang_ops_math(VM *vm, Lex *L){
  ...
  /* digit-8 stack imm 4-bit field ordered-cmp: SLT4N · SGT4N · SLTE4N
   * (nibble ladder of SLT8N/SGT8N/SLTE8N; unsigned predicates after SEQ4N/SNE4N) */
  if (kw(&L->cur,"SLT4N")||kw(&L->cur,"STACKLT4N")||kw(&L->cur,"LT4N")||
      kw(&L->cur,"SCMPLT4N")||kw(&L->cur,"SLTNIBN")||kw(&L->cur,"SLT4IMM")){
    /* SLT4N field n — nibble n of TOS = (nib < field) ? 1 : 0; n clamped 0..15 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SGT4N")||kw(&L->cur,"STACKGT4N")||kw(&L->cur,"GT4N")||
      kw(&L->cur,"SCMPGT4N")||kw(&L->cur,"SGTNIBN")||kw(&L->cur,"SGT4IMM")){
    /* SGT4N field n — nibble n of TOS = (nib > field) ? 1 : 0; n clamped 0..15 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SLTE4N")||kw(&L->cur,"STACKLTE4N")||kw(&L->cur,"LTE4N")||
      kw(&L->cur,"SCMPLE4N")||kw(&L->cur,"SLEQ4N")||kw(&L->cur,"SLTENIBN")||
      kw(&L->cur,"SLTE4IMM")){
    /* SLTE4N field n — nibble n of TOS = (nib <= field) ? 1 : 0; n clamped 0..15 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-5 stack imm 4-bit field signed ordered-cmp: SLTS4N · SGTS4N · SLTES4N · SGTES4N
   * (signed int4 plane after unsigned SLT/SGT/SLTE/SGTE; nibble as -8..7) */
  if (kw(&L->cur,"SLTS4N")||kw(&L->cur,"STACKLTS4N")||kw(&L->cur,"LTS4N")||
      kw(&L->cur,"SCMPLTS4N")||kw(&L->cur,"SLTSSIGN4N")||kw(&L->cur,"SLTS4IMM")){
    /* SLTS4N field n — nibble n = (int4(nib) < int4(field)) ? 1 : 0; n clamped 0..15 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SGTS4N")||kw(&L->cur,"STACKGTS4N")||kw(&L->cur,"GTS4N")||
      kw(&L->cur,"SCMPGTS4N")||kw(&L->cur,"SGTSSIGN4N")||kw(&L->cur,"SGTS4IMM")){
    /* SGTS4N field n — nibble n = (int4(nib) > int4(field)) ? 1 : 0; n clamped 0..15 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SLTES4N")||kw(&L->cur,"STACKLTES4N")||kw(&L->cur,"LTES4N")||
      kw(&L->cur,"SCMPLES4N")||kw(&L->cur,"SLEQS4N")||kw(&L->cur,"SLTES4IMM")){
    /* SLTES4N field n — nibble n = (int4(nib) <= int4(field)) ? 1 : 0; n clamped 0..15 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SGTES4N")||kw(&L->cur,"STACKGTES4N")||kw(&L->cur,"GTES4N")||
      kw(&L->cur,"SCMPGES4N")||kw(&L->cur,"SGEQS4N")||kw(&L->cur,"SGTES4IMM")){
    /* SGTES4N field n — nibble n = (int4(nib) >= int4(field)) ? 1 : 0; n clamped 0..15 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-3 stack imm 4-bit field signed WITHIN: SWITHINS4N (nibble ladder; completes WITHIN plane) */
  if (kw(&L->cur,"SWITHINS4N")||kw(&L->cur,"STACKWITHINS4N")||kw(&L->cur,"WITHINS4N")||
      kw(&L->cur,"SWITHINSIGN4N")||kw(&L->cur,"SWITHINS4IMM")||kw(&L->cur,"SINTERVALS4N")){
    /* SWITHINS4N lo hi n — nibble n = (lo <= int4(nib) < hi) ? 1 : 0; n 0..15; no swap */
    lex_next(L);
    long lo = parse_expr(vm,L);
    long hi = parse_expr(vm,L);
    long n = parse_expr(vm,L);
  ...
  /* digit-7 stack imm 4-bit field signed signum: SSIGN4N (nibble ladder; completes field signum all widths) */
  if (kw(&L->cur,"SSIGN4N")||kw(&L->cur,"STACKSIGN4N")||kw(&L->cur,"SIGN4N")||
      kw(&L->cur,"SSIGNUM4N")||kw(&L->cur,"SGN4N")||kw(&L->cur,"SSIGN4IMM")){
    /* SSIGN4N n — nibble n = sgn(int4): +1 / 0 / 0xF(-1); n 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long sh = (unsigned long)(n * 4);
    long v = (long)((base >> sh) & 0xFul); if (v & 0x8) v -= 16;
    unsigned long w = (v > 0) ? 1ul : ((v < 0) ? 0xFul : 0ul);
    long r = (long)((base & ~(0xFul << sh)) | (w << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  /* digit-7 stack imm 4-bit field zero-eq: S0EQ4N (nibble ladder; completes field zero-eq all widths) */
  if (kw(&L->cur,"S0EQ4N")||kw(&L->cur,"STACK0EQ4N")||kw(&L->cur,"SZ4N")||
      kw(&L->cur,"SEQZ4N")||kw(&L->cur,"SISZERO4N")||kw(&L->cur,"S0EQ4IMM")){
    /* S0EQ4N n — nibble n = (nib == 0) ? 1 : 0; n 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-7 stack imm 4-bit field signed LT0: S0LT4N (nibble ladder; completes field signed LT0 all widths) */
  if (kw(&L->cur,"S0LT4N")||kw(&L->cur,"STACK0LT4N")||kw(&L->cur,"SLT04N")||
      kw(&L->cur,"SNEGZ4N")||kw(&L->cur,"SISNEG4N")||kw(&L->cur,"S0LT4IMM")){
    /* S0LT4N n — nibble n = (int4(nib) < 0) ? 1 : 0; n 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-4 stack imm 4-bit field signed LE0: S0LE4N (nibble ladder; completes field signed LE0 all widths) */
  if (kw(&L->cur,"S0LE4N")||kw(&L->cur,"STACK0LE4N")||kw(&L->cur,"SLE04N")||
      kw(&L->cur,"SNONPOS4N")||kw(&L->cur,"SISNONPOS4N")||kw(&L->cur,"S0LE4IMM")){
    /* S0LE4N n — nibble n = (int4(nib) <= 0) ? 1 : 0; n 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-3 stack imm 4-bit field signed GE0: S0GE4N (nibble ladder; completes field signed GE0 all widths) */
  if (kw(&L->cur,"S0GE4N")||kw(&L->cur,"STACK0GE4N")||kw(&L->cur,"SGE04N")||
      kw(&L->cur,"SNONNEG4N")||kw(&L->cur,"SISNONNEG4N")||kw(&L->cur,"S0GE4IMM")){
    /* S0GE4N n — nibble n = (int4(nib) >= 0) ? 1 : 0; n 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-4 stack imm 8-bit field ordered-cmp: SLT8N · SGT8N · SLTE8N
   * (byte ladder of SLT16N/SGT16N/SLTE16N; unsigned predicates after SEQ8N/SNE8N) */
  if (kw(&L->cur,"SLT8N")||kw(&L->cur,"STACKLT8N")||kw(&L->cur,"LT8N")||
      kw(&L->cur,"SCMPLT8N")||kw(&L->cur,"SLTBYTEN")||kw(&L->cur,"SLT8IMM")){
    /* SLT8N field n — byte n of TOS = (b < field) ? 1 : 0; n clamped 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SGT8N")||kw(&L->cur,"STACKGT8N")||kw(&L->cur,"GT8N")||
      kw(&L->cur,"SCMPGT8N")||kw(&L->cur,"SGTBYTEN")||kw(&L->cur,"SGT8IMM")){
    /* SGT8N field n — byte n of TOS = (b > field) ? 1 : 0; n clamped 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SLTE8N")||kw(&L->cur,"STACKLTE8N")||kw(&L->cur,"LTE8N")||
      kw(&L->cur,"SCMPLE8N")||kw(&L->cur,"SLEQ8N")||kw(&L->cur,"SLTEBYTEN")||
      kw(&L->cur,"SLTE8IMM")){
    /* SLTE8N field n — byte n of TOS = (b <= field) ? 1 : 0; n clamped 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-6 stack imm 8-bit field GTE: SGTE8N (ladder after SLTE8N) */
  if (kw(&L->cur,"SGTE8N")||kw(&L->cur,"STACKGTE8N")||kw(&L->cur,"GTE8N")||
      kw(&L->cur,"SCMPGE8N")||kw(&L->cur,"SGEQ8N")||kw(&L->cur,"SGTEBYTEN")||
      kw(&L->cur,"SGTE8IMM")){
    /* SGTE8N field n — byte n of TOS = (b >= field) ? 1 : 0; n clamped 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-4 stack imm 8-bit field signed ordered-cmp: SLTS8N · SGTS8N · SLTES8N · SGTES8N
   * (byte ladder of SLTS4N plane; signed int8 after unsigned SLT/SGT/SLTE/SGTE8N) */
  if (kw(&L->cur,"SLTS8N")||kw(&L->cur,"STACKLTS8N")||kw(&L->cur,"LTS8N")||
      kw(&L->cur,"SCMPLTS8N")||kw(&L->cur,"SLTSSIGN8N")||kw(&L->cur,"SLTS8IMM")){
    /* SLTS8N field n — byte n = (int8(b) < int8(field)) ? 1 : 0; n clamped 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SGTS8N")||kw(&L->cur,"STACKGTS8N")||kw(&L->cur,"GTS8N")||
      kw(&L->cur,"SCMPGTS8N")||kw(&L->cur,"SGTSSIGN8N")||kw(&L->cur,"SGTS8IMM")){
    /* SGTS8N field n — byte n = (int8(b) > int8(field)) ? 1 : 0; n clamped 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SLTES8N")||kw(&L->cur,"STACKLTES8N")||kw(&L->cur,"LTES8N")||
      kw(&L->cur,"SCMPLES8N")||kw(&L->cur,"SLEQS8N")||kw(&L->cur,"SLTES8IMM")){
    /* SLTES8N field n — byte n = (int8(b) <= int8(field)) ? 1 : 0; n clamped 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SGTES8N")||kw(&L->cur,"STACKGTES8N")||kw(&L->cur,"GTES8N")||
      kw(&L->cur,"SCMPGES8N")||kw(&L->cur,"SGEQS8N")||kw(&L->cur,"SGTES8IMM")){
    /* SGTES8N field n — byte n = (int8(b) >= int8(field)) ? 1 : 0; n clamped 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-2 stack imm 8-bit field signed min/max: SMINS8N · SMAXS8N
   * (byte ladder of SMINS16N plane; signed select after SLTS8N) */
  if (kw(&L->cur,"SMINS8N")||kw(&L->cur,"STACKMINS8N")||kw(&L->cur,"MINS8N")||
      kw(&L->cur,"SMINSIGN8N")||kw(&L->cur,"SMINS8IMM")||kw(&L->cur,"SMINSI8N")){
    /* SMINS8N field n — byte n = min_signed(int8(b), int8(field)); n 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    if (f & 0x80) f -= 256;
    long m = (v < f) ? v : f;
    unsigned long w = (unsigned long)m & 0xFFul;
    long r = (long)((base & ~(0xFFul << sh)) | (w << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SMAXS8N")||kw(&L->cur,"STACKMAXS8N")||kw(&L->cur,"MAXS8N")||
      kw(&L->cur,"SMAXSIGN8N")||kw(&L->cur,"SMAXS8IMM")||kw(&L->cur,"SMAXSI8N")){
    /* SMAXS8N field n — byte n = max_signed(int8(b), int8(field)); n 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-3 stack imm 8-bit field signed WITHIN: SWITHINS8N (byte ladder of SWITHINS16N) */
  if (kw(&L->cur,"SWITHINS8N")||kw(&L->cur,"STACKWITHINS8N")||kw(&L->cur,"WITHINS8N")||
      kw(&L->cur,"SWITHINSIGN8N")||kw(&L->cur,"SWITHINS8IMM")||kw(&L->cur,"SINTERVALS8N")){
    /* SWITHINS8N lo hi n — byte n = (lo <= int8(b) < hi) ? 1 : 0; n 0..7; no swap */
    lex_next(L);
    long lo = parse_expr(vm,L);
    long hi = parse_expr(vm,L);
    long n = parse_expr(vm,L);
  ...
  /* digit-7 stack imm 8-bit field signed signum: SSIGN8N (byte ladder of SSIGN16N) */
  if (kw(&L->cur,"SSIGN8N")||kw(&L->cur,"STACKSIGN8N")||kw(&L->cur,"SIGN8N")||
      kw(&L->cur,"SSIGNUM8N")||kw(&L->cur,"SGN8N")||kw(&L->cur,"SSIGN8IMM")){
    /* SSIGN8N n — byte n = sgn(int8): +1 / 0 / 0xFF(-1); n 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long sh = (unsigned long)(n * 8);
    long v = (long)((base >> sh) & 0xFFul); if (v & 0x80) v -= 256;
    unsigned long w = (v > 0) ? 1ul : ((v < 0) ? 0xFFul : 0ul);
    long r = (long)((base & ~(0xFFul << sh)) | (w << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  /* digit-7 stack imm 8-bit field zero-eq: S0EQ8N (byte ladder of S0EQ16N) */
  if (kw(&L->cur,"S0EQ8N")||kw(&L->cur,"STACK0EQ8N")||kw(&L->cur,"SZ8N")||
      kw(&L->cur,"SEQZ8N")||kw(&L->cur,"SISZERO8N")||kw(&L->cur,"S0EQ8IMM")){
    /* S0EQ8N n — byte n = (b == 0) ? 1 : 0; n 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-7 stack imm 8-bit field signed LT0: S0LT8N (byte ladder of S0LT16N) */
  if (kw(&L->cur,"S0LT8N")||kw(&L->cur,"STACK0LT8N")||kw(&L->cur,"SLT08N")||
      kw(&L->cur,"SNEGZ8N")||kw(&L->cur,"SISNEG8N")||kw(&L->cur,"S0LT8IMM")){
    /* S0LT8N n — byte n = (int8(b) < 0) ? 1 : 0; n 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-4 stack imm 8-bit field signed LE0: S0LE8N (byte ladder of S0LE16N; completes field signed LE0 all widths) */
  if (kw(&L->cur,"S0LE8N")||kw(&L->cur,"STACK0LE8N")||kw(&L->cur,"SLE08N")||
      kw(&L->cur,"SNONPOS8N")||kw(&L->cur,"SISNONPOS8N")||kw(&L->cur,"S0LE8IMM")){
    /* S0LE8N n — byte n = (int8(b) <= 0) ? 1 : 0; n 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-3 stack imm 8-bit field signed GE0: S0GE8N (byte ladder of S0GE16N; completes field signed GE0 all widths) */
  if (kw(&L->cur,"S0GE8N")||kw(&L->cur,"STACK0GE8N")||kw(&L->cur,"SGE08N")||
      kw(&L->cur,"SNONNEG8N")||kw(&L->cur,"SISNONNEG8N")||kw(&L->cur,"S0GE8IMM")){
    /* S0GE8N n — byte n = (int8(b) >= 0) ? 1 : 0; n 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-9 stack imm 8-bit field zeros+signed: SCLZ8N · SCTZ8N · SNEG8N
   * (byte ladder of SCLZ4N/SCTZ4N/SNEG4N; stack dual of DCLZ8N plane after SPARITY8N) */
  if (kw(&L->cur,"SCLZ8N")||kw(&L->cur,"STACKCLZ8N")||kw(&L->cur,"CLZ8N")||
      kw(&L->cur,"SNLZ8N")||kw(&L->cur,"SCLZBYTEN")||kw(&L->cur,"SBYTECLZN")){
    /* SCLZ8N n — byte n of TOS = clz8(byte); 0 → 8; n clamped 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long base = (unsigned long)vm->stack[vm->sp - 1];
    unsigned long sh = (unsigned long)(n * 8);
    unsigned int w = (unsigned int)((base >> sh) & 0xFFul);
    unsigned long cz = 0;
    if (w == 0) cz = 8;
    else {
      for (int b = 7; b >= 0; b--){
    ...
    long r = (long)((base & ~(0xFFul << sh)) | ((cz & 0xFFul) << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SCTZ8N")||kw(&L->cur,"STACKCTZ8N")||kw(&L->cur,"CTZ8N")||
      kw(&L->cur,"SNTZ8N")||kw(&L->cur,"SCTZBYTEN")||kw(&L->cur,"SBYTECTZN")){
    /* SCTZ8N n — byte n of TOS = ctz8(byte); 0 → 8; n clamped 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long r = (long)((base & ~(0xFFul << sh)) | ((tz & 0xFFul) << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SNEG8N")||kw(&L->cur,"STACKNEG8N")||kw(&L->cur,"NEG8N")||
      kw(&L->cur,"SINEG8N")||kw(&L->cur,"SNEGBYTEN")||kw(&L->cur,"SBYTENEGN")){
    /* SNEG8N n — byte n of TOS = -(int8) as uint8; min int8 -128 stays 0x80; n clamped 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long va = (long)((base >> sh) & 0xFFul);
    if (va & 0x80) va -= 256;
    long nr = (va == -128L) ? -128L : -va;
    unsigned long nv = (unsigned long)(nr & 0xFF);
    long r = (long)((base & ~(0xFFul << sh)) | (nv << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  ...
  /* digit-0 stack imm 8-bit field shift: SSHL8N · SSHR8N · SSAR8N
   * (byte ladder of SSHL4N/SSHR4N/SSAR4N; stack dual of DSHL8N; complete stack 8n unary plane) */
  if (kw(&L->cur,"SSHL8N")||kw(&L->cur,"STACKSHL8N")||kw(&L->cur,"SHL8N")||
      kw(&L->cur,"SLSH8N")||kw(&L->cur,"SSHLBYTEN")||kw(&L->cur,"SSHIFTBYTEL")){
    /* SSHL8N k n — byte n of TOS = (uint8)<<k (k>=8 → 0); n clamped 0..7 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long sh = (unsigned long)(n * 8);
    unsigned long w = (base >> sh) & 0xFFul;
    unsigned long nw = (kk >= 8) ? 0ul : ((w << (unsigned)kk) & 0xFFul);
    long r = (long)((base & ~(0xFFul << sh)) | (nw << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SSHR8N")||kw(&L->cur,"STACKSHR8N")||kw(&L->cur,"SHR8N")||
      kw(&L->cur,"SLSHR8N")||kw(&L->cur,"SSHRBYTEN")||kw(&L->cur,"SSHIFTBYTER")){
    /* SSHR8N k n — byte n of TOS = (uint8)>>k logical (k>=8 → 0); n clamped 0..7 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long sh = (unsigned long)(n * 8);
    unsigned long w = (base >> sh) & 0xFFul;
    unsigned long nw = (kk >= 8) ? 0ul : (w >> (unsigned)kk);
    long r = (long)((base & ~(0xFFul << sh)) | (nw << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SSAR8N")||kw(&L->cur,"STACKSAR8N")||kw(&L->cur,"SAR8N")||
      kw(&L->cur,"SASHR8N")||kw(&L->cur,"SSARBYTEN")||kw(&L->cur,"SSARSHIFTBYTE")){
    /* SSAR8N k n — byte n of TOS = (int8)>>k arithmetic (k>=8 → all sign); n clamped 0..7 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    if (va & 0x80) va -= 256; /* sign-extend int8 */
    long shifted;
    if (kk >= 8) shifted = (va < 0) ? -1L : 0L;
    else shifted = va >> kk;
    unsigned long nw = (unsigned long)shifted & 0xFFul;
    long r = (long)((base & ~(0xFFul << sh)) | (nw << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  ...
  if (kw(&L->cur,"SADD16N")||kw(&L->cur,"STACKADD16N")||kw(&L->cur,"ADD16N")||
      kw(&L->cur,"SADDWORDN")||kw(&L->cur,"SADD16IMM")||kw(&L->cur,"SINC16N")){
    /* SADD16N field n — halfword n of TOS = (hw + field) & 0xFFFF; n clamped 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SSUB16N")||kw(&L->cur,"STACKSUB16N")||kw(&L->cur,"SUB16N")||
      kw(&L->cur,"SSUBWORDN")||kw(&L->cur,"SSUB16IMM")||kw(&L->cur,"SDEC16N")){
    /* SSUB16N field n — halfword n of TOS = (hw - field) & 0xFFFF; n clamped 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SMUL16N")||kw(&L->cur,"STACKMUL16N")||kw(&L->cur,"MUL16N")||
      kw(&L->cur,"SMULWORDN")||kw(&L->cur,"SMUL16IMM")||kw(&L->cur,"STIMES16N")){
    /* SMUL16N field n — halfword n of TOS = (hw * field) & 0xFFFF; n clamped 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-7 stack imm 16-bit field div/mod/min: SDIV16N · SMOD16N · SMIN16N
   * (complete uint16 field ALU after SADD16N/SSUB16N/SMUL16N; field 0 → div/mod 0) */
  if (kw(&L->cur,"SDIV16N")||kw(&L->cur,"STACKDIV16N")||kw(&L->cur,"DIV16N")||
      kw(&L->cur,"SDIVWORDN")||kw(&L->cur,"SDIV16IMM")||kw(&L->cur,"SQUO16N")){
    /* SDIV16N field n — halfword n of TOS = hw / field (field 0 → 0); n clamped 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long w = (f == 0) ? 0ul : (v / f);
    long r = (long)((base & ~(0xFFFFul << sh)) | ((w & 0xFFFFul) << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SMOD16N")||kw(&L->cur,"STACKMOD16N")||kw(&L->cur,"MOD16N")||
      kw(&L->cur,"SMODWORDN")||kw(&L->cur,"SMOD16IMM")||kw(&L->cur,"SREM16N")){
    /* SMOD16N field n — halfword n of TOS = hw % field (field 0 → 0); n clamped 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SMIN16N")||kw(&L->cur,"STACKMIN16N")||kw(&L->cur,"MIN16N")||
      kw(&L->cur,"SMINWORDN")||kw(&L->cur,"SMIN16IMM")||kw(&L->cur,"SLE16N")){
    /* SMIN16N field n — halfword n of TOS = min(hw, field); n clamped 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-4 stack imm 16-bit field ordered-cmp: SLT16N · SGT16N · SLTE16N
   * (halfword ladder of SLT32N/SGT32N/SLTE32N; unsigned predicates after SEQ16N/SNE16N) */
  if (kw(&L->cur,"SLT16N")||kw(&L->cur,"STACKLT16N")||kw(&L->cur,"LT16N")||
      kw(&L->cur,"SCMPLT16N")||kw(&L->cur,"SLTWORDN")||kw(&L->cur,"SLT16IMM")){
    /* SLT16N field n — halfword n of TOS = (hw < field) ? 1 : 0; n clamped 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SGT16N")||kw(&L->cur,"STACKGT16N")||kw(&L->cur,"GT16N")||
      kw(&L->cur,"SCMPGT16N")||kw(&L->cur,"SGTWORDN")||kw(&L->cur,"SGT16IMM")){
    /* SGT16N field n — halfword n of TOS = (hw > field) ? 1 : 0; n clamped 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SLTE16N")||kw(&L->cur,"STACKLTE16N")||kw(&L->cur,"LTE16N")||
      kw(&L->cur,"SCMPLE16N")||kw(&L->cur,"SLEQ16N")||kw(&L->cur,"SLTEWORDN")||
      kw(&L->cur,"SLTE16IMM")){
    /* SLTE16N field n — halfword n of TOS = (hw <= field) ? 1 : 0; n clamped 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-6 stack imm 16-bit field GTE: SGTE16N (ladder after SLTE16N) */
  if (kw(&L->cur,"SGTE16N")||kw(&L->cur,"STACKGTE16N")||kw(&L->cur,"GTE16N")||
      kw(&L->cur,"SCMPGE16N")||kw(&L->cur,"SGEQ16N")||kw(&L->cur,"SGTEWORDN")||
      kw(&L->cur,"SGTE16IMM")){
    /* SGTE16N field n — halfword n of TOS = (hw >= field) ? 1 : 0; n clamped 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-7 stack imm 16-bit field signed clamp+between: SCLAMPS16N · SBETWEENS16N
   * (halfword ladder of SCLAMPS32N plane after SMINS16N/SMAXS16N) */
  if (kw(&L->cur,"SCLAMPS16N")||kw(&L->cur,"STACKCLAMPS16N")||kw(&L->cur,"CLAMPS16N")||
      kw(&L->cur,"SCLAMPSIGN16N")||kw(&L->cur,"SCLAMPS16IMM")||kw(&L->cur,"SBOUNDS16N")){
    /* SCLAMPS16N lo hi n — halfword n = clamp_signed(int16(hw),[lo,hi]); n 0..3 */
    lex_next(L);
    long lo = parse_expr(vm,L);
    long hi = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    ...
    if (v < slo) v = slo;
    if (v > shi) v = shi;
    unsigned long w = (unsigned long)v & 0xFFFFul;
    long r = (long)((base & ~(0xFFFFul << sh)) | (w << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SBETWEENS16N")||kw(&L->cur,"STACKBETWEENS16N")||kw(&L->cur,"BETWEENS16N")||
      kw(&L->cur,"SINRANGES16N")||kw(&L->cur,"SBETWEENS16IMM")||kw(&L->cur,"SINRANGESIGN16N")){
    /* SBETWEENS16N lo hi n — halfword n = (lo <= int16(hw) <= hi) ? 1 : 0; n 0..3 */
    lex_next(L);
    long lo = parse_expr(vm,L);
    long hi = parse_expr(vm,L);
    long n = parse_expr(vm,L);
  ...
  /* digit-0 stack imm 16-bit field signed signum: SSIGN16N (halfword ladder; field dual of SSIGN) */
  if (kw(&L->cur,"SSIGN16N")||kw(&L->cur,"STACKSIGN16N")||kw(&L->cur,"SIGN16N")||
      kw(&L->cur,"SSIGNUM16N")||kw(&L->cur,"SGN16N")||kw(&L->cur,"SSIGN16IMM")){
    /* SSIGN16N n — halfword n = sgn(int16): +1 / 0 / 0xFFFF(-1); n 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long sh = (unsigned long)(n * 16);
    long v = (long)((base >> sh) & 0xFFFFul); if (v & 0x8000) v -= 65536;
    unsigned long w = (v > 0) ? 1ul : ((v < 0) ? 0xFFFFul : 0ul);
    long r = (long)((base & ~(0xFFFFul << sh)) | (w << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  /* digit-4 stack imm 16-bit field zero-eq: S0EQ16N (halfword ladder of S0EQ32N; field dual of S0EQ/SZ) */
  if (kw(&L->cur,"S0EQ16N")||kw(&L->cur,"STACK0EQ16N")||kw(&L->cur,"SZ16N")||
      kw(&L->cur,"SEQZ16N")||kw(&L->cur,"SISZERO16N")||kw(&L->cur,"S0EQ16IMM")){
    /* S0EQ16N n — halfword n = (hw == 0) ? 1 : 0; n 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-1 stack imm 16-bit field nonzero: S0NE16N (halfword ladder of S0NE32N; field dual of S0NE/SNZ) */
  if (kw(&L->cur,"S0NE16N")||kw(&L->cur,"STACK0NE16N")||kw(&L->cur,"SNZ16N")||
      kw(&L->cur,"SNEZ16N")||kw(&L->cur,"SISNZ16N")||kw(&L->cur,"S0NE16IMM")){
    /* S0NE16N n — halfword n = (hw != 0) ? 1 : 0; n 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-8 stack imm 16-bit field signed LT0: S0LT16N (halfword ladder of S0LT32N; field dual of S0LT) */
  if (kw(&L->cur,"S0LT16N")||kw(&L->cur,"STACK0LT16N")||kw(&L->cur,"SLT016N")||
      kw(&L->cur,"SNEGZ16N")||kw(&L->cur,"SISNEG16N")||kw(&L->cur,"S0LT16IMM")){
    /* S0LT16N n — halfword n = (int16(hw) < 0) ? 1 : 0; n 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-4 stack imm 16-bit field signed LE0: S0LE16N (halfword ladder of S0LE32N; field dual of S0LE) */
  if (kw(&L->cur,"S0LE16N")||kw(&L->cur,"STACK0LE16N")||kw(&L->cur,"SLE016N")||
      kw(&L->cur,"SNONPOS16N")||kw(&L->cur,"SISNONPOS16N")||kw(&L->cur,"S0LE16IMM")){
    /* S0LE16N n — halfword n = (int16(hw) <= 0) ? 1 : 0; n 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-1 stack imm 16-bit field signed GE0: S0GE16N (halfword ladder of S0GE32N; field dual of S0GE) */
  if (kw(&L->cur,"S0GE16N")||kw(&L->cur,"STACK0GE16N")||kw(&L->cur,"SGE016N")||
      kw(&L->cur,"SNONNEG16N")||kw(&L->cur,"SISNONNEG16N")||kw(&L->cur,"S0GE16IMM")){
    /* S0GE16N n — halfword n = (int16(hw) >= 0) ? 1 : 0; n 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  if (kw(&L->cur,"SABS16N")||kw(&L->cur,"STACKABS16N")||kw(&L->cur,"ABS16N")||
      kw(&L->cur,"SIABS16N")||kw(&L->cur,"SABSWORDN")||kw(&L->cur,"SWORDABSN")){
    /* SABS16N n — halfword n of TOS = abs(int16); min int16 -32768 → 0x8000; n clamped 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long ar = (va < 0) ? -va : va;
    /* min int16 -32768 → +32768 does not fit uint16; keep 0x8000 (same as SABS8N min path) */
    unsigned long nv = (unsigned long)(ar & 0xFFFF);
    long r = (long)((base & ~(0xFFFFul << sh)) | (nv << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SSEXT16N")||kw(&L->cur,"STACKSEXT16N")||kw(&L->cur,"SEXT16N")||
      kw(&L->cur,"SSIGNEXT16N")||kw(&L->cur,"SSEXTWORDN")||kw(&L->cur,"SWORDSEXTN")){
    /* SSEXT16N n — TOS = sign-extend halfword n of TOS to full width; n clamped 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  if (kw(&L->cur,"SZEXT16N")||kw(&L->cur,"STACKZEXT16N")||kw(&L->cur,"ZEXT16N")||
      kw(&L->cur,"SZEROEXT16N")||kw(&L->cur,"SZEXTWORDN")||kw(&L->cur,"SWORDZEXTN")){
    /* SZEXT16N n — TOS = zero-extend halfword n of TOS; n clamped 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long base = (unsigned long)vm->stack[vm->sp - 1];
    unsigned long sh = (unsigned long)(n * 16);
    long r = (long)((base >> sh) & 0xFFFFul);
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  /* digit-1 stack imm 16-bit field unary+rotate: SNOT16N · SROL16N · SROR16N
   * (halfword ladder of SNOT8N/SROL8N/SROR8N; stack dual of DNOT16N after SZEXT16N) */
  if (kw(&L->cur,"SNOT16N")||kw(&L->cur,"STACKNOT16N")||kw(&L->cur,"NOT16N")||
      kw(&L->cur,"SNOTWORDN")||kw(&L->cur,"SINV16N")||kw(&L->cur,"SINVERT16N")){
    /* SNOT16N n — halfword n of TOS = ~hw & 0xFFFF; n clamped 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long base = (unsigned long)vm->stack[vm->sp - 1];
    unsigned long sh = (unsigned long)(n * 16);
    unsigned long w = (~((base >> sh) & 0xFFFFul)) & 0xFFFFul;
    long r = (long)((base & ~(0xFFFFul << sh)) | (w << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SROL16N")||kw(&L->cur,"STACKROL16N")||kw(&L->cur,"ROL16N")||
      kw(&L->cur,"SROTL16N")||kw(&L->cur,"SROLWORDN")||kw(&L->cur,"SROTWORDL")){
    /* SROL16N k n — rotl16 halfword n of TOS by k&15; n clamped 0..3 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long rot = (kk == 0) ? w : (((w << (unsigned)kk) | (w >> (unsigned)(16 - kk))) & 0xFFFFul);
    long r = (long)((base & ~(0xFFFFul << sh)) | (rot << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SROR16N")||kw(&L->cur,"STACKROR16N")||kw(&L->cur,"ROR16N")||
      kw(&L->cur,"SROTR16N")||kw(&L->cur,"SRORWORDN")||kw(&L->cur,"SROTWORDR")){
    /* SROR16N k n — rotr16 halfword n of TOS by k&15; n clamped 0..3 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-1 stack imm 32-bit field unary+rotate: SNOT32N · SROL32N · SROR32N
   * (word ladder of SNOT16N/SROL16N/SROR16N; start stack 32n unary after SNAND32N plane) */
  if (kw(&L->cur,"SNOT32N")||kw(&L->cur,"STACKNOT32N")||kw(&L->cur,"NOT32N")||
      kw(&L->cur,"SNOTDWN")||kw(&L->cur,"SINV32N")||kw(&L->cur,"SINVERT32N")){
    /* SNOT32N n — word n of TOS = ~w & 0xFFFFFFFF; n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long base = (unsigned long)vm->stack[vm->sp - 1];
    unsigned long sh = (unsigned long)(n * 32);
    unsigned long w = (~((base >> sh) & 0xFFFFFFFFul)) & 0xFFFFFFFFul;
    long r = (long)((base & ~(0xFFFFFFFFul << sh)) | (w << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SROL32N")||kw(&L->cur,"STACKROL32N")||kw(&L->cur,"ROL32N")||
      kw(&L->cur,"SROTL32N")||kw(&L->cur,"SROLDWN")||kw(&L->cur,"SROTDWL")){
    /* SROL32N k n — rotl32 word n of TOS by k&31; n clamped 0..1 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long base = (unsigned long)vm->stack[vm->sp - 1];
    unsigned long sh = (unsigned long)(n * 32);
    unsigned long w = (base >> sh) & 0xFFFFFFFFul;
    unsigned long rot = (kk == 0) ? w : (((w << (unsigned)kk) | (w >> (unsigned)(32 - kk))) & 0xFFFFFFFFul);
    long r = (long)((base & ~(0xFFFFFFFFul << sh)) | (rot << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SROR32N")||kw(&L->cur,"STACKROR32N")||kw(&L->cur,"ROR32N")||
      kw(&L->cur,"SROTR32N")||kw(&L->cur,"SRORDWN")||kw(&L->cur,"SROTDWR")){
    /* SROR32N k n — rotr32 word n of TOS by k&31; n clamped 0..1 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-0 stack imm 32-bit field shift: SSHL32N · SSHR32N · SSAR32N
   * (word ladder of SSHL16N/SSHR16N/SSAR16N; stack 32n shift after SNOT32N/SROL32N) */
  if (kw(&L->cur,"SSHL32N")||kw(&L->cur,"STACKSHL32N")||kw(&L->cur,"SHL32N")||
      kw(&L->cur,"SLSH32N")||kw(&L->cur,"SSHLDWN")||kw(&L->cur,"SSHIFTDWL")){
    /* SSHL32N k n — word n of TOS = (uint32)<<k (k>=32 → 0); n clamped 0..1 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long sh = (unsigned long)(n * 32);
    unsigned long w = (base >> sh) & 0xFFFFFFFFul;
    unsigned long nw = (kk >= 32) ? 0ul : ((w << (unsigned)kk) & 0xFFFFFFFFul);
    long r = (long)((base & ~(0xFFFFFFFFul << sh)) | (nw << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SSHR32N")||kw(&L->cur,"STACKSHR32N")||kw(&L->cur,"SHR32N")||
      kw(&L->cur,"SLSHR32N")||kw(&L->cur,"SSHRDWN")||kw(&L->cur,"SSHIFTDWR")){
    /* SSHR32N k n — word n of TOS = (uint32)>>k logical (k>=32 → 0); n clamped 0..1 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long sh = (unsigned long)(n * 32);
    unsigned long w = (base >> sh) & 0xFFFFFFFFul;
    unsigned long nw = (kk >= 32) ? 0ul : (w >> (unsigned)kk);
    long r = (long)((base & ~(0xFFFFFFFFul << sh)) | (nw << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SSAR32N")||kw(&L->cur,"STACKSAR32N")||kw(&L->cur,"SAR32N")||
      kw(&L->cur,"SASHR32N")||kw(&L->cur,"SSARDWN")||kw(&L->cur,"SSARSHIFTDW")){
    /* SSAR32N k n — word n of TOS = (int32)>>k arithmetic (k>=32 → all sign); n clamped 0..1 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    long shifted;
    if (kk >= 32) shifted = (va < 0) ? -1L : 0L;
    else shifted = va >> kk;
    unsigned long nw = (unsigned long)shifted & 0xFFFFFFFFul;
    long r = (long)((base & ~(0xFFFFFFFFul << sh)) | (nw << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  /* digit-3 stack imm 32-bit field zeros+signed: SCLZ32N · SCTZ32N · SNEG32N
   * (word ladder of SCLZ16N/SCTZ16N/SNEG16N; complete stack 32n unary after SSHL32N) */
  if (kw(&L->cur,"SCLZ32N")||kw(&L->cur,"STACKCLZ32N")||kw(&L->cur,"CLZ32N")||
      kw(&L->cur,"SNLZ32N")||kw(&L->cur,"SCLZDWN")||kw(&L->cur,"SDWCLZN")){
    /* SCLZ32N n — word n of TOS = clz32(w); 0 → 32; n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long base = (unsigned long)vm->stack[vm->sp - 1];
    unsigned long sh = (unsigned long)(n * 32);
    unsigned int w = (unsigned int)((base >> sh) & 0xFFFFFFFFul);
    unsigned long cz = 0;
    if (w == 0) cz = 32;
    else {
      for (int b = 31; b >= 0; b--){
    ...
    long r = (long)((base & ~(0xFFFFFFFFul << sh)) | ((cz & 0xFFFFFFFFul) << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SCTZ32N")||kw(&L->cur,"STACKCTZ32N")||kw(&L->cur,"CTZ32N")||
      kw(&L->cur,"SNTZ32N")||kw(&L->cur,"SCTZDWN")||kw(&L->cur,"SDWCTZN")){
    /* SCTZ32N n — word n of TOS = ctz32(w); 0 → 32; n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long r = (long)((base & ~(0xFFFFFFFFul << sh)) | ((tz & 0xFFFFFFFFul) << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SNEG32N")||kw(&L->cur,"STACKNEG32N")||kw(&L->cur,"NEG32N")||
      kw(&L->cur,"SINEG32N")||kw(&L->cur,"SNEGDWN")||kw(&L->cur,"SDWNEGN")){
    /* SNEG32N n — word n of TOS = -(int32) as uint32; min int32 stays 0x80000000; n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long nr = (va == -2147483648L) ? -2147483648L : -va;
    unsigned long nv = (unsigned long)(nr & 0xFFFFFFFFul);
  ...
  /* digit-5 stack imm 32-bit field metrics: SBITREV32N · SPOPCNT32N · SPARITY32N
   * (word ladder of SBITREV16N/SPOPCNT16N/SPARITY16N; metrics after SABS32N plane) */
  if (kw(&L->cur,"SBITREV32N")||kw(&L->cur,"STACKBITREV32N")||kw(&L->cur,"BITREV32N")||
      kw(&L->cur,"SBREV32N")||kw(&L->cur,"SREV32N")||kw(&L->cur,"SBITREVDWN")){
    /* SBITREV32N n — word n of TOS = bitrev32(w); n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long r = (long)((base & ~(0xFFFFFFFFul << sh)) | ((rv & 0xFFFFFFFFul) << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SPOPCNT32N")||kw(&L->cur,"STACKPOPCNT32N")||kw(&L->cur,"POPCNT32N")||
      kw(&L->cur,"SPCNT32N")||kw(&L->cur,"SPOPDWN")||kw(&L->cur,"SDWPOPN")){
    /* SPOPCNT32N n — word n of TOS = popcount(w); n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long pc = 0;
    while (w){ pc += (w & 1u); w >>= 1; }
    long r = (long)((base & ~(0xFFFFFFFFul << sh)) | ((pc & 0xFFFFFFFFul) << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SPARITY32N")||kw(&L->cur,"STACKPARITY32N")||kw(&L->cur,"PARITY32N")||
      kw(&L->cur,"SXORRED32N")||kw(&L->cur,"SPARITYDWN")||kw(&L->cur,"SDWPARN")){
    /* SPARITY32N n — word n of TOS = xor-reduce(w) in low bit; n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long pr = 0;
    while (w){ pr ^= (w & 1u); w >>= 1; }
    long r = (long)((base & ~(0xFFFFFFFFul << sh)) | (pr << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  /* digit-5 stack imm 32-bit field arith merge: SADD32N · SSUB32N · SMUL32N
   * (word ladder of SADD16N/SSUB16N/SMUL16N; wrap uint32 ALU after SPARITY32N metrics) */
  if (kw(&L->cur,"SADD32N")||kw(&L->cur,"STACKADD32N")||kw(&L->cur,"ADD32N")||
      kw(&L->cur,"SADDDWN")||kw(&L->cur,"SADD32IMM")||kw(&L->cur,"SINC32N")){
    /* SADD32N field n — word n of TOS = (w + field) & 0xFFFFFFFF; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SSUB32N")||kw(&L->cur,"STACKSUB32N")||kw(&L->cur,"SUB32N")||
      kw(&L->cur,"SSUBDWN")||kw(&L->cur,"SSUB32IMM")||kw(&L->cur,"SDEC32N")){
    /* SSUB32N field n — word n of TOS = (w - field) & 0xFFFFFFFF; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SMUL32N")||kw(&L->cur,"STACKMUL32N")||kw(&L->cur,"MUL32N")||
      kw(&L->cur,"SMULDWN")||kw(&L->cur,"SMUL32IMM")||kw(&L->cur,"STIMES32N")){
    /* SMUL32N field n — word n of TOS = (w * field) & 0xFFFFFFFF; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-7 stack imm 32-bit field div/mod/min: SDIV32N · SMOD32N · SMIN32N
   * (word ladder of SDIV16N/SMOD16N/SMIN16N; complete uint32 field ALU after SMUL32N) */
  if (kw(&L->cur,"SDIV32N")||kw(&L->cur,"STACKDIV32N")||kw(&L->cur,"DIV32N")||
      kw(&L->cur,"SDIVDWN")||kw(&L->cur,"SDIV32IMM")||kw(&L->cur,"SQUO32N")){
    /* SDIV32N field n — word n of TOS = w / field (field 0 → 0); n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long f = (unsigned long)field & 0xFFFFFFFFul;
    unsigned long sh = (unsigned long)(n * 32);
    unsigned long v = (base >> sh) & 0xFFFFFFFFul;
    unsigned long w = (f == 0) ? 0ul : (v / f);
    long r = (long)((base & ~(0xFFFFFFFFul << sh)) | ((w & 0xFFFFFFFFul) << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SMOD32N")||kw(&L->cur,"STACKMOD32N")||kw(&L->cur,"MOD32N")||
      kw(&L->cur,"SMODDWN")||kw(&L->cur,"SMOD32IMM")||kw(&L->cur,"SREM32N")){
    /* SMOD32N field n — word n of TOS = w % field (field 0 → 0); n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SMIN32N")||kw(&L->cur,"STACKMIN32N")||kw(&L->cur,"MIN32N")||
      kw(&L->cur,"SMINDWN")||kw(&L->cur,"SMIN32IMM")||kw(&L->cur,"SLE32N")){
    /* SMIN32N field n — word n of TOS = min(w, field) unsigned; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-6 stack imm 32-bit field max+eq: SMAX32N · SEQ32N · SNE32N
   * (word ladder of SMAX16N/SEQ16N/SNE16N; complete min/max + equality after SMIN32N) */
  if (kw(&L->cur,"SMAX32N")||kw(&L->cur,"STACKMAX32N")||kw(&L->cur,"MAX32N")||
      kw(&L->cur,"SMAXDWN")||kw(&L->cur,"SMAX32IMM")||kw(&L->cur,"SGE32N")){
    /* SMAX32N field n — word n of TOS = max(w, field) unsigned; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SEQ32N")||kw(&L->cur,"STACKEQ32N")||kw(&L->cur,"EQ32N")||
      kw(&L->cur,"SEQDWN")||kw(&L->cur,"SEQ32IMM")||kw(&L->cur,"SCMPEQ32N")){
    /* SEQ32N field n — word n of TOS = (w == field) ? 1 : 0; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SNE32N")||kw(&L->cur,"STACKNE32N")||kw(&L->cur,"NE32N")||
      kw(&L->cur,"SNEDWN")||kw(&L->cur,"SNE32IMM")||kw(&L->cur,"SCMPNE32N")){
    /* SNE32N field n — word n of TOS = (w != field) ? 1 : 0; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-1 stack imm 32-bit field ordered-cmp: SLT32N · SGT32N · SLTE32N
   * (unsigned predicates after SEQ32N/SNE32N; complete stack 32n field compare plane) */
  if (kw(&L->cur,"SLT32N")||kw(&L->cur,"STACKLT32N")||kw(&L->cur,"LT32N")||
      kw(&L->cur,"SCMPLT32N")||kw(&L->cur,"SLTDWN")||kw(&L->cur,"SLT32IMM")){
    /* SLT32N field n — word n of TOS = (w < field) ? 1 : 0; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SGT32N")||kw(&L->cur,"STACKGT32N")||kw(&L->cur,"GT32N")||
      kw(&L->cur,"SCMPGT32N")||kw(&L->cur,"SGTDWN")||kw(&L->cur,"SGT32IMM")){
    /* SGT32N field n — word n of TOS = (w > field) ? 1 : 0; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SLTE32N")||kw(&L->cur,"STACKLTE32N")||kw(&L->cur,"LTE32N")||
      kw(&L->cur,"SCMPLE32N")||kw(&L->cur,"SLTEDWN")||kw(&L->cur,"SLEQ32N")||
      kw(&L->cur,"SLTE32IMM")){
    /* SLTE32N field n — word n of TOS = (w <= field) ? 1 : 0; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-6 stack imm field GTE: SGTE32N (complete ordered plane after SLTE32N) */
  if (kw(&L->cur,"SGTE32N")||kw(&L->cur,"STACKGTE32N")||kw(&L->cur,"GTE32N")||
      kw(&L->cur,"SCMPGE32N")||kw(&L->cur,"SGEQ32N")||kw(&L->cur,"SGTEDWN")||
      kw(&L->cur,"SGTE32IMM")){
    /* SGTE32N field n — word n of TOS = (w >= field) ? 1 : 0; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-6 stack imm 32-bit field signed ordered-cmp: SLTS32N · SGTS32N · SLTES32N · SGTES32N
   * (word ladder of SLTS16N plane; signed int32 after unsigned SGTE32N) */
  if (kw(&L->cur,"SLTS32N")||kw(&L->cur,"STACKLTS32N")||kw(&L->cur,"LTS32N")||
      kw(&L->cur,"SCMPLTS32N")||kw(&L->cur,"SLTSSIGN32N")||kw(&L->cur,"SLTS32IMM")){
    /* SLTS32N field n — word n = (int32(w) < int32(field)) ? 1 : 0; n 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SGTS32N")||kw(&L->cur,"STACKGTS32N")||kw(&L->cur,"GTS32N")||
      kw(&L->cur,"SCMPGTS32N")||kw(&L->cur,"SGTSSIGN32N")||kw(&L->cur,"SGTS32IMM")){
    /* SGTS32N field n — word n = (int32(w) > int32(field)) ? 1 : 0; n 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SLTES32N")||kw(&L->cur,"STACKLTES32N")||kw(&L->cur,"LTES32N")||
      kw(&L->cur,"SCMPLES32N")||kw(&L->cur,"SLEQS32N")||kw(&L->cur,"SLTES32IMM")){
    /* SLTES32N field n — word n = (int32(w) <= int32(field)) ? 1 : 0; n 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"SGTES32N")||kw(&L->cur,"STACKGTES32N")||kw(&L->cur,"GTES32N")||
      kw(&L->cur,"SCMPGES32N")||kw(&L->cur,"SGEQS32N")||kw(&L->cur,"SGTES32IMM")){
    /* SGTES32N field n — word n = (int32(w) >= int32(field)) ? 1 : 0; n 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-9 stack imm 32-bit field signed clamp+between: SCLAMPS32N · SBETWEENS32N
   * (signed range plane after SMINS32N/SMAXS32N; field dual of SCLAMPN/SBETWEENN) */
  if (kw(&L->cur,"SCLAMPS32N")||kw(&L->cur,"STACKCLAMPS32N")||kw(&L->cur,"CLAMPS32N")||
      kw(&L->cur,"SCLAMPSIGN32N")||kw(&L->cur,"SCLAMPS32IMM")||kw(&L->cur,"SBOUNDS32N")){
    /* SCLAMPS32N lo hi n — word n = clamp_signed(int32(w),[lo,hi]); swap lo/hi if needed; n 0..1 */
    lex_next(L);
    long lo = parse_expr(vm,L);
    long hi = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    ...
    if (v < slo) v = slo;
    if (v > shi) v = shi;
    unsigned long w = (unsigned long)(unsigned int)v;
    long r = (long)((base & ~(0xFFFFFFFFul << sh)) | (w << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"SBETWEENS32N")||kw(&L->cur,"STACKBETWEENS32N")||kw(&L->cur,"BETWEENS32N")||
      kw(&L->cur,"SINRANGES32N")||kw(&L->cur,"SBETWEENS32IMM")||kw(&L->cur,"SINRANGESIGN32N")){
    /* SBETWEENS32N lo hi n — word n = (lo <= int32(w) <= hi) ? 1 : 0; swap lo/hi; n 0..1 */
    lex_next(L);
    long lo = parse_expr(vm,L);
    long hi = parse_expr(vm,L);
    long n = parse_expr(vm,L);
  ...
  /* digit-0 stack imm 32-bit field signed signum: SSIGN32N
   * (word ladder of SSIGN16N; field dual of SSIGN after signed WITHIN plane) */
  if (kw(&L->cur,"SSIGN32N")||kw(&L->cur,"STACKSIGN32N")||kw(&L->cur,"SIGN32N")||
      kw(&L->cur,"SSIGNUM32N")||kw(&L->cur,"SGN32N")||kw(&L->cur,"SSIGN32IMM")){
    /* SSIGN32N n — word n = sgn(int32): +1 / 0 / 0xFFFFFFFF(-1); n 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long sh = (unsigned long)(n * 32);
    long v = (long)(int)((unsigned int)((base >> sh) & 0xFFFFFFFFul));
    unsigned long w = (v > 0) ? 1ul : ((v < 0) ? 0xFFFFFFFFul : 0ul);
    long r = (long)((base & ~(0xFFFFFFFFul << sh)) | (w << sh));
    vm->stack[vm->sp - 1] = r;
    var_set_num(vm,"LAST_N",r); vm->last_n=r;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  /* digit-4 stack imm 32-bit field zero-eq: S0EQ32N
   * (word ladder of S0EQ16N; field dual of S0EQ/SZ after SSIGN plane) */
  if (kw(&L->cur,"S0EQ32N")||kw(&L->cur,"STACK0EQ32N")||kw(&L->cur,"SZ32N")||
      kw(&L->cur,"SEQZ32N")||kw(&L->cur,"SISZERO32N")||kw(&L->cur,"S0EQ32IMM")){
    /* S0EQ32N n — word n = (w == 0) ? 1 : 0; n 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-1 stack imm 32-bit field nonzero: S0NE32N
   * (word ladder of S0NE16N; field dual of S0NE/SNZ after S0EQ plane) */
  if (kw(&L->cur,"S0NE32N")||kw(&L->cur,"STACK0NE32N")||kw(&L->cur,"SNZ32N")||
      kw(&L->cur,"SNEZ32N")||kw(&L->cur,"SISNZ32N")||kw(&L->cur,"S0NE32IMM")){
    /* S0NE32N n — word n = (w != 0) ? 1 : 0; n 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-8 stack imm 32-bit field signed LT0: S0LT32N
   * (word ladder of S0LT16N; field dual of S0LT after S0EQ/S0NE plane) */
  if (kw(&L->cur,"S0LT32N")||kw(&L->cur,"STACK0LT32N")||kw(&L->cur,"SLT032N")||
      kw(&L->cur,"SNEGZ32N")||kw(&L->cur,"SISNEG32N")||kw(&L->cur,"S0LT32IMM")){
    /* S0LT32N n — word n = (int32(w) < 0) ? 1 : 0; n 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-4 stack imm 32-bit field signed LE0: S0LE32N
   * (word ladder of S0LE16N; field dual of S0LE after S0GT plane) */
  if (kw(&L->cur,"S0LE32N")||kw(&L->cur,"STACK0LE32N")||kw(&L->cur,"SLE032N")||
      kw(&L->cur,"SNONPOS32N")||kw(&L->cur,"SISNONPOS32N")||kw(&L->cur,"S0LE32IMM")){
    /* S0LE32N n — word n = (int32(w) <= 0) ? 1 : 0; n 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-1 stack imm 32-bit field signed GE0: S0GE32N
   * (word ladder of S0GE16N; field dual of S0GE after S0LE plane open) */
  if (kw(&L->cur,"S0GE32N")||kw(&L->cur,"STACK0GE32N")||kw(&L->cur,"SGE032N")||
      kw(&L->cur,"SNONNEG32N")||kw(&L->cur,"SISNONNEG32N")||kw(&L->cur,"S0GE32IMM")){
    /* S0GE32N n — word n = (int32(w) >= 0) ? 1 : 0; n 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 1){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
