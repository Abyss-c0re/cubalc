...
static const char *const form_suggest_pool[] = {
  ...
  "IF", "IFERR", "IFOK", "IFEMPTY", "IFNONEMPTY", "IFDEFINED", "IFUNDEF", "IFSTARTS", "IFSTARTSI", "IFENDS", "IFENDSI", "IFCONTAINS", "IFCONTAINSI", "IFHAS", "IFHASI", "IFEQS", "IFEQSI", "IFGT", "IFLT", "IFGE", "IFLE", "IFEQN", "IFNEQN", "IFHASLINE", "IFINBAG", "WHENHASLINE", "WHENINBAG", "IFBETWEEN", "IFINRANGE", "IFWITHIN", "WHENBETWEEN", "IFFN", "IFHASFN", "IFCLASS", "WHENFN", "WHENCLASS", "IFOBJ", "IFHASOBJ", "IFMETHOD", "IFHASMETHOD", "WHENOBJ", "WHENMETHOD", "IFFILE", "IFDIR", "IFEXIST", "IFEXISTS", "WHENFILE", "WHENDIR", "WHENEXIST", "IFENV", "IFHASENV", "WHENENV", "WHENHASENV", "IFFIELD", "IFHASFIELD", "WHENFIELD", "WHENHASFIELD", "IFFRESH", "IFSTALE", "WHENFRESH", "WHENSTALE", "IFBIG", "IFSMALL", "IFSIZE", "WHENBIG", "WHENSMALL", "WHENSIZE", "IFNEWER", "IFOLDER", "IFOUTOFDATE", "WHENNEWER", "WHENOLDER", "WHENOUTOFDATE", "IFEQFILE", "IFDIFFILE", "IFSAMEFILE", "WHENEQFILE", "WHENDIFFILE", "WHENSAMEFILE", "IFJSONHAS", "IFJSONMISS", "IFHASJSON", "WHENJSONHAS", "WHENJSONMISS", "WHENHASJSON", "IFJSONHASALL", "IFJSONHASANY", "IFJSONNEED", "IFHASJSONALL", "IFHASJSONANY", "WHENJSONHASALL", "WHENJSONHASANY", "WHENJSONNEED", "WHENHASJSONALL", "WHENHASJSONANY", "IFONLYP", "IFNOEXTRAP", "IFJSONONLYP", "IFSTRICTP", "WHENONLYP", "WHENNOEXTRAP", "IFEXACTP", "IFSCHEMAP", "IFJSONEXACTP", "WHENEXACTP", "WHENSCHEMAP", "IFNUM", "IFSTR", "IFTYPE", "IFVARTYPE", "IFKIND", "WHENNUM", "WHENSTR", "WHENTYPE", "IFZERO", "IFNZ", "IFPOS", "IFNEG", "WHENZERO", "WHENNZ", "WHENPOS", "WHENNEG", "IFCANREAD", "IFCANWRITE", "IFCANEXEC", "WHENCANREAD", "WHENCANWRITE", "WHENCANEXEC", "IFJSONEQ", "IFJSONNEQ", "IFSAMEJSON", "WHENJSONEQ", "WHENJSONNEQ", "WHENSAMEJSON", "IFBLANK", "IFNOTBLANK", "WHENBLANK", "WHENNOTBLANK", "IFLEN", "IFLONG", "IFSHORT", "WHENLEN", "WHENLONG", "WHENSHORT", "IFLINES", "IFMANY", "IFFEW", "WHENLINES", "WHENMANY", "WHENFEW", "IFHASFLAG", "IFNOFLAG", "IFHASARG", "IFNOARG", "WHENHASFLAG", "WHENNOFLAG", "WHENHASARG", "WHENNOARG", "HASEMPTY", "HASDEFINED", "HASERR", "HASOK", "TRY", "FINALLY", "CATCH", "ONERR", "GUARD", "LOOP", "WHILE", "FOR", "RETRY", "TIMEIT", "BENCH", "FN", "CALL", "TRYCALL", "DUMPOBJ",
