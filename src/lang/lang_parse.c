...
static const char *const form_suggest_pool[] = {
  ...
  "HASOBJ", "ISCLASS", "NEEDISA", "HASFIELD", "HASMETHOD", "LISTOBJS", "LISTFIELDS", "LISTMETHODS",
  ...
  "TRYCLONE", "ENSURECLONE", "CLONEOBJ", "TRYRENAME", "RENAMEOBJ", "TRYSWAP", "SWAPOBJ", "DELETEOBJ", "SENDALL", "GETFALL", "SETFALL", "WHEREOBJ",
  NULL
};
