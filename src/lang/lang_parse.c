...
static const char *const form_suggest_pool[] = {
  ...
  "HOLD_FLASH", "CUBE", "PLUG", "FLOW", "IMPULSE", "SYS", "SMX", "LET", "INC", "DEC", "SWAP", "TOGGLE", "CLAMP", "SETMIN", "SETMAX", "APPENDTO", "PREPENDTO", "COPYTO", "REPLACEIN", "TRIMTO", "UPPERTO", "LOWERTO", "ZERO", "PUSHTO", "POPFROM", "SHIFTFROM", "LINESIN", "HASINBAG", "SPLITTO", "JOINTO", "GREPIN", "SORTIN", "UNIQIN", "MUL", "DIVBY", "MODBY", "ABS", "NEG", "COALESCETO", "NTHIN", "HEADIN", "TAILIN", "LENOF", "STARTSIN", "ENDSIN", "CONTAINSIN", "EQSIN", "INDEXIN", "LEFTTO", "RIGHTTO", "MIDTO", "BEFOREIN", "AFTERIN", "BETWEENIN", "STRIPPREFIXTO", "STRIPSUFFIXTO", "DROPPREFIXTO", "DROPSUFFIXTO", "ENSUREIN", "DROPLINEIN", "REMOVELINEIN", "ACKIN", "NUMTO", "STRTO", "INTTO", "TOSTR", "LPADTO", "RPADTO", "PADTO",
