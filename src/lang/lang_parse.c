...
static const char *const form_suggest_pool[] = {
  ...
  "IF", "IFERR", "IFOK", "IFEMPTY", "IFNONEMPTY", "IFDEFINED", "IFUNDEF", "IFSTARTS", "IFENDS", "IFCONTAINS", "IFHAS", "IFEQS", "IFGT", "IFLT", "IFGE", "IFLE", "IFEQN", "IFNEQN", "IFHASLINE", "IFINBAG", "WHENHASLINE", "WHENINBAG", "HASEMPTY", "HASDEFINED", "HASERR", "HASOK", "TRY", "FINALLY", "CATCH", "ONERR", "GUARD", "LOOP", "WHILE", "FOR", "RETRY", "TIMEIT", "BENCH", "FN", "CALL", "TRYCALL", "DUMPOBJ",
