...
static const char *const form_suggest_pool[] = {
  ...
  "IF", "IFERR", "IFOK", "IFEMPTY", "IFNONEMPTY", "IFDEFINED", "IFUNDEF", "IFSTARTS", "IFSTARTSI", "IFENDS", "IFENDSI", "IFCONTAINS", "IFCONTAINSI", "IFHAS", "IFHASI", "IFEQS", "IFEQSI", "IFGT", "IFLT", "IFGE", "IFLE", "IFEQN", "IFNEQN", "IFHASLINE", "IFINBAG", "WHENHASLINE", "WHENINBAG", "IFBETWEEN", "IFINRANGE", "IFWITHIN", "WHENBETWEEN", "IFFN", "IFHASFN", "IFCLASS", "WHENFN", "WHENCLASS", "HASEMPTY", "HASDEFINED", "HASERR", "HASOK", "TRY", "FINALLY", "CATCH", "ONERR", "GUARD", "LOOP", "WHILE", "FOR", "RETRY", "TIMEIT", "BENCH", "FN", "CALL", "TRYCALL", "DUMPOBJ",
