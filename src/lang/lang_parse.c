...
static const char *const form_suggest_pool[] = {
  ...
  "HASOBJ", "HASCLASS", "HASCLASSES", "NEEDCLASSES", "HASCLASSANY", "NEEDCLASSANY", "BINDTHIS", "HASTHIS", "ISCLASS", "NEEDISA", "HASFIELD", "HASFIELDS", "NEEDFIELDS", "HASMETHOD", "HASMETHODS", "NEEDMETHODS", "HASMETHODANY", "NEEDMETHODANY", "LISTOBJS", "LISTFIELDS", "LISTMETHODS",
