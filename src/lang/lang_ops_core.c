...
int cubalc_lang_ops_core(VM *vm, Lex *L){
  ...
  if (kw(&L->cur,"SYS") || kw(&L->cur,"HOST")){
    ...
    if (kw(&L->cur,"KVINC") || kw(&L->cur,"INCKV") || kw(&L->cur,"BUMPKV") ||
        kw(&L->cur,"KVADD") || kw(&L->cur,"ADDKV") || kw(&L->cur,"INCKEY") ||
