...
int cubalc_lang_ops_dual(VM *vm, Lex *L){
  ...
  /* digit-3 dual-stack imm 16-bit field ordered-cmp: DLT16N · DGT16N · DLTE16N
   * (dual of SLT16N/SGT16N/SLTE16N; unsigned halfword predicates after DEQ16N/DNE16N) */
  if (kw(&L->cur,"DLT16N")||kw(&L->cur,"S2LT16N")||kw(&L->cur,"STACK2LT16N")||
      kw(&L->cur,"PAIRLT16N")||kw(&L->cur,"DCMPLT16N")||kw(&L->cur,"DLTHIMM")||
      kw(&L->cur,"DLTHN16")){
    /* a b + field n → halfword n of each = (hw < field) ? 1 : 0; n clamped 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  if (kw(&L->cur,"DGT16N")||kw(&L->cur,"S2GT16N")||kw(&L->cur,"STACK2GT16N")||
      kw(&L->cur,"PAIRGT16N")||kw(&L->cur,"DCMPGT16N")||kw(&L->cur,"DGTHIMM")||
      kw(&L->cur,"DGTHN16")){
    /* a b + field n → halfword n of each = (hw > field) ? 1 : 0; n clamped 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  if (kw(&L->cur,"DLTE16N")||kw(&L->cur,"S2LTE16N")||kw(&L->cur,"STACK2LTE16N")||
      kw(&L->cur,"PAIRLTE16N")||kw(&L->cur,"DCMPLE16N")||kw(&L->cur,"DLEQ16N")||
      kw(&L->cur,"DLTEHIMM")||kw(&L->cur,"DLTEHN16")){
    /* a b + field n → halfword n of each = (hw <= field) ? 1 : 0; n clamped 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
  ...
  /* digit-0 dual-stack imm 16-bit field GTE: DGTE16N (dual of SGTE16N after DLTE16N) */
  if (kw(&L->cur,"DGTE16N")||kw(&L->cur,"S2GTE16N")||kw(&L->cur,"STACK2GTE16N")||
      kw(&L->cur,"PAIRGTE16N")||kw(&L->cur,"DCMPGE16N")||kw(&L->cur,"DGEQ16N")||
      kw(&L->cur,"DGTEHIMM")||kw(&L->cur,"DGTEHN16")){
    /* a b + field n → halfword n of each = (hw >= field) ? 1 : 0; n clamped 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
  ...
  /* digit-8 dual-stack imm 16-bit field signed ordered-cmp: DLTS16N · DGTS16N · DLTES16N · DGTES16N
   * (dual of SLTS16N/SGTS16N/SLTES16N/SGTES16N; signed int16 plane on top two) */
  if (kw(&L->cur,"DLTS16N")||kw(&L->cur,"S2LTS16N")||kw(&L->cur,"STACK2LTS16N")||
      kw(&L->cur,"PAIRLTS16N")||kw(&L->cur,"DCMPLTS16N")||kw(&L->cur,"DLTSSIGN16N")||
      kw(&L->cur,"DLTS16IMM")){
    /* a b + field n → halfword n of each = (int16(hw) < int16(field)) ? 1 : 0; n 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"DGTS16N")||kw(&L->cur,"S2GTS16N")||kw(&L->cur,"STACK2GTS16N")||
      kw(&L->cur,"PAIRGTS16N")||kw(&L->cur,"DCMPGTS16N")||kw(&L->cur,"DGTSSIGN16N")||
      kw(&L->cur,"DGTS16IMM")){
    /* a b + field n → halfword n of each = (int16(hw) > int16(field)) ? 1 : 0; n 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  if (kw(&L->cur,"DLTES16N")||kw(&L->cur,"S2LTES16N")||kw(&L->cur,"STACK2LTES16N")||
      kw(&L->cur,"PAIRLTES16N")||kw(&L->cur,"DCMPLES16N")||kw(&L->cur,"DLEQS16N")||
      kw(&L->cur,"DLTES16IMM")){
    /* a b + field n → halfword n of each = (int16(hw) <= int16(field)) ? 1 : 0; n 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  if (kw(&L->cur,"DGTES16N")||kw(&L->cur,"S2GTES16N")||kw(&L->cur,"STACK2GTES16N")||
      kw(&L->cur,"PAIRGTES16N")||kw(&L->cur,"DCMPGES16N")||kw(&L->cur,"DGEQS16N")||
      kw(&L->cur,"DGTES16IMM")){
    /* a b + field n → halfword n of each = (int16(hw) >= int16(field)) ? 1 : 0; n 0..3 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  /* digit-0 dual-stack imm 16-bit field signed signum: DSIGN16N (dual of SSIGN16N) */
  if (kw(&L->cur,"DSIGN16N")||kw(&L->cur,"S2SIGN16N")||kw(&L->cur,"STACK2SIGN16N")||
      kw(&L->cur,"PAIRSIGN16N")||kw(&L->cur,"DSIGNUM16N")||kw(&L->cur,"DSGN16N")||
      kw(&L->cur,"DSIGN16IMM")){
    /* a b + n → halfword n of each = sgn(int16): +1 / 0 / 0xFFFF; n 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long va = (long)((ma >> sh) & 0xFFFFul); if (va & 0x8000) va -= 65536;
    long vb = (long)((mb >> sh) & 0xFFFFul); if (vb & 0x8000) vb -= 65536;
    unsigned long wa = (va > 0) ? 1ul : ((va < 0) ? 0xFFFFul : 0ul);
    unsigned long wb = (vb > 0) ? 1ul : ((vb < 0) ? 0xFFFFul : 0ul);
    long x = (long)((ma & ~(0xFFFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  /* digit-4 dual-stack imm 16-bit field zero-eq: D0EQ16N (dual of S0EQ16N) */
  if (kw(&L->cur,"D0EQ16N")||kw(&L->cur,"S20EQ16N")||kw(&L->cur,"STACK20EQ16N")||
      kw(&L->cur,"PAIR0EQ16N")||kw(&L->cur,"DZ16N")||kw(&L->cur,"DEQZ16N")||
      kw(&L->cur,"D0EQ16IMM")){
  ...
  /* digit-8 dual-stack imm 16-bit field signed LT0: D0LT16N (dual of S0LT16N) */
  if (kw(&L->cur,"D0LT16N")||kw(&L->cur,"S20LT16N")||kw(&L->cur,"STACK20LT16N")||
      kw(&L->cur,"PAIR0LT16N")||kw(&L->cur,"DLT016N")||kw(&L->cur,"DNEGZ16N")||
      kw(&L->cur,"D0LT16IMM")){
    /* a b + n → halfword n of each = (int16(hw) < 0) ? 1 : 0; n 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-9 dual-stack imm 16-bit field signed GT0: D0GT16N (dual of S0GT16N) */
  if (kw(&L->cur,"D0GT16N")||kw(&L->cur,"S20GT16N")||kw(&L->cur,"STACK20GT16N")||
      kw(&L->cur,"PAIR0GT16N")||kw(&L->cur,"DGT016N")||kw(&L->cur,"DPOSZ16N")||
      kw(&L->cur,"D0GT16IMM")){
    /* a b + n → halfword n of each = (int16(hw) > 0) ? 1 : 0; n 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
  ...
  /* digit-4 dual-stack imm 16-bit field signed LE0: D0LE16N (dual of S0LE16N) */
  if (kw(&L->cur,"D0LE16N")||kw(&L->cur,"S20LE16N")||kw(&L->cur,"STACK20LE16N")||
      kw(&L->cur,"PAIR0LE16N")||kw(&L->cur,"DLE016N")||kw(&L->cur,"DNONPOS16N")||
      kw(&L->cur,"D0LE16IMM")){
    /* a b + n → halfword n of each = (int16(hw) <= 0) ? 1 : 0; n 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
  ...
  /* digit-1 dual-stack imm 16-bit field signed GE0: D0GE16N (dual of S0GE16N) */
  if (kw(&L->cur,"D0GE16N")||kw(&L->cur,"S20GE16N")||kw(&L->cur,"STACK20GE16N")||
      kw(&L->cur,"PAIR0GE16N")||kw(&L->cur,"DGE016N")||kw(&L->cur,"DNONNEG16N")||
      kw(&L->cur,"D0GE16IMM")){
    /* a b + n → halfword n of each = (int16(hw) >= 0) ? 1 : 0; n 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
  ...
  /* digit-3 dual-stack imm 8-bit field ordered-cmp: DLT8N · DGT8N · DLTE8N
   * (dual of SLT8N/SGT8N/SLTE8N; unsigned byte predicates after DEQ8N/DNE8N) */
  if (kw(&L->cur,"DLT8N")||kw(&L->cur,"S2LT8N")||kw(&L->cur,"STACK2LT8N")||
      kw(&L->cur,"PAIRLT8N")||kw(&L->cur,"DCMPLT8N")||kw(&L->cur,"DLTBIMM")||
      kw(&L->cur,"DLTBN")){
    /* a b + field n → byte n of each = (b < field) ? 1 : 0; n clamped 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"DGT8N")||kw(&L->cur,"S2GT8N")||kw(&L->cur,"STACK2GT8N")||
      kw(&L->cur,"PAIRGT8N")||kw(&L->cur,"DCMPGT8N")||kw(&L->cur,"DGTBIMM")||
      kw(&L->cur,"DGTBN")){
    /* a b + field n → byte n of each = (b > field) ? 1 : 0; n clamped 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  if (kw(&L->cur,"DLTE8N")||kw(&L->cur,"S2LTE8N")||kw(&L->cur,"STACK2LTE8N")||
      kw(&L->cur,"PAIRLTE8N")||kw(&L->cur,"DCMPLE8N")||kw(&L->cur,"DLEQ8N")||
      kw(&L->cur,"DLTEBIMM")||kw(&L->cur,"DLTEBN")){
    /* a b + field n → byte n of each = (b <= field) ? 1 : 0; n clamped 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
  ...
  /* digit-0 dual-stack imm 8-bit field GTE: DGTE8N (dual of SGTE8N after DLTE8N) */
  if (kw(&L->cur,"DGTE8N")||kw(&L->cur,"S2GTE8N")||kw(&L->cur,"STACK2GTE8N")||
      kw(&L->cur,"PAIRGTE8N")||kw(&L->cur,"DCMPGE8N")||kw(&L->cur,"DGEQ8N")||
      kw(&L->cur,"DGTEBIMM")||kw(&L->cur,"DGTEBN")){
    /* a b + field n → byte n of each = (b >= field) ? 1 : 0; n clamped 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
  ...
  /* digit-3 dual-stack imm 8-bit field signed ordered-cmp: DLTS8N · DGTS8N · DLTES8N · DGTES8N
   * (dual of SLTS8N/SGTS8N/SLTES8N/SGTES8N; signed int8 plane on top two) */
  if (kw(&L->cur,"DLTS8N")||kw(&L->cur,"S2LTS8N")||kw(&L->cur,"STACK2LTS8N")||
      kw(&L->cur,"PAIRLTS8N")||kw(&L->cur,"DCMPLTS8N")||kw(&L->cur,"DLTSSIGN8N")||
      kw(&L->cur,"DLTS8IMM")){
    /* a b + field n → byte n of each = (int8(b) < int8(field)) ? 1 : 0; n 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    if (n > 7) n = 7;
    unsigned long sh = (unsigned long)(n * 8);
    long f = (long)((unsigned long)field & 0xFFul);
    if (f & 0x80) f -= 256;
    unsigned long ma = (unsigned long)vm->stack[vm->sp - 2];
    unsigned long mb = (unsigned long)vm->stack[vm->sp - 1];
  ...
  if (kw(&L->cur,"DGTS8N")||kw(&L->cur,"S2GTS8N")||kw(&L->cur,"STACK2GTS8N")||
      kw(&L->cur,"PAIRGTS8N")||kw(&L->cur,"DCMPGTS8N")||kw(&L->cur,"DGTSSIGN8N")||
      kw(&L->cur,"DGTS8IMM")){
    /* a b + field n → byte n of each = (int8(b) > int8(field)) ? 1 : 0; n 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  if (kw(&L->cur,"DLTES8N")||kw(&L->cur,"S2LTES8N")||kw(&L->cur,"STACK2LTES8N")||
      kw(&L->cur,"PAIRLTES8N")||kw(&L->cur,"DCMPLES8N")||kw(&L->cur,"DLEQS8N")||
      kw(&L->cur,"DLTES8IMM")){
    /* a b + field n → byte n of each = (int8(b) <= int8(field)) ? 1 : 0; n 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  if (kw(&L->cur,"DGTES8N")||kw(&L->cur,"S2GTES8N")||kw(&L->cur,"STACK2GTES8N")||
      kw(&L->cur,"PAIRGTES8N")||kw(&L->cur,"DCMPGES8N")||kw(&L->cur,"DGEQS8N")||
      kw(&L->cur,"DGTES8IMM")){
    /* a b + field n → byte n of each = (int8(b) >= int8(field)) ? 1 : 0; n 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  /* digit-2 dual-stack imm 8-bit field signed min/max: DMINS8N · DMAXS8N
   * (dual of SMINS8N/SMAXS8N; byte ladder of DMINS16N after DLTS8N) */
  if (kw(&L->cur,"DMINS8N")||kw(&L->cur,"S2MINS8N")||kw(&L->cur,"STACK2MINS8N")||
      kw(&L->cur,"PAIRMINS8N")||kw(&L->cur,"DMINSIGN8N")||kw(&L->cur,"DMINS8IMM")||
      kw(&L->cur,"DMINSI8N")){
    /* a b + field n → byte n of each = min_signed(int8(b), int8(field)); n 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    long ma_m = (va < f) ? va : f;
    long mb_m = (vb < f) ? vb : f;
    unsigned long wa = (unsigned long)ma_m & 0xFFul;
    unsigned long wb = (unsigned long)mb_m & 0xFFul;
    long x = (long)((ma & ~(0xFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DMAXS8N")||kw(&L->cur,"S2MAXS8N")||kw(&L->cur,"STACK2MAXS8N")||
      kw(&L->cur,"PAIRMAXS8N")||kw(&L->cur,"DMAXSIGN8N")||kw(&L->cur,"DMAXS8IMM")||
      kw(&L->cur,"DMAXSI8N")){
    /* a b + field n → byte n of each = max_signed(int8(b), int8(field)); n 0..7 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-5 dual-stack imm 8-bit field signed clamp+between: DCLAMPS8N · DBETWEENS8N
   * (dual of SCLAMPS8N/SBETWEENS8N; byte ladder of DCLAMPS16N after DMINS8N) */
  if (kw(&L->cur,"DCLAMPS8N")||kw(&L->cur,"S2CLAMPS8N")||kw(&L->cur,"STACK2CLAMPS8N")||
      kw(&L->cur,"PAIRCLAMPS8N")||kw(&L->cur,"DCLAMPSIGN8N")||kw(&L->cur,"DCLAMPS8IMM")||
      kw(&L->cur,"DBOUNDS8N")){
    /* a b + lo hi n → byte n of each = clamp_signed(int8(b),[lo,hi]); n 0..7 */
    lex_next(L);
    long lo = parse_expr(vm,L);
    long hi = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    ...
    if (va < slo) va = slo; if (va > shi) va = shi;
    if (vb < slo) vb = slo; if (vb > shi) vb = shi;
    unsigned long wa = (unsigned long)va & 0xFFul;
    unsigned long wb = (unsigned long)vb & 0xFFul;
    long x = (long)((ma & ~(0xFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DBETWEENS8N")||kw(&L->cur,"S2BETWEENS8N")||kw(&L->cur,"STACK2BETWEENS8N")||
      kw(&L->cur,"PAIRBETWEENS8N")||kw(&L->cur,"DINRANGES8N")||kw(&L->cur,"DBETWEENS8IMM")||
      kw(&L->cur,"DINRANGESIGN8N")){
    /* a b + lo hi n → byte n of each = (lo <= int8(b) <= hi) ? 1 : 0; n 0..7 */
    lex_next(L);
    long lo = parse_expr(vm,L);
    long hi = parse_expr(vm,L);
    long n = parse_expr(vm,L);
  ...
  /* digit-3 dual-stack imm 8-bit field signed WITHIN: DWITHINS8N (dual of SWITHINS8N) */
  if (kw(&L->cur,"DWITHINS8N")||kw(&L->cur,"S2WITHINS8N")||kw(&L->cur,"STACK2WITHINS8N")||
      kw(&L->cur,"PAIRWITHINS8N")||kw(&L->cur,"DWITHINSIGN8N")||kw(&L->cur,"DWITHINS8IMM")||
      kw(&L->cur,"DINTERVALS8N")){
    /* a b + lo hi n → byte n of each = (lo <= int8(b) < hi) ? 1 : 0; n 0..7; no swap */
    lex_next(L);
    long lo = parse_expr(vm,L);
    long hi = parse_expr(vm,L);
    long n = parse_expr(vm,L);
  ...
  /* digit-7 dual-stack imm 8-bit field signed signum: DSIGN8N (dual of SSIGN8N) */
  if (kw(&L->cur,"DSIGN8N")||kw(&L->cur,"S2SIGN8N")||kw(&L->cur,"STACK2SIGN8N")||
      kw(&L->cur,"PAIRSIGN8N")||kw(&L->cur,"DSIGNUM8N")||kw(&L->cur,"DSGN8N")||
      kw(&L->cur,"DSIGN8IMM")){
    /* a b + n → byte n of each = sgn(int8): +1 / 0 / 0xFF; n 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long va = (long)((ma >> sh) & 0xFFul); if (va & 0x80) va -= 256;
    long vb = (long)((mb >> sh) & 0xFFul); if (vb & 0x80) vb -= 256;
    unsigned long wa = (va > 0) ? 1ul : ((va < 0) ? 0xFFul : 0ul);
    unsigned long wb = (vb > 0) ? 1ul : ((vb < 0) ? 0xFFul : 0ul);
    long x = (long)((ma & ~(0xFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  /* digit-3 dual-stack imm 8-bit field nonzero: D0NE8N (dual of S0NE8N) */
  if (kw(&L->cur,"D0NE8N")||kw(&L->cur,"S20NE8N")||kw(&L->cur,"STACK20NE8N")||
      kw(&L->cur,"PAIR0NE8N")||kw(&L->cur,"DNZ8N")||kw(&L->cur,"DNEZ8N")||
      kw(&L->cur,"D0NE8IMM")){
    /* a b + n → byte n of each = (b != 0) ? 1 : 0; n 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
  ...
  /* digit-7 dual-stack imm 8-bit field signed LT0: D0LT8N (dual of S0LT8N) */
  if (kw(&L->cur,"D0LT8N")||kw(&L->cur,"S20LT8N")||kw(&L->cur,"STACK20LT8N")||
      kw(&L->cur,"PAIR0LT8N")||kw(&L->cur,"DLT08N")||kw(&L->cur,"DNEGZ8N")||
      kw(&L->cur,"D0LT8IMM")){
  ...
  /* digit-4 dual-stack imm 8-bit field signed LE0: D0LE8N (dual of S0LE8N) */
  if (kw(&L->cur,"D0LE8N")||kw(&L->cur,"S20LE8N")||kw(&L->cur,"STACK20LE8N")||
      kw(&L->cur,"PAIR0LE8N")||kw(&L->cur,"DLE08N")||kw(&L->cur,"DNONPOS8N")||
      kw(&L->cur,"D0LE8IMM")){
    /* a b + n → byte n of each = (int8(b) <= 0) ? 1 : 0; n 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
  ...
  /* digit-3 dual-stack imm 8-bit field signed GE0: D0GE8N (dual of S0GE8N) */
  if (kw(&L->cur,"D0GE8N")||kw(&L->cur,"S20GE8N")||kw(&L->cur,"STACK20GE8N")||
      kw(&L->cur,"PAIR0GE8N")||kw(&L->cur,"DGE08N")||kw(&L->cur,"DNONNEG8N")||
      kw(&L->cur,"D0GE8IMM")){
    /* a b + n → byte n of each = (int8(b) >= 0) ? 1 : 0; n 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
  ...
  /* digit-1 dual-stack imm 4-bit field GTE: DGTE4N (dual of SGTE4N after DLTE4N) */
  if (kw(&L->cur,"DGTE4N")||kw(&L->cur,"S2GTE4N")||kw(&L->cur,"STACK2GTE4N")||
      kw(&L->cur,"PAIRGTE4N")||kw(&L->cur,"DCMPGE4N")||kw(&L->cur,"DGEQ4N")||
      kw(&L->cur,"DGTENIMM")||kw(&L->cur,"DGTENIBN")){
    /* a b + field n → nibble n of each = (nib >= field) ? 1 : 0; n clamped 0..15 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
  ...
  /* digit-4 dual-stack imm 4-bit field signed min/max: DMINS4N · DMAXS4N
   * (dual of SMINS4N/SMAXS4N; nibble ladder of DMINS8N after DLTS4N; completes signed select all widths) */
  if (kw(&L->cur,"DMINS4N")||kw(&L->cur,"S2MINS4N")||kw(&L->cur,"STACK2MINS4N")||
      kw(&L->cur,"PAIRMINS4N")||kw(&L->cur,"DMINSIGN4N")||kw(&L->cur,"DMINS4IMM")||
      kw(&L->cur,"DMINSI4N")){
    /* a b + field n → nibble n of each = min_signed(int4(nib), int4(field)); n 0..15 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    long ma_m = (va < f) ? va : f;
    long mb_m = (vb < f) ? vb : f;
    unsigned long wa = (unsigned long)ma_m & 0xFul;
    unsigned long wb = (unsigned long)mb_m & 0xFul;
    long x = (long)((ma & ~(0xFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DMAXS4N")||kw(&L->cur,"S2MAXS4N")||kw(&L->cur,"STACK2MAXS4N")||
      kw(&L->cur,"PAIRMAXS4N")||kw(&L->cur,"DMAXSIGN4N")||kw(&L->cur,"DMAXS4IMM")||
      kw(&L->cur,"DMAXSI4N")){
    /* a b + field n → nibble n of each = max_signed(int4(nib), int4(field)); n 0..15 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-3 dual-stack imm 4-bit field signed WITHIN: DWITHINS4N (completes WITHIN all widths dual) */
  if (kw(&L->cur,"DWITHINS4N")||kw(&L->cur,"S2WITHINS4N")||kw(&L->cur,"STACK2WITHINS4N")||
      kw(&L->cur,"PAIRWITHINS4N")||kw(&L->cur,"DWITHINSIGN4N")||kw(&L->cur,"DWITHINS4IMM")||
      kw(&L->cur,"DINTERVALS4N")){
    /* a b + lo hi n → nibble n of each = (lo <= int4(nib) < hi) ? 1 : 0; n 0..15; no swap */
    lex_next(L);
    long lo = parse_expr(vm,L);
    long hi = parse_expr(vm,L);
    long n = parse_expr(vm,L);
  ...
  /* digit-7 dual-stack imm 4-bit field signed signum: DSIGN4N (completes field signum all widths dual) */
  if (kw(&L->cur,"DSIGN4N")||kw(&L->cur,"S2SIGN4N")||kw(&L->cur,"STACK2SIGN4N")||
      kw(&L->cur,"PAIRSIGN4N")||kw(&L->cur,"DSIGNUM4N")||kw(&L->cur,"DSGN4N")||
      kw(&L->cur,"DSIGN4IMM")){
    /* a b + n → nibble n of each = sgn(int4): +1 / 0 / 0xF; n 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-3 dual-stack imm 4-bit field nonzero: D0NE4N (completes field nonzero all widths dual) */
  if (kw(&L->cur,"D0NE4N")||kw(&L->cur,"S20NE4N")||kw(&L->cur,"STACK20NE4N")||
      kw(&L->cur,"PAIR0NE4N")||kw(&L->cur,"DNZ4N")||kw(&L->cur,"DNEZ4N")||
      kw(&L->cur,"D0NE4IMM")){
    /* a b + n → nibble n of each = (nib != 0) ? 1 : 0; n 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
  ...
  /* digit-7 dual-stack imm 4-bit field signed LT0: D0LT4N (completes field signed LT0 all widths dual) */
  if (kw(&L->cur,"D0LT4N")||kw(&L->cur,"S20LT4N")||kw(&L->cur,"STACK20LT4N")||
      kw(&L->cur,"PAIR0LT4N")||kw(&L->cur,"DLT04N")||kw(&L->cur,"DNEGZ4N")||
      kw(&L->cur,"D0LT4IMM")){
  ...
  /* digit-4 dual-stack imm 4-bit field signed LE0: D0LE4N (completes field signed LE0 all widths dual) */
  if (kw(&L->cur,"D0LE4N")||kw(&L->cur,"S20LE4N")||kw(&L->cur,"STACK20LE4N")||
      kw(&L->cur,"PAIR0LE4N")||kw(&L->cur,"DLE04N")||kw(&L->cur,"DNONPOS4N")||
      kw(&L->cur,"D0LE4IMM")){
    /* a b + n → nibble n of each = (int4(nib) <= 0) ? 1 : 0; n 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
  ...
  /* digit-3 dual-stack imm 4-bit field signed GE0: D0GE4N (completes field signed GE0 all widths dual) */
  if (kw(&L->cur,"D0GE4N")||kw(&L->cur,"S20GE4N")||kw(&L->cur,"STACK20GE4N")||
      kw(&L->cur,"PAIR0GE4N")||kw(&L->cur,"DGE04N")||kw(&L->cur,"DNONNEG4N")||
      kw(&L->cur,"D0GE4IMM")){
    /* a b + n → nibble n of each = (int4(nib) >= 0) ? 1 : 0; n 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
  ...
  /* digit-2 dual-stack imm 4-bit field shift: DSHL4N · DSHR4N · DSAR4N
   * (dual of SSHL4N/SSHR4N/SSAR4N; nibble-field shift plane on top two cells after DNOT4N/DROL4N) */
  if (kw(&L->cur,"DSHL4N")||kw(&L->cur,"S2SHL4N")||kw(&L->cur,"STACK2SHL4N")||
      kw(&L->cur,"PAIRSHL4N")||kw(&L->cur,"DLSH4N")||kw(&L->cur,"DSHLNIBN")||
      kw(&L->cur,"DSHIFTNIBL")){
    /* a b + k n → nibble n of each = (uint4)<<k (k>=4 → 0); n clamped 0..15 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long va = (ma >> sh) & 0xFul;
    unsigned long vb = (mb >> sh) & 0xFul;
    unsigned long wa = (kk >= 4) ? 0ul : ((va << (unsigned)kk) & 0xFul);
    unsigned long wb = (kk >= 4) ? 0ul : ((vb << (unsigned)kk) & 0xFul);
    long x = (long)((ma & ~(0xFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DSHR4N")||kw(&L->cur,"S2SHR4N")||kw(&L->cur,"STACK2SHR4N")||
      kw(&L->cur,"PAIRSHR4N")||kw(&L->cur,"DLSHR4N")||kw(&L->cur,"DSHRNIBN")||
      kw(&L->cur,"DSHIFTNIBR")){
    /* a b + k n → nibble n of each = (uint4)>>k logical (k>=4 → 0); n clamped 0..15 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long va = (ma >> sh) & 0xFul;
    unsigned long vb = (mb >> sh) & 0xFul;
    unsigned long wa = (kk >= 4) ? 0ul : (va >> (unsigned)kk);
    unsigned long wb = (kk >= 4) ? 0ul : (vb >> (unsigned)kk);
    long x = (long)((ma & ~(0xFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DSAR4N")||kw(&L->cur,"S2SAR4N")||kw(&L->cur,"STACK2SAR4N")||
      kw(&L->cur,"PAIRSAR4N")||kw(&L->cur,"DASHR4N")||kw(&L->cur,"DSARNIBN")||
      kw(&L->cur,"DSARSHIFTNIB")){
    /* a b + k n → nibble n of each = (int4)>>k arithmetic (k>=4 → all sign); n clamped 0..15 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    if (vb & 0x8) vb -= 16;
    long sa, sb;
    if (kk >= 4){ sa = (va < 0) ? -1L : 0L; sb = (vb < 0) ? -1L : 0L; }
    else { sa = va >> kk; sb = vb >> kk; }
    unsigned long wa = (unsigned long)sa & 0xFul;
    unsigned long wb = (unsigned long)sb & 0xFul;
    long x = (long)((ma & ~(0xFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  /* digit-0 dual-stack imm 4-bit field metrics: DBITREV4N · DPOPCNT4N · DPARITY4N
   * (dual of SBITREV4N/SPOPCNT4N/SPARITY4N; nibble metrics plane on top two after DSHL4N) */
  if (kw(&L->cur,"DBITREV4N")||kw(&L->cur,"S2BITREV4N")||kw(&L->cur,"STACK2BITREV4N")||
      kw(&L->cur,"PAIRBITREV4N")||kw(&L->cur,"DBREV4N")||kw(&L->cur,"DREV4N")||
      kw(&L->cur,"DBITREVNIBN")){
    /* a b + n → nibble n of each = bitrev4(nibble); n clamped 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long x = (long)((ma & ~(0xFul << sh)) | (ra << sh));
    long y = (long)((mb & ~(0xFul << sh)) | (rb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"DPOPCNT4N")||kw(&L->cur,"S2POPCNT4N")||kw(&L->cur,"STACK2POPCNT4N")||
      kw(&L->cur,"PAIRPOPCNT4N")||kw(&L->cur,"DPCNT4N")||kw(&L->cur,"DPOPNIBN")||
      kw(&L->cur,"DNIBPOPN")){
    /* a b + n → nibble n of each = popcount(nibble); n clamped 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long x = (long)((ma & ~(0xFul << sh)) | (pa << sh));
    long y = (long)((mb & ~(0xFul << sh)) | (pb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"DPARITY4N")||kw(&L->cur,"S2PARITY4N")||kw(&L->cur,"STACK2PARITY4N")||
      kw(&L->cur,"PAIRPARITY4N")||kw(&L->cur,"DXORRED4N")||kw(&L->cur,"DPARITYNIBN")||
      kw(&L->cur,"DNIBPARN")){
    /* a b + n → nibble n of each = xor-reduce(nibble) in low bit; n clamped 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long x = (long)((ma & ~(0xFul << sh)) | (pra << sh));
    long y = (long)((mb & ~(0xFul << sh)) | (prb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  /* digit-2 dual-stack imm 4-bit field zeros+signed: DCLZ4N · DCTZ4N · DNEG4N
   * (dual of SCLZ4N/SCTZ4N/SNEG4N; nibble zeros+negate plane on top two after DPARITY4N) */
  if (kw(&L->cur,"DCLZ4N")||kw(&L->cur,"S2CLZ4N")||kw(&L->cur,"STACK2CLZ4N")||
      kw(&L->cur,"PAIRCLZ4N")||kw(&L->cur,"DNLZ4N")||kw(&L->cur,"DCLZNIBN")||
      kw(&L->cur,"DNIBCLZN")){
    /* a b + n → nibble n of each = clz4(nibble); 0 → 4; n clamped 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long ma = (unsigned long)vm->stack[vm->sp - 2];
    unsigned long mb = (unsigned long)vm->stack[vm->sp - 1];
    unsigned int wa = (unsigned int)((ma >> sh) & 0xFul);
    unsigned int wb = (unsigned int)((mb >> sh) & 0xFul);
    unsigned long cza = 0, czb = 0;
    if (wa == 0) cza = 4;
    else { for (int b = 3; b >= 0; b--){ if (wa & (1u << (unsigned)b)) break; cza++; } }
    if (wb == 0) czb = 4;
    else { for (int b = 3; b >= 0; b--){ if (wb & (1u << (unsigned)b)) break; czb++; } }
    long x = (long)((ma & ~(0xFul << sh)) | (cza << sh));
    long y = (long)((mb & ~(0xFul << sh)) | (czb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"DCTZ4N")||kw(&L->cur,"S2CTZ4N")||kw(&L->cur,"STACK2CTZ4N")||
      kw(&L->cur,"PAIRCTZ4N")||kw(&L->cur,"DNTZ4N")||kw(&L->cur,"DCTZNIBN")||
      kw(&L->cur,"DNIBCTZN")){
    /* a b + n → nibble n of each = ctz4(nibble); 0 → 4; n clamped 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned int wa = (unsigned int)((ma >> sh) & 0xFul);
    unsigned int wb = (unsigned int)((mb >> sh) & 0xFul);
    unsigned long tza = 0, tzb = 0;
    if (wa == 0) tza = 4;
    else { while ((wa & 1u) == 0){ tza++; wa >>= 1; } }
    if (wb == 0) tzb = 4;
    else { while ((wb & 1u) == 0){ tzb++; wb >>= 1; } }
    long x = (long)((ma & ~(0xFul << sh)) | (tza << sh));
    long y = (long)((mb & ~(0xFul << sh)) | (tzb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"DNEG4N")||kw(&L->cur,"S2NEG4N")||kw(&L->cur,"STACK2NEG4N")||
      kw(&L->cur,"PAIRNEG4N")||kw(&L->cur,"DINEG4N")||kw(&L->cur,"DNEGNIBN")||
      kw(&L->cur,"DNIBNEGN")){
    /* a b + n → nibble n of each = -(int4) as uint4; min int4 -8 stays 0x8; n clamped 0..15 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long na = (va == -8L) ? -8L : -va;
    long nb = (vb == -8L) ? -8L : -vb;
    unsigned long nva = (unsigned long)(na & 0xF);
    unsigned long nvb = (unsigned long)(nb & 0xF);
  ...
  /* digit-1 dual-stack imm 8-bit field unary+rotate: DNOT8N · DROL8N · DROR8N
   * (byte-field ladder of DNOT4N/DROL4N/DROR4N; dual 8n unary plane after dual 4n complete) */
  if (kw(&L->cur,"DNOT8N")||kw(&L->cur,"S2NOT8N")||kw(&L->cur,"STACK2NOT8N")||
      kw(&L->cur,"PAIRNOT8N")||kw(&L->cur,"DINV8N")||kw(&L->cur,"DINVERT8N")||
      kw(&L->cur,"DNOTBYTEN")){
    /* a b + n → byte n of each = ~byte & 0xFF; n clamped 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long ma = (unsigned long)vm->stack[vm->sp - 2];
    unsigned long mb = (unsigned long)vm->stack[vm->sp - 1];
    unsigned long wa = (~((ma >> sh) & 0xFFul)) & 0xFFul;
    unsigned long wb = (~((mb >> sh) & 0xFFul)) & 0xFFul;
    long x = (long)((ma & ~(0xFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DROL8N")||kw(&L->cur,"S2ROL8N")||kw(&L->cur,"STACK2ROL8N")||
      kw(&L->cur,"PAIRROL8N")||kw(&L->cur,"DROTL8N")||kw(&L->cur,"DROLBYTEN")||
      kw(&L->cur,"DROTBYTEL")){
    /* a b + k n → rotl8 byte n of each by k&7; n clamped 0..7 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long va = (ma >> sh) & 0xFFul;
    unsigned long vb = (mb >> sh) & 0xFFul;
    unsigned long wa = (kk == 0) ? va : (((va << (unsigned)kk) | (va >> (unsigned)(8 - kk))) & 0xFFul);
    unsigned long wb = (kk == 0) ? vb : (((vb << (unsigned)kk) | (vb >> (unsigned)(8 - kk))) & 0xFFul);
    long x = (long)((ma & ~(0xFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DROR8N")||kw(&L->cur,"S2ROR8N")||kw(&L->cur,"STACK2ROR8N")||
      kw(&L->cur,"PAIRROR8N")||kw(&L->cur,"DROTR8N")||kw(&L->cur,"DRORBYTEN")||
      kw(&L->cur,"DROTBYTER")){
    /* a b + k n → rotr8 byte n of each by k&7; n clamped 0..7 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-0 dual-stack imm 8-bit field shift: DSHL8N · DSHR8N · DSAR8N
   * (byte ladder of DSHL4N/DSHR4N/DSAR4N; dual 8n shift plane after DNOT8N/DROL8N) */
  if (kw(&L->cur,"DSHL8N")||kw(&L->cur,"S2SHL8N")||kw(&L->cur,"STACK2SHL8N")||
      kw(&L->cur,"PAIRSHL8N")||kw(&L->cur,"DLSH8N")||kw(&L->cur,"DSHLBYTEN")||
      kw(&L->cur,"DSHIFTBYTEL")){
    /* a b + k n → byte n of each = (uint8)<<k (k>=8 → 0); n clamped 0..7 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long va = (ma >> sh) & 0xFFul;
    unsigned long vb = (mb >> sh) & 0xFFul;
    unsigned long wa = (kk >= 8) ? 0ul : ((va << (unsigned)kk) & 0xFFul);
    unsigned long wb = (kk >= 8) ? 0ul : ((vb << (unsigned)kk) & 0xFFul);
    long x = (long)((ma & ~(0xFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DSHR8N")||kw(&L->cur,"S2SHR8N")||kw(&L->cur,"STACK2SHR8N")||
      kw(&L->cur,"PAIRSHR8N")||kw(&L->cur,"DLSHR8N")||kw(&L->cur,"DSHRBYTEN")||
      kw(&L->cur,"DSHIFTBYTER")){
    /* a b + k n → byte n of each = (uint8)>>k logical (k>=8 → 0); n clamped 0..7 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long va = (ma >> sh) & 0xFFul;
    unsigned long vb = (mb >> sh) & 0xFFul;
    unsigned long wa = (kk >= 8) ? 0ul : (va >> (unsigned)kk);
    unsigned long wb = (kk >= 8) ? 0ul : (vb >> (unsigned)kk);
    long x = (long)((ma & ~(0xFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DSAR8N")||kw(&L->cur,"S2SAR8N")||kw(&L->cur,"STACK2SAR8N")||
      kw(&L->cur,"PAIRSAR8N")||kw(&L->cur,"DASHR8N")||kw(&L->cur,"DSARBYTEN")||
      kw(&L->cur,"DSARSHIFTBYTE")){
    /* a b + k n → byte n of each = (int8)>>k arithmetic (k>=8 → all sign); n clamped 0..7 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long ma = (unsigned long)vm->stack[vm->sp - 2];
    unsigned long mb = (unsigned long)vm->stack[vm->sp - 1];
    long va = (long)((ma >> sh) & 0xFFul);
    long vb = (long)((mb >> sh) & 0xFFul);
    if (va & 0x80) va -= 256;
    if (vb & 0x80) vb -= 256;
    long sa, sb;
    if (kk >= 8){ sa = (va < 0) ? -1L : 0L; sb = (vb < 0) ? -1L : 0L; }
    else { sa = va >> kk; sb = vb >> kk; }
    unsigned long wa = (unsigned long)sa & 0xFFul;
    unsigned long wb = (unsigned long)sb & 0xFFul;
    long x = (long)((ma & ~(0xFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  /* digit-3 dual-stack imm 8-bit field zeros+signed: DCLZ8N · DCTZ8N · DNEG8N
   * (byte ladder of DCLZ4N/DCTZ4N/DNEG4N; dual 8n zeros+negate after DPARITY8N) */
  if (kw(&L->cur,"DCLZ8N")||kw(&L->cur,"S2CLZ8N")||kw(&L->cur,"STACK2CLZ8N")||
      kw(&L->cur,"PAIRCLZ8N")||kw(&L->cur,"DNLZ8N")||kw(&L->cur,"DCLZBYTEN")||
      kw(&L->cur,"DBYTECLZN")){
    /* a b + n → byte n of each = clz8(byte); 0 → 8; n clamped 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long ma = (unsigned long)vm->stack[vm->sp - 2];
    unsigned long mb = (unsigned long)vm->stack[vm->sp - 1];
    unsigned int wa = (unsigned int)((ma >> sh) & 0xFFul);
    unsigned int wb = (unsigned int)((mb >> sh) & 0xFFul);
    unsigned long cza = 0, czb = 0;
    if (wa == 0) cza = 8;
    else { for (int b = 7; b >= 0; b--){ if (wa & (1u << (unsigned)b)) break; cza++; } }
    if (wb == 0) czb = 8;
    else { for (int b = 7; b >= 0; b--){ if (wb & (1u << (unsigned)b)) break; czb++; } }
    long x = (long)((ma & ~(0xFFul << sh)) | ((cza & 0xFFul) << sh));
    long y = (long)((mb & ~(0xFFul << sh)) | ((czb & 0xFFul) << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"DCTZ8N")||kw(&L->cur,"S2CTZ8N")||kw(&L->cur,"STACK2CTZ8N")||
      kw(&L->cur,"PAIRCTZ8N")||kw(&L->cur,"DNTZ8N")||kw(&L->cur,"DCTZBYTEN")||
      kw(&L->cur,"DBYTECTZN")){
    /* a b + n → byte n of each = ctz8(byte); 0 → 8; n clamped 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long x = (long)((ma & ~(0xFFul << sh)) | ((tza & 0xFFul) << sh));
    long y = (long)((mb & ~(0xFFul << sh)) | ((tzb & 0xFFul) << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"DNEG8N")||kw(&L->cur,"S2NEG8N")||kw(&L->cur,"STACK2NEG8N")||
      kw(&L->cur,"PAIRNEG8N")||kw(&L->cur,"DINEG8N")||kw(&L->cur,"DNEGBYTEN")||
      kw(&L->cur,"DBYTENEGN")){
    /* a b + n → byte n of each = -(int8) as uint8; min int8 -128 stays 0x80; n clamped 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    if (va & 0x80) va -= 256;
    if (vb & 0x80) vb -= 256;
    long na = (va == -128L) ? -128L : -va;
    long nb = (vb == -128L) ? -128L : -vb;
    unsigned long nva = (unsigned long)(na & 0xFF);
    unsigned long nvb = (unsigned long)(nb & 0xFF);
    long x = (long)((ma & ~(0xFFul << sh)) | (nva << sh));
    long y = (long)((mb & ~(0xFFul << sh)) | (nvb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  /* digit-5 dual-stack imm 8-bit field abs+extend: DABS8N · DSEXT8N · DZEXT8N
   * (byte ladder of DABS4N/DSEXT4N/DZEXT4N; complete dual 8n unary plane after DNEG8N) */
  if (kw(&L->cur,"DABS8N")||kw(&L->cur,"S2ABS8N")||kw(&L->cur,"STACK2ABS8N")||
      kw(&L->cur,"PAIRABS8N")||kw(&L->cur,"DIABS8N")||kw(&L->cur,"DABSBYTEN")||
      kw(&L->cur,"DBYTEABSN")){
    /* a b + n → byte n of each = abs(int8); min -128 → 0x80; n clamped 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long ara = (va < 0) ? -va : va;
    long arb = (vb < 0) ? -vb : vb;
    /* min int8 -128 → +128 does not fit uint8; keep 0x80 (same as SABS4N min path) */
    unsigned long nva = (unsigned long)(ara & 0xFF);
    unsigned long nvb = (unsigned long)(arb & 0xFF);
    long x = (long)((ma & ~(0xFFul << sh)) | (nva << sh));
    long y = (long)((mb & ~(0xFFul << sh)) | (nvb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DSEXT8N")||kw(&L->cur,"S2SEXT8N")||kw(&L->cur,"STACK2SEXT8N")||
      kw(&L->cur,"PAIRSEXT8N")||kw(&L->cur,"DSIGNEXT8N")||kw(&L->cur,"DSEXTBYTEN")||
      kw(&L->cur,"DBYTESEXTN")){
    /* a b + n → each cell = sign-extend byte n to full width; n clamped 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  if (kw(&L->cur,"DZEXT8N")||kw(&L->cur,"S2ZEXT8N")||kw(&L->cur,"STACK2ZEXT8N")||
      kw(&L->cur,"PAIRZEXT8N")||kw(&L->cur,"DZEROEXT8N")||kw(&L->cur,"DZEXTBYTEN")||
      kw(&L->cur,"DBYTEZEXTN")){
    /* a b + n → each cell = zero-extend byte n; n clamped 0..7 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long ma = (unsigned long)vm->stack[vm->sp - 2];
    unsigned long mb = (unsigned long)vm->stack[vm->sp - 1];
    long xa = (long)((ma >> sh) & 0xFFul);
    long yb = (long)((mb >> sh) & 0xFFul);
    vm->stack[vm->sp - 2] = xa;
    vm->stack[vm->sp - 1] = yb;
    var_set_num(vm,"LAST_N",yb); vm->last_n=yb;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  ...
  /* digit-1 dual-stack imm 16-bit field unary+rotate: DNOT16N · DROL16N · DROR16N
   * (halfword ladder of DNOT8N/DROL8N/DROR8N; start dual 16n unary plane after DZEXT16N) */
  if (kw(&L->cur,"DNOT16N")||kw(&L->cur,"S2NOT16N")||kw(&L->cur,"STACK2NOT16N")||
      kw(&L->cur,"PAIRNOT16N")||kw(&L->cur,"DINV16N")||kw(&L->cur,"DINVERT16N")||
      kw(&L->cur,"DNOTWORDN")){
    /* a b + n → halfword n of each = ~hw & 0xFFFF; n clamped 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long ma = (unsigned long)vm->stack[vm->sp - 2];
    unsigned long mb = (unsigned long)vm->stack[vm->sp - 1];
    unsigned long wa = (~((ma >> sh) & 0xFFFFul)) & 0xFFFFul;
    unsigned long wb = (~((mb >> sh) & 0xFFFFul)) & 0xFFFFul;
    long x = (long)((ma & ~(0xFFFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DROL16N")||kw(&L->cur,"S2ROL16N")||kw(&L->cur,"STACK2ROL16N")||
      kw(&L->cur,"PAIRROL16N")||kw(&L->cur,"DROTL16N")||kw(&L->cur,"DROLWORDN")||
      kw(&L->cur,"DROTWORDL")){
    /* a b + k n → rotl16 halfword n of each by k&15; n clamped 0..3 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long va = (ma >> sh) & 0xFFFFul;
    unsigned long vb = (mb >> sh) & 0xFFFFul;
    unsigned long wa = (kk == 0) ? va : (((va << (unsigned)kk) | (va >> (unsigned)(16 - kk))) & 0xFFFFul);
    unsigned long wb = (kk == 0) ? vb : (((vb << (unsigned)kk) | (vb >> (unsigned)(16 - kk))) & 0xFFFFul);
    long x = (long)((ma & ~(0xFFFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DROR16N")||kw(&L->cur,"S2ROR16N")||kw(&L->cur,"STACK2ROR16N")||
      kw(&L->cur,"PAIRROR16N")||kw(&L->cur,"DROTR16N")||kw(&L->cur,"DRORWORDN")||
      kw(&L->cur,"DROTWORDR")){
    /* a b + k n → rotr16 halfword n of each by k&15; n clamped 0..3 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-8 dual-stack imm 16-bit field shift: DSHL16N · DSHR16N · DSAR16N
   * (halfword ladder of DSHL8N/DSHR8N/DSAR8N; dual 16n shift after DNOT16N/DROL16N) */
  if (kw(&L->cur,"DSHL16N")||kw(&L->cur,"S2SHL16N")||kw(&L->cur,"STACK2SHL16N")||
      kw(&L->cur,"PAIRSHL16N")||kw(&L->cur,"DLSH16N")||kw(&L->cur,"DSHLWORDN")||
      kw(&L->cur,"DSHIFTWORDL")){
    /* a b + k n → halfword n of each = (uint16)<<k (k>=16 → 0); n clamped 0..3 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long va = (ma >> sh) & 0xFFFFul;
    unsigned long vb = (mb >> sh) & 0xFFFFul;
    unsigned long wa = (kk >= 16) ? 0ul : ((va << (unsigned)kk) & 0xFFFFul);
    unsigned long wb = (kk >= 16) ? 0ul : ((vb << (unsigned)kk) & 0xFFFFul);
    long x = (long)((ma & ~(0xFFFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DSHR16N")||kw(&L->cur,"S2SHR16N")||kw(&L->cur,"STACK2SHR16N")||
      kw(&L->cur,"PAIRSHR16N")||kw(&L->cur,"DLSHR16N")||kw(&L->cur,"DSHRWORDN")||
      kw(&L->cur,"DSHIFTWORDR")){
    /* a b + k n → halfword n of each = (uint16)>>k logical (k>=16 → 0); n clamped 0..3 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long va = (ma >> sh) & 0xFFFFul;
    unsigned long vb = (mb >> sh) & 0xFFFFul;
    unsigned long wa = (kk >= 16) ? 0ul : (va >> (unsigned)kk);
    unsigned long wb = (kk >= 16) ? 0ul : (vb >> (unsigned)kk);
    long x = (long)((ma & ~(0xFFFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DSAR16N")||kw(&L->cur,"S2SAR16N")||kw(&L->cur,"STACK2SAR16N")||
      kw(&L->cur,"PAIRSAR16N")||kw(&L->cur,"DASHR16N")||kw(&L->cur,"DSARWORDN")||
      kw(&L->cur,"DSARSHIFTWORD")){
    /* a b + k n → halfword n of each = (int16)>>k arithmetic (k>=16 → all sign); n clamped 0..3 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    if (vb & 0x8000) vb -= 65536;
    long sa, sb;
    if (kk >= 16){ sa = (va < 0) ? -1L : 0L; sb = (vb < 0) ? -1L : 0L; }
    else { sa = va >> kk; sb = vb >> kk; }
    unsigned long wa = (unsigned long)sa & 0xFFFFul;
    unsigned long wb = (unsigned long)sb & 0xFFFFul;
    long x = (long)((ma & ~(0xFFFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  /* digit-1 dual-stack imm 16-bit field zeros+signed: DCLZ16N · DCTZ16N · DNEG16N
   * (halfword ladder of DCLZ8N/DCTZ8N/DNEG8N; dual of SCLZ16N after DPARITY16N) */
  if (kw(&L->cur,"DCLZ16N")||kw(&L->cur,"S2CLZ16N")||kw(&L->cur,"STACK2CLZ16N")||
      kw(&L->cur,"PAIRCLZ16N")||kw(&L->cur,"DNLZ16N")||kw(&L->cur,"DCLZWORDN")||
      kw(&L->cur,"DWORDCLZN")){
    /* a b + n → halfword n of each = clz16(hw); 0 → 16; n clamped 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long ma = (unsigned long)vm->stack[vm->sp - 2];
    unsigned long mb = (unsigned long)vm->stack[vm->sp - 1];
    unsigned int wa = (unsigned int)((ma >> sh) & 0xFFFFul);
    unsigned int wb = (unsigned int)((mb >> sh) & 0xFFFFul);
    unsigned long cza = 0, czb = 0;
    if (wa == 0) cza = 16;
    else { for (int b = 15; b >= 0; b--){ if (wa & (1u << (unsigned)b)) break; cza++; } }
    if (wb == 0) czb = 16;
    else { for (int b = 15; b >= 0; b--){ if (wb & (1u << (unsigned)b)) break; czb++; } }
    long x = (long)((ma & ~(0xFFFFul << sh)) | ((cza & 0xFFFFul) << sh));
    long y = (long)((mb & ~(0xFFFFul << sh)) | ((czb & 0xFFFFul) << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"DCTZ16N")||kw(&L->cur,"S2CTZ16N")||kw(&L->cur,"STACK2CTZ16N")||
      kw(&L->cur,"PAIRCTZ16N")||kw(&L->cur,"DNTZ16N")||kw(&L->cur,"DCTZWORDN")||
      kw(&L->cur,"DWORDCTZN")){
    /* a b + n → halfword n of each = ctz16(hw); 0 → 16; n clamped 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long x = (long)((ma & ~(0xFFFFul << sh)) | ((tza & 0xFFFFul) << sh));
    long y = (long)((mb & ~(0xFFFFul << sh)) | ((tzb & 0xFFFFul) << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"DNEG16N")||kw(&L->cur,"S2NEG16N")||kw(&L->cur,"STACK2NEG16N")||
      kw(&L->cur,"PAIRNEG16N")||kw(&L->cur,"DINEG16N")||kw(&L->cur,"DNEGWORDN")||
      kw(&L->cur,"DWORDNEGN")){
    /* a b + n → halfword n of each = -(int16) as uint16; min int16 -32768 stays 0x8000; n clamped 0..3 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    if (va & 0x8000) va -= 65536;
    if (vb & 0x8000) vb -= 65536;
    long na = (va == -32768L) ? -32768L : -va;
    long nb = (vb == -32768L) ? -32768L : -vb;
    unsigned long nva = (unsigned long)(na & 0xFFFF);
    unsigned long nvb = (unsigned long)(nb & 0xFFFF);
    long x = (long)((ma & ~(0xFFFFul << sh)) | (nva << sh));
    long y = (long)((mb & ~(0xFFFFul << sh)) | (nvb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  /* digit-1 dual-stack imm 32-bit field unary+rotate: DNOT32N · DROL32N · DROR32N
   * (word ladder of DNOT16N/DROL16N/DROR16N; dual of SNOT32N; start dual 32n unary) */
  if (kw(&L->cur,"DNOT32N")||kw(&L->cur,"S2NOT32N")||kw(&L->cur,"STACK2NOT32N")||
      kw(&L->cur,"PAIRNOT32N")||kw(&L->cur,"DINV32N")||kw(&L->cur,"DINVERT32N")||
      kw(&L->cur,"DNOTDWN")){
    /* a b + n → word n of each = ~w & 0xFFFFFFFF; n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long ma = (unsigned long)vm->stack[vm->sp - 2];
    unsigned long mb = (unsigned long)vm->stack[vm->sp - 1];
    unsigned long wa = (~((ma >> sh) & 0xFFFFFFFFul)) & 0xFFFFFFFFul;
    unsigned long wb = (~((mb >> sh) & 0xFFFFFFFFul)) & 0xFFFFFFFFul;
    long x = (long)((ma & ~(0xFFFFFFFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFFFFFFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DROL32N")||kw(&L->cur,"S2ROL32N")||kw(&L->cur,"STACK2ROL32N")||
      kw(&L->cur,"PAIRROL32N")||kw(&L->cur,"DROTL32N")||kw(&L->cur,"DROLDWN")||
      kw(&L->cur,"DROTDWL")){
    /* a b + k n → rotl32 word n of each by k&31; n clamped 0..1 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long ra = (kk == 0) ? va : (((va << (unsigned)kk) | (va >> (unsigned)(32 - kk))) & 0xFFFFFFFFul);
    unsigned long rb = (kk == 0) ? vb : (((vb << (unsigned)kk) | (vb >> (unsigned)(32 - kk))) & 0xFFFFFFFFul);
    long x = (long)((ma & ~(0xFFFFFFFFul << sh)) | (ra << sh));
    long y = (long)((mb & ~(0xFFFFFFFFul << sh)) | (rb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"DROR32N")||kw(&L->cur,"S2ROR32N")||kw(&L->cur,"STACK2ROR32N")||
      kw(&L->cur,"PAIRROR32N")||kw(&L->cur,"DROTR32N")||kw(&L->cur,"DRORDWN")||
      kw(&L->cur,"DROTDWR")){
    /* a b + k n → rotr32 word n of each by k&31; n clamped 0..1 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-8 dual-stack imm 32-bit field shift: DSHL32N · DSHR32N · DSAR32N
   * (word ladder of DSHL16N/DSHR16N/DSAR16N; dual of SSHL32N after DNOT32N) */
  if (kw(&L->cur,"DSHL32N")||kw(&L->cur,"S2SHL32N")||kw(&L->cur,"STACK2SHL32N")||
      kw(&L->cur,"PAIRSHL32N")||kw(&L->cur,"DLSH32N")||kw(&L->cur,"DSHLDWN")||
      kw(&L->cur,"DSHIFTDWL")){
    /* a b + k n → word n of each = (uint32)<<k (k>=32 → 0); n clamped 0..1 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long va = (ma >> sh) & 0xFFFFFFFFul;
    unsigned long vb = (mb >> sh) & 0xFFFFFFFFul;
    unsigned long wa = (kk >= 32) ? 0ul : ((va << (unsigned)kk) & 0xFFFFFFFFul);
    unsigned long wb = (kk >= 32) ? 0ul : ((vb << (unsigned)kk) & 0xFFFFFFFFul);
    long x = (long)((ma & ~(0xFFFFFFFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFFFFFFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DSHR32N")||kw(&L->cur,"S2SHR32N")||kw(&L->cur,"STACK2SHR32N")||
      kw(&L->cur,"PAIRSHR32N")||kw(&L->cur,"DLSHR32N")||kw(&L->cur,"DSHRDWN")||
      kw(&L->cur,"DSHIFTDWR")){
    /* a b + k n → word n of each = (uint32)>>k logical (k>=32 → 0); n clamped 0..1 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long va = (ma >> sh) & 0xFFFFFFFFul;
    unsigned long vb = (mb >> sh) & 0xFFFFFFFFul;
    unsigned long wa = (kk >= 32) ? 0ul : (va >> (unsigned)kk);
    unsigned long wb = (kk >= 32) ? 0ul : (vb >> (unsigned)kk);
    long x = (long)((ma & ~(0xFFFFFFFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFFFFFFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DSAR32N")||kw(&L->cur,"S2SAR32N")||kw(&L->cur,"STACK2SAR32N")||
      kw(&L->cur,"PAIRSAR32N")||kw(&L->cur,"DASHR32N")||kw(&L->cur,"DSARDWN")||
      kw(&L->cur,"DSARSHIFTDW")){
    /* a b + k n → word n of each = (int32)>>k arithmetic (k>=32 → all sign); n clamped 0..1 */
    lex_next(L);
    long k = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    unsigned long ma = (unsigned long)vm->stack[vm->sp - 2];
    unsigned long mb = (unsigned long)vm->stack[vm->sp - 1];
    long va = (long)((ma >> sh) & 0xFFFFFFFFul);
    long vb = (long)((mb >> sh) & 0xFFFFFFFFul);
    if (va & 0x80000000L) va -= 4294967296L;
    if (vb & 0x80000000L) vb -= 4294967296L;
    long sa, sb;
    if (kk >= 32){ sa = (va < 0) ? -1L : 0L; sb = (vb < 0) ? -1L : 0L; }
    else { sa = va >> kk; sb = vb >> kk; }
    unsigned long wa = (unsigned long)sa & 0xFFFFFFFFul;
    unsigned long wb = (unsigned long)sb & 0xFFFFFFFFul;
    long x = (long)((ma & ~(0xFFFFFFFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFFFFFFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  /* digit-1 dual-stack imm 32-bit field abs+extend: DABS32N · DSEXT32N · DZEXT32N
   * (word ladder of DABS16N/DSEXT16N/DZEXT16N; dual of SABS32N after DSHL32N) */
  if (kw(&L->cur,"DABS32N")||kw(&L->cur,"S2ABS32N")||kw(&L->cur,"STACK2ABS32N")||
      kw(&L->cur,"PAIRABS32N")||kw(&L->cur,"DIABS32N")||kw(&L->cur,"DABSDWN")||
      kw(&L->cur,"DDWABSN")){
    /* a b + n → word n of each = abs(int32); min -2147483648 → 0x80000000; n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long nva = (unsigned long)(ara & 0xFFFFFFFFul);
    unsigned long nvb = (unsigned long)(arb & 0xFFFFFFFFul);
    long x = (long)((ma & ~(0xFFFFFFFFul << sh)) | (nva << sh));
    long y = (long)((mb & ~(0xFFFFFFFFul << sh)) | (nvb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"DSEXT32N")||kw(&L->cur,"S2SEXT32N")||kw(&L->cur,"STACK2SEXT32N")||
      kw(&L->cur,"PAIRSEXT32N")||kw(&L->cur,"DSIGNEXT32N")||kw(&L->cur,"DSEXTDWN")||
      kw(&L->cur,"DDWSEXTN")){
    /* a b + n → each cell = sign-extend word n to full width; n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  if (kw(&L->cur,"DZEXT32N")||kw(&L->cur,"S2ZEXT32N")||kw(&L->cur,"STACK2ZEXT32N")||
      kw(&L->cur,"PAIRZEXT32N")||kw(&L->cur,"DZEROEXT32N")||kw(&L->cur,"DZEXTDWN")||
      kw(&L->cur,"DDWZEXTN")){
    /* a b + n → each cell = zero-extend word n; n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long ma = (unsigned long)vm->stack[vm->sp - 2];
    unsigned long mb = (unsigned long)vm->stack[vm->sp - 1];
    long xa = (long)((ma >> sh) & 0xFFFFFFFFul);
    long yb = (long)((mb >> sh) & 0xFFFFFFFFul);
    vm->stack[vm->sp - 2] = xa;
    vm->stack[vm->sp - 1] = yb;
    var_set_num(vm,"LAST_N",yb); vm->last_n=yb;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  /* digit-1 dual-stack imm 32-bit field zeros+signed: DCLZ32N · DCTZ32N · DNEG32N
   * (word ladder of DCLZ16N/DCTZ16N/DNEG16N; dual of SCLZ32N after DABS32N) */
  if (kw(&L->cur,"DCLZ32N")||kw(&L->cur,"S2CLZ32N")||kw(&L->cur,"STACK2CLZ32N")||
      kw(&L->cur,"PAIRCLZ32N")||kw(&L->cur,"DNLZ32N")||kw(&L->cur,"DCLZDWN")||
      kw(&L->cur,"DDWCLZN")){
    /* a b + n → word n of each = clz32(w); 0 → 32; n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    unsigned long ma = (unsigned long)vm->stack[vm->sp - 2];
    unsigned long mb = (unsigned long)vm->stack[vm->sp - 1];
    unsigned int wa = (unsigned int)((ma >> sh) & 0xFFFFFFFFul);
    unsigned int wb = (unsigned int)((mb >> sh) & 0xFFFFFFFFul);
    unsigned long cza = 0, czb = 0;
    if (wa == 0) cza = 32;
    else { for (int b = 31; b >= 0; b--){ if (wa & (1u << (unsigned)b)) break; cza++; } }
    if (wb == 0) czb = 32;
    else { for (int b = 31; b >= 0; b--){ if (wb & (1u << (unsigned)b)) break; czb++; } }
    long x = (long)((ma & ~(0xFFFFFFFFul << sh)) | ((cza & 0xFFFFFFFFul) << sh));
    long y = (long)((mb & ~(0xFFFFFFFFul << sh)) | ((czb & 0xFFFFFFFFul) << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"DCTZ32N")||kw(&L->cur,"S2CTZ32N")||kw(&L->cur,"STACK2CTZ32N")||
      kw(&L->cur,"PAIRCTZ32N")||kw(&L->cur,"DNTZ32N")||kw(&L->cur,"DCTZDWN")||
      kw(&L->cur,"DDWCTZN")){
    /* a b + n → word n of each = ctz32(w); 0 → 32; n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long x = (long)((ma & ~(0xFFFFFFFFul << sh)) | ((tza & 0xFFFFFFFFul) << sh));
    long y = (long)((mb & ~(0xFFFFFFFFul << sh)) | ((tzb & 0xFFFFFFFFul) << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"DNEG32N")||kw(&L->cur,"S2NEG32N")||kw(&L->cur,"STACK2NEG32N")||
      kw(&L->cur,"PAIRNEG32N")||kw(&L->cur,"DINEG32N")||kw(&L->cur,"DNEGDWN")||
      kw(&L->cur,"DDWNEGN")){
    /* a b + n → word n of each = -(int32) as uint32; min int32 stays 0x80000000; n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    if (va & 0x80000000L) va -= 4294967296L;
    if (vb & 0x80000000L) vb -= 4294967296L;
    long na = (va == -2147483648L) ? -2147483648L : -va;
    long nb = (vb == -2147483648L) ? -2147483648L : -vb;
    unsigned long nva = (unsigned long)(na & 0xFFFFFFFFul);
    unsigned long nvb = (unsigned long)(nb & 0xFFFFFFFFul);
    long x = (long)((ma & ~(0xFFFFFFFFul << sh)) | (nva << sh));
    long y = (long)((mb & ~(0xFFFFFFFFul << sh)) | (nvb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  /* digit-8 dual-stack imm 32-bit field metrics: DBITREV32N · DPOPCNT32N · DPARITY32N
   * (word ladder of DBITREV16N/DPOPCNT16N/DPARITY16N; dual of SBITREV32N after DCLZ32N) */
  if (kw(&L->cur,"DBITREV32N")||kw(&L->cur,"S2BITREV32N")||kw(&L->cur,"STACK2BITREV32N")||
      kw(&L->cur,"PAIRBITREV32N")||kw(&L->cur,"DBREV32N")||kw(&L->cur,"DREV32N")||
      kw(&L->cur,"DBITREVDWN")){
    /* a b + n → word n of each = bitrev32(w); n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long x = (long)((ma & ~(0xFFFFFFFFul << sh)) | ((ra & 0xFFFFFFFFul) << sh));
    long y = (long)((mb & ~(0xFFFFFFFFul << sh)) | ((rb & 0xFFFFFFFFul) << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"DPOPCNT32N")||kw(&L->cur,"S2POPCNT32N")||kw(&L->cur,"STACK2POPCNT32N")||
      kw(&L->cur,"PAIRPOPCNT32N")||kw(&L->cur,"DPCNT32N")||kw(&L->cur,"DPOPDWN")||
      kw(&L->cur,"DDWPOPN")){
    /* a b + n → word n of each = popcount(w); n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    while (va){ pa += (va & 1u); va >>= 1; }
    while (vb){ pb += (vb & 1u); vb >>= 1; }
    long x = (long)((ma & ~(0xFFFFFFFFul << sh)) | ((pa & 0xFFFFFFFFul) << sh));
    long y = (long)((mb & ~(0xFFFFFFFFul << sh)) | ((pb & 0xFFFFFFFFul) << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  }
  if (kw(&L->cur,"DPARITY32N")||kw(&L->cur,"S2PARITY32N")||kw(&L->cur,"STACK2PARITY32N")||
      kw(&L->cur,"PAIRPARITY32N")||kw(&L->cur,"DXORRED32N")||kw(&L->cur,"DPARITYDWN")||
      kw(&L->cur,"DDWPARN")){
    /* a b + n → word n of each = xor-reduce(w) in low bit; n clamped 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    while (va){ pra ^= (va & 1u); va >>= 1; }
    while (vb){ prb ^= (vb & 1u); vb >>= 1; }
    long x = (long)((ma & ~(0xFFFFFFFFul << sh)) | (pra << sh));
    long y = (long)((mb & ~(0xFFFFFFFFul << sh)) | (prb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
    var_set_num(vm,"LAST_N",y); vm->last_n=y;
    var_set_num(vm,"SP",vm->sp); var_set_num(vm,"OK",1); bump(vm); return 1;
  ...
  /* digit-5 dual-stack imm 32-bit field max+eq: DMAX32N · DEQ32N · DNE32N
   * (word ladder of DMAX16N/DEQ16N/DNE16N; dual of SMAX32N after DMIN32N) */
  if (kw(&L->cur,"DMAX32N")||kw(&L->cur,"S2MAX32N")||kw(&L->cur,"STACK2MAX32N")||
      kw(&L->cur,"PAIRMAX32N")||kw(&L->cur,"DMAXDIMM")||kw(&L->cur,"DGE32N")||
      kw(&L->cur,"DMAXDWN")){
    /* a b + field n → word n of each = max(w, field) unsigned; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"DEQ32N")||kw(&L->cur,"S2EQ32N")||kw(&L->cur,"STACK2EQ32N")||
      kw(&L->cur,"PAIREQ32N")||kw(&L->cur,"DEQDIMM")||kw(&L->cur,"DCMPEQ32N")||
      kw(&L->cur,"DEQDWN")){
    /* a b + field n → word n of each = (w == field) ? 1 : 0; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"DNE32N")||kw(&L->cur,"S2NE32N")||kw(&L->cur,"STACK2NE32N")||
      kw(&L->cur,"PAIRNE32N")||kw(&L->cur,"DNEDIMM")||kw(&L->cur,"DCMPNE32N")||
      kw(&L->cur,"DNEDWN")){
    /* a b + field n → word n of each = (w != field) ? 1 : 0; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  /* digit-6 dual-stack imm 32-bit field ordered-cmp: DLT32N · DGT32N · DLTE32N
   * (unsigned predicates after DEQ32N/DNE32N; dual of SLT32N/SGT32N/SLTE32N) */
  if (kw(&L->cur,"DLT32N")||kw(&L->cur,"S2LT32N")||kw(&L->cur,"STACK2LT32N")||
      kw(&L->cur,"PAIRLT32N")||kw(&L->cur,"DCMPLT32N")||kw(&L->cur,"DLTDIMM")||
      kw(&L->cur,"DLTDWN")){
    /* a b + field n → word n of each = (w < field) ? 1 : 0; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  if (kw(&L->cur,"DGT32N")||kw(&L->cur,"S2GT32N")||kw(&L->cur,"STACK2GT32N")||
      kw(&L->cur,"PAIRGT32N")||kw(&L->cur,"DCMPGT32N")||kw(&L->cur,"DGTDIMM")||
      kw(&L->cur,"DGTDWN")){
    /* a b + field n → word n of each = (w > field) ? 1 : 0; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  if (kw(&L->cur,"DLTE32N")||kw(&L->cur,"S2LTE32N")||kw(&L->cur,"STACK2LTE32N")||
      kw(&L->cur,"PAIRLTE32N")||kw(&L->cur,"DCMPLE32N")||kw(&L->cur,"DLEQ32N")||
      kw(&L->cur,"DLTEDIMM")||kw(&L->cur,"DLTEDWN")){
    /* a b + field n → word n of each = (w <= field) ? 1 : 0; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
  ...
  /* digit-0 dual-stack imm 32-bit field GTE: DGTE32N (dual of SGTE32N after DLTE32N) */
  if (kw(&L->cur,"DGTE32N")||kw(&L->cur,"S2GTE32N")||kw(&L->cur,"STACK2GTE32N")||
      kw(&L->cur,"PAIRGTE32N")||kw(&L->cur,"DCMPGE32N")||kw(&L->cur,"DGEQ32N")||
      kw(&L->cur,"DGTEDIMM")||kw(&L->cur,"DGTEDWN")){
    /* a b + field n → word n of each = (w >= field) ? 1 : 0; n clamped 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
  ...
  /* digit-7 dual-stack imm 32-bit field signed ordered-cmp: DLTS32N · DGTS32N · DLTES32N · DGTES32N
   * (dual of SLTS32N/SGTS32N/SLTES32N/SGTES32N; signed int32 plane on top two) */
  if (kw(&L->cur,"DLTS32N")||kw(&L->cur,"S2LTS32N")||kw(&L->cur,"STACK2LTS32N")||
      kw(&L->cur,"PAIRLTS32N")||kw(&L->cur,"DCMPLTS32N")||kw(&L->cur,"DLTSSIGN32N")||
      kw(&L->cur,"DLTS32IMM")){
    /* a b + field n → word n of each = (int32(w) < int32(field)) ? 1 : 0; n 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  if (kw(&L->cur,"DGTS32N")||kw(&L->cur,"S2GTS32N")||kw(&L->cur,"STACK2GTS32N")||
      kw(&L->cur,"PAIRGTS32N")||kw(&L->cur,"DCMPGTS32N")||kw(&L->cur,"DGTSSIGN32N")||
      kw(&L->cur,"DGTS32IMM")){
    /* a b + field n → word n of each = (int32(w) > int32(field)) ? 1 : 0; n 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  if (kw(&L->cur,"DLTES32N")||kw(&L->cur,"S2LTES32N")||kw(&L->cur,"STACK2LTES32N")||
      kw(&L->cur,"PAIRLTES32N")||kw(&L->cur,"DCMPLES32N")||kw(&L->cur,"DLEQS32N")||
      kw(&L->cur,"DLTES32IMM")){
    /* a b + field n → word n of each = (int32(w) <= int32(field)) ? 1 : 0; n 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  if (kw(&L->cur,"DGTES32N")||kw(&L->cur,"S2GTES32N")||kw(&L->cur,"STACK2GTES32N")||
      kw(&L->cur,"PAIRGTES32N")||kw(&L->cur,"DCMPGES32N")||kw(&L->cur,"DGEQS32N")||
      kw(&L->cur,"DGTES32IMM")){
    /* a b + field n → word n of each = (int32(w) >= int32(field)) ? 1 : 0; n 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
  ...
  /* digit-5 dual-stack imm 32-bit field signed min/max: DMINS32N · DMAXS32N
   * (dual of SMINS32N/SMAXS32N; signed select after DLTS32N plane) */
  if (kw(&L->cur,"DMINS32N")||kw(&L->cur,"S2MINS32N")||kw(&L->cur,"STACK2MINS32N")||
      kw(&L->cur,"PAIRMINS32N")||kw(&L->cur,"DMINSIGN32N")||kw(&L->cur,"DMINS32IMM")||
      kw(&L->cur,"DMINSI32N")){
    /* a b + field n → word n of each = min_signed(int32(w), int32(field)); n 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    ...
    long ma_m = (va < f) ? va : f;
    long mb_m = (vb < f) ? vb : f;
    unsigned long wa = (unsigned long)(unsigned int)ma_m;
    unsigned long wb = (unsigned long)(unsigned int)mb_m;
    long x = (long)((ma & ~(0xFFFFFFFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFFFFFFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  if (kw(&L->cur,"DMAXS32N")||kw(&L->cur,"S2MAXS32N")||kw(&L->cur,"STACK2MAXS32N")||
      kw(&L->cur,"PAIRMAXS32N")||kw(&L->cur,"DMAXSIGN32N")||kw(&L->cur,"DMAXS32IMM")||
      kw(&L->cur,"DMAXSI32N")){
    /* a b + field n → word n of each = max_signed(int32(w), int32(field)); n 0..1 */
    lex_next(L);
    long field = parse_expr(vm,L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
  ...
  /* digit-0 dual-stack imm 32-bit field signed signum: DSIGN32N (dual of SSIGN32N) */
  if (kw(&L->cur,"DSIGN32N")||kw(&L->cur,"S2SIGN32N")||kw(&L->cur,"STACK2SIGN32N")||
      kw(&L->cur,"PAIRSIGN32N")||kw(&L->cur,"DSIGNUM32N")||kw(&L->cur,"DSGN32N")||
      kw(&L->cur,"DSIGN32IMM")){
    /* a b + n → word n of each = sgn(int32): +1 / 0 / 0xFFFFFFFF; n 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
    ...
    long va = (long)(int)((unsigned int)((ma >> sh) & 0xFFFFFFFFul));
    long vb = (long)(int)((unsigned int)((mb >> sh) & 0xFFFFFFFFul));
    unsigned long wa = (va > 0) ? 1ul : ((va < 0) ? 0xFFFFFFFFul : 0ul);
    unsigned long wb = (vb > 0) ? 1ul : ((vb < 0) ? 0xFFFFFFFFul : 0ul);
    long x = (long)((ma & ~(0xFFFFFFFFul << sh)) | (wa << sh));
    long y = (long)((mb & ~(0xFFFFFFFFul << sh)) | (wb << sh));
    vm->stack[vm->sp - 2] = x;
    vm->stack[vm->sp - 1] = y;
  ...
  /* digit-4 dual-stack imm 32-bit field zero-eq: D0EQ32N (dual of S0EQ32N) */
  if (kw(&L->cur,"D0EQ32N")||kw(&L->cur,"S20EQ32N")||kw(&L->cur,"STACK20EQ32N")||
      kw(&L->cur,"PAIR0EQ32N")||kw(&L->cur,"DZ32N")||kw(&L->cur,"DEQZ32N")||
      kw(&L->cur,"D0EQ32IMM")){
  ...
  /* digit-8 dual-stack imm 32-bit field signed LT0: D0LT32N (dual of S0LT32N) */
  if (kw(&L->cur,"D0LT32N")||kw(&L->cur,"S20LT32N")||kw(&L->cur,"STACK20LT32N")||
      kw(&L->cur,"PAIR0LT32N")||kw(&L->cur,"DLT032N")||kw(&L->cur,"DNEGZ32N")||
      kw(&L->cur,"D0LT32IMM")){
    /* a b + n → word n of each = (int32(w) < 0) ? 1 : 0; n 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
    if (vm->sp < 2){ var_set_num(vm,"OK",0); bump(vm); return 1; }
    if (n < 0) n = 0;
  ...
  /* digit-9 dual-stack imm 32-bit field signed GT0: D0GT32N (dual of S0GT32N) */
  if (kw(&L->cur,"D0GT32N")||kw(&L->cur,"S20GT32N")||kw(&L->cur,"STACK20GT32N")||
      kw(&L->cur,"PAIR0GT32N")||kw(&L->cur,"DGT032N")||kw(&L->cur,"DPOSZ32N")||
      kw(&L->cur,"D0GT32IMM")){
    /* a b + n → word n of each = (int32(w) > 0) ? 1 : 0; n 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
  ...
  /* digit-4 dual-stack imm 32-bit field signed LE0: D0LE32N (dual of S0LE32N) */
  if (kw(&L->cur,"D0LE32N")||kw(&L->cur,"S20LE32N")||kw(&L->cur,"STACK20LE32N")||
      kw(&L->cur,"PAIR0LE32N")||kw(&L->cur,"DLE032N")||kw(&L->cur,"DNONPOS32N")||
      kw(&L->cur,"D0LE32IMM")){
    /* a b + n → word n of each = (int32(w) <= 0) ? 1 : 0; n 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
  ...
  /* digit-1 dual-stack imm 32-bit field signed GE0: D0GE32N (dual of S0GE32N) */
  if (kw(&L->cur,"D0GE32N")||kw(&L->cur,"S20GE32N")||kw(&L->cur,"STACK20GE32N")||
      kw(&L->cur,"PAIR0GE32N")||kw(&L->cur,"DGE032N")||kw(&L->cur,"DNONNEG32N")||
      kw(&L->cur,"D0GE32IMM")){
    /* a b + n → word n of each = (int32(w) >= 0) ? 1 : 0; n 0..1 */
    lex_next(L);
    long n = parse_expr(vm,L);
