...
int cubalc_lang_ops_smx(VM *vm, Lex *L){
  ...
  if (kw(&L->cur,"THERMOSPHERE")||kw(&L->cur,"THERMO")||kw(&L->cur,"THERMAL")||
    ...
    }
    {
      ...
      var_set_num(vm, "SMX_EXOSPHERE", (long)(tm_ok ? 1 : 0));
