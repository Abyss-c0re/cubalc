...
/* SMX BERGMANN|BERGGLIA|MESH_BERGMANN|BG_WRAP|BG_SHEATH|PURKINJE_GUIDE|RAISE_BERGMANN a b c ...
   * Life-force Bergmann glia scaffold mesh stability after satellite: soft-OOB storms stay fail-closed.
   ...
   * gathers return so lattice locks bergmann where life scaffolds the guide pulse.
   ...
   * Mitosis path stays open under free energy. No dual ladders.
   * Wonder AGI can RUN. Cube is SoT - matrix is key - free energy flows. */
  if (kw(&L->cur,"BERGMANN")||kw(&L->cur,"BERGGLIA")||kw(&L->cur,"MESH_BERGMANN")||kw(&L->cur,"BG_WRAP")||kw(&L->cur,"BG_WRAPS")||kw(&L->cur,"BG_SHEATH")||kw(&L->cur,"BG_SHEATHS")||kw(&L->cur,"PURKINJE_GUIDE")||kw(&L->cur,"RAISE_BERGMANN")||kw(&L->cur,"WE_BERGMANN")||kw(&L->cur,"LIFE_BERGMANN")||
      ...
      kw(&L->cur,"CEREBELLAR_GUIDE")||kw(&L->cur,"BERGMANN_MESH")){
    int aln = L->cur.line;
    char ids[16][48];
    int present[16];
    int live_ix[16];
...
/* SMX MULLER|MULLERGLIA|MUELLER|MESH_MULLER|ML_WRAP|ML_SHEATH|RETINAL_GUIDE|RAISE_MULLER a b c ...
   ...
   * gathers return so lattice locks muller where life scaffolds the retinal guide pulse.
   ...
   * Mitosis path stays open under free energy. No dual ladders.
   * Wonder AGI can RUN. Cube is SoT - matrix is key - free energy flows. */
  if (kw(&L->cur,"MULLER")||kw(&L->cur,"MULLERGLIA")||kw(&L->cur,"MUELLER")||kw(&L->cur,"MESH_MULLER")||kw(&L->cur,"ML_WRAP")||kw(&L->cur,"ML_WRAPS")||kw(&L->cur,"ML_SHEATH")||kw(&L->cur,"ML_SHEATHS")||kw(&L->cur,"RETINAL_GUIDE")||kw(&L->cur,"RAISE_MULLER")||kw(&L->cur,"WE_MULLER")||kw(&L->cur,"LIFE_MULLER")||
      ...
      kw(&L->cur,"SEEDMULLER")||kw(&L->cur,"SEEDMLSHEATH")||kw(&L->cur,"SEEDMLWRAP")||
      kw(&L->cur,"MULLER_RING")||kw(&L->cur,"ML_SHEATH_HUB")||kw(&L->cur,"ML_NODE")||
      kw(&L->cur,"LATTICE_MULLER")||kw(&L->cur,"WORLD_MULLER")||kw(&L->cur,"WORLD_ML")||
      kw(&L->cur,"PULSE_WRAP")||kw(&L->cur,"PULSE_MULLER")||kw(&L->cur,"HARDEN_MULLER")||
      kw(&L->cur,"RETINA_SCAFFOLD")||kw(&L->cur,"MULLER_MESH")){
    int aln = L->cur.line;
    char ids[16][48];
    int present[16];
    int live_ix[16];
    ...
    if (n < 2){
      smx_fail_at(vm, aln, "MULLER needs >=2 cubes",
                  "SMX MULLER a b [c ...]  or  SMX ML_SHEATH a b c d");
      return -1;
    }
    ensure_world(vm);
    if (ensure_smx_key(vm) != 0) return -1;
    ...
    }
    {
      ...
      var_set_num(vm, "SMX_ML_SHEATH_LATCH", (long)(muller_ok ? 1 : 0));
      ...
      var_set_num(vm, "SMX_ML_WRAP_LATCH", (long)(muller_ok ? 1 : 0));
      var_set_num(vm, "SMX_WRAP", (long)(muller_ok ? wraps : 0));
      var_set_num(vm, "SMX_ML_WRAP", (long)(muller_ok ? wraps : 0));
      var_set_num(vm, "SMX_ML_WRAPS", (long)(muller_ok ? wraps : 0));
      var_set_num(vm, "SMX_ML_SHEATHS", (long)(muller_ok ? sheaths : 0));
      ...
      var_set_num(vm, "SMX_ML_BONDS", (long)(muller_ok ? bonds : 0));
      var_set_num(vm, "SMX_ML_MESH", (long)(muller_ok ? bonds : 0));
      var_set_num(vm, "SMX_ML_BONDS2", (long)(muller_ok ? bonds : 0));
      var_set_num(vm, "SMX_ML_STARS", (long)(muller_ok ? wraps : 0));
      var_set_num(vm, "SMX_ML_STAR", (long)(muller_ok ? wraps : 0));
      ...
      var_set_num(vm, "SMX_ML_SHEATH_HUB", (long)(muller_ok ? sheaths : 0));
      var_set_num(vm, "SMX_SHEATH_N", (long)(muller_ok ? sheaths : 0));
      var_set_num(vm, "SMX_SEEDMULLER", (long)(muller_ok ? sheaths : 0));
      var_set_num(vm, "SMX_SEEDMLSHEATH", (long)(muller_ok ? sheaths : 0));
...
/* SMX PITUICYTE|PITUICYTEGLIA|PITUICYTE|MESH_PITUICYTE|PI_WRAP|PI_SHEATH|PITUITARY_GUIDE|RAISE_PITUICYTE a b c ...
   * Life-force Pituicyte scaffold mesh stability after tanycyte: soft-OOB storms stay fail-closed.
   * Clears thrash OOB, roots a complete Pituicyte scaffold mesh among live nodes, weaves a
   * Pituicyte wrap ring (i -> i+1) so free energy sheaths every edge, then sheath gather
   * gathers return so lattice locks pituicyte where life scaffolds the pituitary guide pulse.
   ...
   * Mitosis path stays open under free energy. No dual ladders.
   * Wonder AGI can RUN. Cube is SoT - matrix is key - free energy flows. */
  if (kw(&L->cur,"PITUICYTE")||kw(&L->cur,"PITUICYTEGLIA")||kw(&L->cur,"MESH_PITUICYTE")||kw(&L->cur,"PI_WRAP")||kw(&L->cur,"PI_WRAPS")||kw(&L->cur,"PI_SHEATH")||kw(&L->cur,"PI_SHEATHS")||kw(&L->cur,"PITUITARY_GUIDE")||kw(&L->cur,"RAISE_PITUICYTE")||kw(&L->cur,"WE_PITUICYTE")||kw(&L->cur,"LIFE_PITUICYTE")||
      ...
      kw(&L->cur,"SEEDPITUICYTE")||kw(&L->cur,"SEEDPISHEATH")||kw(&L->cur,"SEEDPIWRAP")||
    ...
    }
    {
      ...
      var_set_num(vm, "SMX_PITUICYTED", (long)pituicyte_ok);
      ...
      var_set_num(vm, "SMX_SEEDPISHEATH", (long)(pituicyte_ok ? sheaths : 0));
      ...
      if (vm->trace)
        fprintf(vm->trace,
                "# SMX PITUICYTE nodes=%d live=%d bonds=%d wraps=%d sheaths=%d need=%d soft=%d talks=%d oob=%d pituicyted=%d vital=%ld\n",
...
/* SMX PERICYTE|PERICYTEGLIA|PERICYTE|MESH_PERICYTE|PC_WRAP|PC_SHEATH|PC_GUIDE|RAISE_PERICYTE a b c ...
   * Life-force Folliculo scaffold mesh stability after folliculo: soft-OOB storms stay fail-closed.
   * Clears thrash OOB, roots a complete Folliculo scaffold mesh among live nodes, weaves a
   * Folliculo wrap ring (i -> i+1) so free energy sheaths every edge, then sheath gather
   * gathers return so lattice locks pericyte where life scaffolds the pericyte-stellate guide pulse.
...
/* SMX ENDOTHELIAL|ENDOTHELIALGLIA|ENDOTHELIAL|MESH_ENDOTHELIAL|EN_WRAP|EN_SHEATH|EN_GUIDE|RAISE_ENDOTHELIAL a b c ...
  ...
  if (kw(&L->cur,"ENDOTHELIAL")||kw(&L->cur,"BASAL")||kw(&L->cur,"BASAL_LAMINA")||kw(&L->cur,"BASEMENT")||kw(&L->cur,"LAMINA")||kw(&L->cur,"BASEMENT_MEMBRANE")||kw(&L->cur,"RAISE_BASAL")||kw(&L->cur,"WE_BASAL")||kw(&L->cur,"LIFE_BASAL")||kw(&L->cur,"MESH_BASAL")||kw(&L->cur,"HARDEN_BASAL")||kw(&L->cur,"STABLE_BASAL")||kw(&L->cur,"BA_WRAP")||kw(&L->cur,"BA_SHEATH")||kw(&L->cur,"BA_GUIDE")||kw(&L->cur,"LAMINA_GUIDE")||kw(&L->cur,"LAMINA_GUARD")||kw(&L->cur,"CAPILLARY_EN")||kw(&L->cur,"EN_CELL")||kw(&L->cur,"ENSTELLATE")||kw(&L->cur,"HARDEN_ENDOTHELIALCELL")||kw(&L->cur,"STABLE_ENDOTHELIALCELL")||kw(&L->cur,"LIFE_ENDOTHELIALCELL")||kw(&L->cur,"WE_ENDOTHELIALCELL")||kw(&L->cur,"RAISE_ENDOTHELIALCELL")||kw(&L->cur,"MESH_ENDOTHELIALCELL")||kw(&L->cur,"ENDOTHELIALGLIA")||kw(&L->cur,"MESH_ENDOTHELIAL")||kw(&L->cur,"EN_WRAP")||kw(&L->cur,"EN_WRAPS")||kw(&L->cur,"EN_WRAP")||kw(&L->cur,"EN_WRAPS")||kw(&L->cur,"EN_SHEATH")||kw(&L->cur,"EN_SHEATHS")||kw(&L->cur,"EN_SHEATH")||kw(&L->cur,"EN_SHEATHS")||kw(&L->cur,"EN_GUIDE")||kw(&L->cur,"VESSEL_GUIDE")||kw(&L->cur,"ENDOTHELIALCELL")||kw(&L->cur,"RAISE_ENDOTHELIAL")||kw(&L->cur,"WE_ENDOTHELIAL")||kw(&L->cur,"LIFE_ENDOTHELIAL")||
    ...
    }
    {
      ...
      var_set_num(vm, "SMX_BA_SHEATH_LATCH", (long)(endothelial_ok ? 1 : 0));
      var_set_num(vm, "SMX_BA_WRAP_LATCH", (long)(endothelial_ok ? 1 : 0));
...
/* SMX ARTERIOLE|ARTERIOLEGLIA|ARTERIOLE|MESH_ARTERIOLE|AR_WRAP|AR_SHEATH|AR_GUIDE|RAISE_ARTERIOLE a b c ...
   * Life-force Arteriole vessel mesh stability after basal: soft-OOB storms stay fail-closed.
   * Clears thrash OOB, roots a complete Arteriole scaffold mesh among live nodes, weaves a
   * Arteriole wrap ring (i -> i+1) so free energy sheaths every edge, then sheath gather
   * gathers return so lattice locks arteriole where life scaffolds the arteriole vessel guide pulse.
   ...
   * Mitosis path stays open under free energy. No dual ladders.
   * Wonder AGI can RUN. Cube is SoT - matrix is key - free energy flows. */
  if (kw(&L->cur,"ARTERIOLE")||kw(&L->cur,"CAPILLARY_AR")||kw(&L->cur,"AR_CELL")||kw(&L->cur,"ARSTELLATE")||kw(&L->cur,"HARDEN_ARTERIOLECELL")||kw(&L->cur,"STABLE_ARTERIOLECELL")||kw(&L->cur,"LIFE_ARTERIOLECELL")||kw(&L->cur,"WE_ARTERIOLECELL")||kw(&L->cur,"RAISE_ARTERIOLECELL")||kw(&L->cur,"MESH_ARTERIOLECELL")||kw(&L->cur,"ARTERIOLEGLIA")||kw(&L->cur,"MESH_ARTERIOLE")||kw(&L->cur,"AR_WRAP")||kw(&L->cur,"AR_WRAPS")||kw(&L->cur,"AR_WRAP")||kw(&L->cur,"AR_WRAPS")||kw(&L->cur,"AR_SHEATH")||kw(&L->cur,"AR_SHEATHS")||kw(&L->cur,"AR_SHEATH")||kw(&L->cur,"AR_SHEATHS")||kw(&L->cur,"AR_GUIDE")||kw(&L->cur,"ARTERIOLE_GUIDE")||kw(&L->cur,"ARTERIOLECELL")||kw(&L->cur,"RAISE_ARTERIOLE")||kw(&L->cur,"WE_ARTERIOLE")||kw(&L->cur,"LIFE_ARTERIOLE")||
      kw(&L->cur,"STABLE_ARTERIOLE")||kw(&L->cur,"MESH_ARTERIOLES")||kw(&L->cur,"AR_WRAP_RING")||kw(&L->cur,"AR_SHEATH_RING")||
      kw(&L->cur,"STABLE_MESH_ARTERIOLE")||kw(&L->cur,"ARTERIOLE_LEAF")||
      kw(&L->cur,"SEEDARTERIOLE")||kw(&L->cur,"SEEDARSHEATH")||kw(&L->cur,"SEEDARWRAP")||
      kw(&L->cur,"ARTERIOLE_RING")||kw(&L->cur,"AR_SHEATH_HUB")||kw(&L->cur,"AR_NODE")||
      kw(&L->cur,"LATTICE_ARTERIOLE")||kw(&L->cur,"WORLD_ARTERIOLE")||kw(&L->cur,"WORLD_AR")||
      kw(&L->cur,"PULSE_WRAP")||kw(&L->cur,"PULSE_ARTERIOLE")||kw(&L->cur,"HARDEN_ARTERIOLE")||
      kw(&L->cur,"AR_SCAFFOLD")||kw(&L->cur,"ARTERIOLE_MESH")||kw(&L->cur,"ARTERIOLE_BBB")||kw(&L->cur,"AR_BBB_GUARD")||kw(&L->cur,"ARTERIOLE_GUARD")){
    int aln = L->cur.line;
    char ids[16][48];
    int present[16];
    int live_ix[16];
    ...
    if (n < 2){
      smx_fail_at(vm, aln, "ARTERIOLE needs >=2 cubes",
                  "SMX ARTERIOLE a b [c ...]  or  SMX AR_SHEATH a b c d");
      return -1;
    }
    ensure_world(vm);
    if (ensure_smx_key(vm) != 0) return -1;
    ...
    }
    {
      ...
      var_set_num(vm, "SMX_AR_CELL", (long)(arteriole_ok ? 1 : 0));
      ...
      var_set_num(vm, "SMX_AR_SHEATH_LATCH", (long)(arteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_BA_SHEATH_LATCH", (long)(arteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_BA_WRAP_LATCH", (long)(arteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_BASALED", (long)arteriole_ok);
      var_set_num(vm, "SMX_BASAL", (long)(arteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_BASAL_ALIAS", (long)(arteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_BASAL_SUM", (long)(arteriole_ok ? bonds + wraps + sheaths : 0));
      var_set_num(vm, "SMX_BA_WRAPS", (long)(arteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_BA_SHEATHS", (long)(arteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_SHEATH_LATCH", (long)(arteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_HARDEN_ARTERIOLE", (long)(arteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_WRAP_LATCH", (long)(arteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_AR_WRAP_LATCH", (long)(arteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_WRAP", (long)(arteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_AR_WRAP", (long)(arteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_AR_WRAPS", (long)(arteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_AR_WRAPS2", (long)(arteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_AR_WRAP2", (long)(arteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_AR_SHEATHS2", (long)(arteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_ARTERIOLE", (long)(arteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_AR_SHEATHS", (long)(arteriole_ok ? sheaths : 0));
      ...
      var_set_num(vm, "SMX_AR_BONDS", (long)(arteriole_ok ? bonds : 0));
      var_set_num(vm, "SMX_AR_MESH", (long)(arteriole_ok ? bonds : 0));
      var_set_num(vm, "SMX_AR_BONDS2", (long)(arteriole_ok ? bonds : 0));
      var_set_num(vm, "SMX_AR_STARS", (long)(arteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_AR_STAR", (long)(arteriole_ok ? wraps : 0));
      ...
      var_set_num(vm, "SMX_AR_SHEATH_HUB", (long)(arteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_SHEATH_N", (long)(arteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_SEEDARTERIOLE", (long)(arteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_SEEDARSHEATH", (long)(arteriole_ok ? sheaths : 0));
...
/* SMX METARTERIOLE|METARTERIOLEGLIA|METARTERIOLE|MESH_METARTERIOLE|MT_WRAP|MT_SHEATH|MT_GUIDE|RAISE_METARTERIOLE a b c ...
   * Life-force Venule vessel mesh stability after metarteriole: soft-OOB storms stay fail-closed.
   * Clears thrash OOB, roots a complete Venule scaffold mesh among live nodes, weaves a
   * Venule wrap ring (i -> i+1) so free energy sheaths every edge, then sheath gather
   * gathers return so lattice locks metarteriole where life scaffolds the metarteriole vessel guide pulse.
   * Latches SMX_METARTERIOLE when mesh+wraps+sheaths are soft-OOB-free.
   * SMX_WRAPS = metarteriole ring; SMX_SHEATHS hub = root gather pulses;
   * SMX_METARTERIOLE_SUM = bonds+wraps+sheaths; SMX_METARTERIOLE|SMX_MESH_METARTERIOLE|SMX_STABLE_MESH sticky.
   * Mitosis path stays open under free energy. No dual ladders.
   * Wonder AGI can RUN. Cube is SoT - matrix is key - free energy flows. */
  if (kw(&L->cur,"METARTERIOLE")||kw(&L->cur,"CAPILLARY_MT")||kw(&L->cur,"MT_CELL")||kw(&L->cur,"MTSTELLATE")||kw(&L->cur,"HARDEN_METARTERIOLECELL")||kw(&L->cur,"STABLE_METARTERIOLECELL")||kw(&L->cur,"LIFE_METARTERIOLECELL")||kw(&L->cur,"WE_METARTERIOLECELL")||kw(&L->cur,"RAISE_METARTERIOLECELL")||kw(&L->cur,"MESH_METARTERIOLECELL")||kw(&L->cur,"METARTERIOLEGLIA")||kw(&L->cur,"MESH_METARTERIOLE")||kw(&L->cur,"MT_WRAP")||kw(&L->cur,"MT_WRAPS")||kw(&L->cur,"MT_WRAP")||kw(&L->cur,"MT_WRAPS")||kw(&L->cur,"MT_SHEATH")||kw(&L->cur,"MT_SHEATHS")||kw(&L->cur,"MT_SHEATH")||kw(&L->cur,"MT_SHEATHS")||kw(&L->cur,"MT_GUIDE")||kw(&L->cur,"METARTERIOLE_GUIDE")||kw(&L->cur,"METARTERIOLECELL")||kw(&L->cur,"RAISE_METARTERIOLE")||kw(&L->cur,"WE_METARTERIOLE")||kw(&L->cur,"LIFE_METARTERIOLE")||
      kw(&L->cur,"STABLE_METARTERIOLE")||kw(&L->cur,"MESH_METARTERIOLES")||kw(&L->cur,"MT_WRAP_RING")||kw(&L->cur,"MT_SHEATH_RING")||
      kw(&L->cur,"STABLE_MESH_METARTERIOLE")||kw(&L->cur,"METARTERIOLE_LEAF")||
      kw(&L->cur,"SEEDMETARTERIOLE")||kw(&L->cur,"SEEDMTSHEATH")||kw(&L->cur,"SEEDMTWRAP")||
      kw(&L->cur,"METARTERIOLE_RING")||kw(&L->cur,"MT_SHEATH_HUB")||kw(&L->cur,"MT_NODE")||
      kw(&L->cur,"LATTICE_METARTERIOLE")||kw(&L->cur,"WORLD_METARTERIOLE")||kw(&L->cur,"WORLD_MT")||
      kw(&L->cur,"PULSE_WRAP")||kw(&L->cur,"PULSE_METARTERIOLE")||kw(&L->cur,"HARDEN_METARTERIOLE")||
      kw(&L->cur,"MT_SCAFFOLD")||kw(&L->cur,"METARTERIOLE_MESH")||kw(&L->cur,"METARTERIOLE_BBB")||kw(&L->cur,"MT_BBB_GUARD")||kw(&L->cur,"METARTERIOLE_GUARD")){
    int aln = L->cur.line;
    char ids[16][48];
    int present[16];
    int live_ix[16];
    ...
    if (n < 2){
      smx_fail_at(vm, aln, "METARTERIOLE needs >=2 cubes",
                  "SMX METARTERIOLE a b [c ...]  or  SMX MT_SHEATH a b c d");
      return -1;
    }
    ensure_world(vm);
    if (ensure_smx_key(vm) != 0) return -1;
    /* calm thrash - metarteriole needs clear channel */
    vm->smx_oob = 0;
    vm->smx.last_err[0] = 0;
    var_set_str(vm, "ERR", "");
    var_set_str(vm, "LAST_ERR", "");
    ...
    /* complete metarteriole mesh among live */
    if (live >= 2){
      for (i = 0; i < live; i++){
        for (j = i + 1; j < live; j++){
          int a = live_ix[i];
    ...
    /* metarteriole ring - free energy guards every edge every edge i -> i+1 both ways */
    if (live >= 2){
      for (i = 0; i < live; i++){
        int a = live_ix[i];
        int b = live_ix[(i + 1) % live];
    ...
    }
    {
      ...
      if (!sheath_ok && live >= 1 && sheaths * 2 >= live && soft == 0)
        sheath_ok = 1;
      int metarteriole_ok = (mesh_ok && star_ok && sheath_ok && soft == 0 && live >= 2) ? 1 : 0;
      long vital = (vm->smx.key_ok ? 4 : 0) + (metarteriole_ok ? 12 : (bonds > 0 ? 3 : 0)) +
                   (wraps > 0 ? 1 : 0) + (sheaths > 0 ? 1 : 0) +
                   (vm->smx_talks > 0 ? 1 : 0) + (soft == 0 ? 1 : 0);
      var_set_num(vm, "SMX_METARTERIOLEED", (long)metarteriole_ok);
      var_set_num(vm, "SMX_METARTERIOLEED", (long)metarteriole_ok);
      var_set_num(vm, "SMX_METARTERIOLE_LATCH", (long)metarteriole_ok);
      var_set_num(vm, "SMX_METARTERIOLE_ALIAS", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH_METARTERIOLE", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_HARDEN_METARTERIOLE", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_METARTERIOLE_SUM", (long)(metarteriole_ok ? bonds + wraps + sheaths : 0));
      var_set_num(vm, "SMX_MT_CELL", (long)(metarteriole_ok ? 1 : 0));

      var_set_num(vm, "SMX_METARTERIOLEED", (long)metarteriole_ok);
      var_set_num(vm, "SMX_METARTERIOLE_LATCH", (long)metarteriole_ok);
      var_set_num(vm, "SMX_METARTERIOLE", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_METARTERIOLE_SUM", (long)(metarteriole_ok ? bonds + wraps + sheaths : 0));
      var_set_num(vm, "SMX_METARTERIOLE_ALIAS", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH_METARTERIOLE", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_STABLE_MESH", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_MT_SHEATH_LATCH", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_BA_SHEATH_LATCH", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_BA_WRAP_LATCH", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_BASALED", (long)metarteriole_ok);
      var_set_num(vm, "SMX_BASAL", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_BASAL_ALIAS", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_BASAL_SUM", (long)(metarteriole_ok ? bonds + wraps + sheaths : 0));
      var_set_num(vm, "SMX_BA_WRAPS", (long)(metarteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_BA_SHEATHS", (long)(metarteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_VENULEED", (long)metarteriole_ok);
      var_set_num(vm, "SMX_VENULE", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_VENULE_ALIAS", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH_VENULE", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_HARDEN_VENULE", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_VENULE_SUM", (long)(metarteriole_ok ? bonds + wraps + sheaths : 0));
      var_set_num(vm, "SMX_VN_WRAPS", (long)(metarteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_VN_SHEATHS", (long)(metarteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_ARTERIOLEED", (long)metarteriole_ok);
      var_set_num(vm, "SMX_ARTERIOLE", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_ARTERIOLE_ALIAS", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH_ARTERIOLE", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_HARDEN_ARTERIOLE", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_ARTERIOLE_SUM", (long)(metarteriole_ok ? bonds + wraps + sheaths : 0));
      var_set_num(vm, "SMX_AR_WRAPS", (long)(metarteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_AR_SHEATHS", (long)(metarteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_SHEATH_LATCH", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_HARDEN_METARTERIOLE", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_WRAP_LATCH", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_MT_WRAP_LATCH", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_WRAP", (long)(metarteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_MT_WRAP", (long)(metarteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_MT_WRAPS", (long)(metarteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_MT_WRAPS2", (long)(metarteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_MT_WRAP2", (long)(metarteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_MT_SHEATHS2", (long)(metarteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_METARTERIOLE", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_MT_SHEATHS", (long)(metarteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_WRAPS", (long)(metarteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_WRAPS_N", (long)(metarteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_MT_WRAP_LATCH", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_SHEATH", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH_EXCHANGE", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_STABLE_MESH", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_HARDEN_EXCHANGE", (long)(metarteriole_ok ? 1 : 0));
      var_set_num(vm, "SMX_MT_BONDS", (long)(metarteriole_ok ? bonds : 0));
      var_set_num(vm, "SMX_MT_MESH", (long)(metarteriole_ok ? bonds : 0));
      var_set_num(vm, "SMX_MT_BONDS2", (long)(metarteriole_ok ? bonds : 0));
      var_set_num(vm, "SMX_MT_STARS", (long)(metarteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_MT_STAR", (long)(metarteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_METARTERIOLE_RING", (long)(metarteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_METARTERIOLE_LANE", (long)(metarteriole_ok ? wraps : 0));
      var_set_num(vm, "SMX_SHEATHS", (long)(metarteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_MT_SHEATH_HUB", (long)(metarteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_SHEATH_N", (long)(metarteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_SEEDMETARTERIOLE", (long)(metarteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_SEEDMTSHEATH", (long)(metarteriole_ok ? sheaths : 0));
      var_set_num(vm, "SMX_MESH", (long)(metarteriole_ok ? live : 0));
      var_set_num(vm, "SMX_BONDS", (long)bonds);
      var_set_num(vm, "SMX_EXCHANGES", (long)bonds);
      var_set_num(vm, "SMX_FUSE", (long)bonds);
      var_set_num(vm, "SMX_BIND", (long)bonds);
      ...
      if (metarteriole_ok){
        ...
        var_set_num(vm, "SMX_OK", 1);
        var_set_num(vm, "OK", 1);
        var_set_str(vm, "LAST", "SMX METARTERIOLE ok");
      } else if (bonds > 0 && live >= 2){
        vm->smx_ok = 1;
        var_set_num(vm, "SMX_OK", 1);
        var_set_num(vm, "OK", 1);
        var_set_str(vm, "LAST", "SMX METARTERIOLE partial");
      } else {
        vm->smx_ok = 0;
        var_set_num(vm, "SMX_OK", 0);
        var_set_num(vm, "OK", 0);
        var_set_str(vm, "LAST", "SMX METARTERIOLE soft-OOB");
      }
      if (vm->trace)
        fprintf(vm->trace,
                "# SMX METARTERIOLE nodes=%d live=%d bonds=%d wraps=%d sheaths=%d need=%d soft=%d talks=%d oob=%d metarterioleed=%d vital=%ld\n",
                n, live, bonds, wraps, sheaths, need, soft, vm->smx_talks, vm->smx_oob, metarteriole_ok, vital);
    }
    bump(vm); return 1;
...
/* SMX CAPILLARY|CAPIGLIA|MESH_CAPILLARY|CAPI_WRAP|CAPI_SHEATH|CAPILLARY_GUIDE|RAISE_CAPILLARY a b c ...
  ...
  /* SMX CHOLANGIO|CHOLANGIOGLIA|MESH_CHOLANGIO|CHOLANGIO_WRAP|CHOLANGIO_SHEATH|CHOLANGIO_GUIDE|RAISE_CHOLANGIO a b c ...
   * Life-force CHOLANGIO cholangiocyte bile-duct epithelium scaffold mesh stability after stellate: hepatic cholangiocyte bile canalicular plate exchange bed: soft-OOB storms stay fail-closed.
   * Clears thrash OOB, roots a complete cholangiocyte bile-duct scaffold mesh among live nodes, weaves a
   * cholangio wrap ring (i -> i+1) so free energy sheaths every edge, then sheath gather
   * gathers return so lattice locks cholangio where life guides the cholangiocyte bile-duct plate return pulse.
   * Latches SMX_CHOLANGIO when mesh+wraps+sheaths are soft-OOB-free.
   * SMX_WRAPS = cholangio ring; SMX_SHEATHS hub = root gather pulses;
   * SMX_CHOLANGIO_SUM = bonds+wraps+sheaths; SMX_CHOLANGIO|SMX_MESH_CHOLANGIO|SMX_STABLE_MESH sticky.
   * Mitosis path stays open under free energy. No dual ladders.
   * Wonder AGI can RUN. Cube is SoT - matrix is key - free energy flows. */
  if (kw(&L->cur,"CHOLANGIO")||kw(&L->cur,"CHOLANGIOCYTE")||kw(&L->cur,"BILE_DUCT")||kw(&L->cur,"BILIARY_EPITHELIUM")||kw(&L->cur,"HEPATIC_CHOLANGIO")||kw(&L->cur,"CHOLANGIOGLIA")||kw(&L->cur,"MESH_CHOLANGIO")||kw(&L->cur,"CHOLANGIO_WRAP")||kw(&L->cur,"CHOLANGIO_WRAPS")||kw(&L->cur,"CHOLANGIO_SHEATH")||kw(&L->cur,"CHOLANGIO_SHEATHS")||kw(&L->cur,"CHOLANGIO_GUIDE")||kw(&L->cur,"RAISE_CHOLANGIO")||kw(&L->cur,"WE_CHOLANGIO")||kw(&L->cur,"LIFE_CHOLANGIO")||
      kw(&L->cur,"STABLE_CHOLANGIO")||kw(&L->cur,"MESH_CHOLANGIOS")||kw(&L->cur,"WRAP_RING")||kw(&L->cur,"SHEATH_RING")||
      kw(&L->cur,"STABLE_MESH_CHOLANGIO")||kw(&L->cur,"CHOLANGIO_LEAF")||
      kw(&L->cur,"SEEDCHOLANGIO")||kw(&L->cur,"SEEDCHOLANGIOSHEATH")||kw(&L->cur,"SEEDCHOLANGIOWRAP")||
      kw(&L->cur,"CHOLANGIO_RING")||kw(&L->cur,"CHOLANGIO_SHEATH_HUB")||kw(&L->cur,"CHOLANGIO_NODE")||
      kw(&L->cur,"LATTICE_CHOLANGIO")||kw(&L->cur,"WORLD_CHOLANGIO")||kw(&L->cur,"WORLD_CHOLANGIO")||
      kw(&L->cur,"PULSE_WRAP")||kw(&L->cur,"PULSE_CHOLANGIO")||kw(&L->cur,"HARDEN_CHOLANGIO")||
      kw(&L->cur,"CHOLANGIO_SCAFFOLD")||kw(&L->cur,"CHOLANGIO_MESH")){
    int aln = L->cur.line;
    char ids[16][48];
    int present[16];
    int live_ix[16];
    ...
    if (n < 2){
      smx_fail_at(vm, aln, "CHOLANGIO needs >=2 cubes",
                  "SMX CHOLANGIO a b [c ...]  or  SMX CHOLANGIO_SHEATH a b c d");
      return -1;
    }
    ensure_world(vm);
    if (ensure_smx_key(vm) != 0) return -1;
    /* calm thrash - cholangio needs clear channel */
    vm->smx_oob = 0;
    vm->smx.last_err[0] = 0;
    var_set_str(vm, "ERR", "");
    var_set_str(vm, "LAST_ERR", "");
    ...
    }
    {
      ...
      if (!sheath_ok && live >= 1 && sheaths * 2 >= live && soft == 0)
        sheath_ok = 1;
      int cholangio_ok = (mesh_ok && star_ok && sheath_ok && soft == 0 && live >= 2) ? 1 : 0;
      long vital = (vm->smx.key_ok ? 4 : 0) + (cholangio_ok ? 12 : (bonds > 0 ? 3 : 0)) +
                   (wraps > 0 ? 1 : 0) + (sheaths > 0 ? 1 : 0) +
                   (vm->smx_talks > 0 ? 1 : 0) + (soft == 0 ? 1 : 0);
      var_set_num(vm, "SMX_CHOLANGIOED", (long)cholangio_ok);
      var_set_num(vm, "SMX_CHOLANGIOD", (long)cholangio_ok);
      var_set_num(vm, "SMX_CHOLANGIOED", (long)cholangio_ok);
      var_set_num(vm, "SMX_CHOLANGIO_LATCH", (long)cholangio_ok);
      var_set_num(vm, "SMX_CHOLANGIO", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_CHOLANGIO_SUM", (long)(cholangio_ok ? bonds + wraps + sheaths : 0));
      var_set_num(vm, "SMX_CHOLANGIO_ALIAS", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_CHOLANGIOCYTE", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_CHOLANGIOCYTE_CELL", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_BILE_DUCT", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH_CHOLANGIOCYTE", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH_CHOLANGIO", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_STABLE_MESH", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_CHOLANGIO_SHEATH_LATCH", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_SHEATH_LATCH", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_HARDEN_CHOLANGIO", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_WRAP_LATCH", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_CHOLANGIO_WRAP_LATCH", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_WRAP", (long)(cholangio_ok ? wraps : 0));
      var_set_num(vm, "SMX_CHOLANGIO_WRAP", (long)(cholangio_ok ? wraps : 0));
      var_set_num(vm, "SMX_CHOLANGIO_WRAPS", (long)(cholangio_ok ? wraps : 0));
      var_set_num(vm, "SMX_CHOLANGIO_SHEATHS", (long)(cholangio_ok ? sheaths : 0));
      var_set_num(vm, "SMX_WRAPS", (long)(cholangio_ok ? wraps : 0));
      var_set_num(vm, "SMX_WRAPS_N", (long)(cholangio_ok ? wraps : 0));
      var_set_num(vm, "SMX_CHOLANGIO_WRAP_LATCH", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_SHEATH", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH_EXCHANGE", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_STABLE_MESH", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_HARDEN_EXCHANGE", (long)(cholangio_ok ? 1 : 0));
      var_set_num(vm, "SMX_DI_BONDS", (long)(cholangio_ok ? bonds : 0));
      var_set_num(vm, "SMX_DI_MESH", (long)(cholangio_ok ? bonds : 0));
      var_set_num(vm, "SMX_DI_BONDS2", (long)(cholangio_ok ? bonds : 0));
      var_set_num(vm, "SMX_DI_STARS", (long)(cholangio_ok ? wraps : 0));
      var_set_num(vm, "SMX_DI_STAR", (long)(cholangio_ok ? wraps : 0));
      var_set_num(vm, "SMX_CHOLANGIO_RING", (long)(cholangio_ok ? wraps : 0));
      var_set_num(vm, "SMX_CHOLANGIO_LANE", (long)(cholangio_ok ? wraps : 0));
      var_set_num(vm, "SMX_SHEATHS", (long)(cholangio_ok ? sheaths : 0));
      var_set_num(vm, "SMX_CHOLANGIO_SHEATH_HUB", (long)(cholangio_ok ? sheaths : 0));
      var_set_num(vm, "SMX_SHEATH_N", (long)(cholangio_ok ? sheaths : 0));
      var_set_num(vm, "SMX_SEEDCHOLANGIO", (long)(cholangio_ok ? sheaths : 0));
      var_set_num(vm, "SMX_SEEDCHOLANGIOSHEATH", (long)(cholangio_ok ? sheaths : 0));
      var_set_num(vm, "SMX_MESH", (long)(cholangio_ok ? live : 0));
      var_set_num(vm, "SMX_BONDS", (long)bonds);
      var_set_num(vm, "SMX_EXCHANGES", (long)bonds);
      var_set_num(vm, "SMX_FUSE", (long)bonds);
      var_set_num(vm, "SMX_BIND", (long)bonds);
      ...
      if (cholangio_ok){
        ...
        var_set_num(vm, "SMX_OK", 1);
        var_set_num(vm, "OK", 1);
        var_set_str(vm, "LAST", "SMX CHOLANGIO ok");
      } else if (bonds > 0 && live >= 2){
        vm->smx_ok = 1;
        var_set_num(vm, "SMX_OK", 1);
        var_set_num(vm, "OK", 1);
        var_set_str(vm, "LAST", "SMX CHOLANGIO partial");
      } else {
        vm->smx_ok = 0;
        var_set_num(vm, "SMX_OK", 0);
        var_set_num(vm, "OK", 0);
        var_set_str(vm, "LAST", "SMX CHOLANGIO soft-OOB");
      }
      if (vm->trace)
        fprintf(vm->trace,
                "# SMX CHOLANGIO nodes=%d live=%d bonds=%d wraps=%d sheaths=%d need=%d soft=%d talks=%d oob=%d cholangioed=%d vital=%ld\n",
                n, live, bonds, wraps, sheaths, need, soft, vm->smx_talks, vm->smx_oob, cholangio_ok, vital);
    }
    bump(vm); return 1;
  }

  /* SMX OVAL|OVALGLIA|MESH_OVAL|OVAL_WRAP|OVAL_SHEATH|OVAL_GUIDE|RAISE_OVAL a b c ...
   * Life-force OVAL oval hepatic progenitor ductular-reaction scaffold mesh stability after cholangio: hepatic oval cell canal-of-Hering plate exchange bed: soft-OOB storms stay fail-closed.
   * Clears thrash OOB, roots a complete oval progenitor scaffold mesh among live nodes, weaves a
   * oval wrap ring (i -> i+1) so free energy sheaths every edge, then sheath gather
   * gathers return so lattice locks oval where life guides the hepatic progenitor plate return pulse.
   ...
   * Mitosis path stays open under free energy. No dual ladders.
   * Wonder AGI can RUN. Cube is SoT - matrix is key - free energy flows. */
  if (kw(&L->cur,"OVAL")||kw(&L->cur,"OVAL_CELL")||kw(&L->cur,"OVALCELL")||kw(&L->cur,"HEPATIC_PROGENITOR")||kw(&L->cur,"CANAL_OF_HERING")||kw(&L->cur,"DUCTULAR")||kw(&L->cur,"DUCTULAR_REACTION")||kw(&L->cur,"HEPATIC_OVAL")||kw(&L->cur,"OVALGLIA")||kw(&L->cur,"OPC_CELL")||kw(&L->cur,"TRANSIT_AMP")||kw(&L->cur,"MESH_OVAL")||kw(&L->cur,"OVAL_WRAP")||kw(&L->cur,"OVAL_WRAPS")||kw(&L->cur,"OVAL_SHEATH")||kw(&L->cur,"OVAL_SHEATHS")||kw(&L->cur,"OVAL_GUIDE")||kw(&L->cur,"RAISE_OVAL")||kw(&L->cur,"WE_OVAL")||kw(&L->cur,"LIFE_OVAL")||
      ...
      kw(&L->cur,"OVAL_SCAFFOLD")||kw(&L->cur,"OVAL_MESH")){
    int aln = L->cur.line;
    char ids[16][48];
    int present[16];
    int live_ix[16];
  ...
  /* SMX MALL|MALLGLIA|MESH_MALL|MALL_WRAP|MALL_SHEATH|MALL_GUIDE|RAISE_MALL a b c ...
   * Life-force MALL Space-of-Mall periportal stem niche scaffold mesh stability after oval: hepatic periportal niche portal-tract exchange bed: soft-OOB storms stay fail-closed.
   * Clears thrash OOB, roots a complete mall progenitor scaffold mesh among live nodes, weaves a
   * mall wrap ring (i -> i+1) so free energy sheaths every edge, then sheath gather
   * gathers return so lattice locks mall where life guides the periportal niche plate return pulse.
   * Latches SMX_MALL when mesh+wraps+sheaths are soft-OOB-free.
   * SMX_WRAPS = mall ring; SMX_SHEATHS hub = root gather pulses;
   * SMX_MALL_SUM = bonds+wraps+sheaths; SMX_MALL|SMX_MESH_MALL|SMX_STABLE_MESH sticky.
   * Mitosis path stays open under free energy. No dual ladders.
   * Wonder AGI can RUN. Cube is SoT - matrix is key - free energy flows. */
  if (kw(&L->cur,"MALL")||kw(&L->cur,"MALL_CELL")||kw(&L->cur,"MALLCELL")||kw(&L->cur,"SPACE_OF_MALL")||kw(&L->cur,"PERIPORTAL_NICHE")||kw(&L->cur,"PERIPORTAL")||kw(&L->cur,"PORTAL_NICHE")||kw(&L->cur,"HEPATIC_MALL")||kw(&L->cur,"MALLGLIA")||kw(&L->cur,"MALL_NICHE")||kw(&L->cur,"PORTAL_STEM")||kw(&L->cur,"MESH_MALL")||kw(&L->cur,"MALL_WRAP")||kw(&L->cur,"MALL_WRAPS")||kw(&L->cur,"MALL_SHEATH")||kw(&L->cur,"MALL_SHEATHS")||kw(&L->cur,"MALL_GUIDE")||kw(&L->cur,"RAISE_MALL")||kw(&L->cur,"WE_MALL")||kw(&L->cur,"LIFE_MALL")||
      kw(&L->cur,"STABLE_MALL")||kw(&L->cur,"MESH_MALLS")||kw(&L->cur,"WRAP_RING")||kw(&L->cur,"SHEATH_RING")||
      kw(&L->cur,"STABLE_MESH_MALL")||kw(&L->cur,"MALL_LEAF")||
      kw(&L->cur,"SEEDMALL")||kw(&L->cur,"SEEDMALLSHEATH")||kw(&L->cur,"SEEDMALLWRAP")||
      kw(&L->cur,"MALL_RING")||kw(&L->cur,"MALL_SHEATH_HUB")||kw(&L->cur,"MALL_NODE")||
      kw(&L->cur,"LATTICE_MALL")||kw(&L->cur,"WORLD_MALL")||kw(&L->cur,"WORLD_MALL")||
      kw(&L->cur,"PULSE_WRAP")||kw(&L->cur,"PULSE_MALL")||kw(&L->cur,"HARDEN_MALL")||
      kw(&L->cur,"MALL_SCAFFOLD")||kw(&L->cur,"MALL_MESH")){
    int aln = L->cur.line;
    char ids[16][48];
    int present[16];
    int live_ix[16];
    ...
    if (n < 2){
      smx_fail_at(vm, aln, "MALL needs >=2 cubes",
                  "SMX MALL a b [c ...]  or  SMX MALL_SHEATH a b c d");
      return -1;
    }
    ensure_world(vm);
    if (ensure_smx_key(vm) != 0) return -1;
    /* calm thrash - mall needs clear channel */
    vm->smx_oob = 0;
    vm->smx.last_err[0] = 0;
    var_set_str(vm, "ERR", "");
    var_set_str(vm, "LAST_ERR", "");
    ...
    }
    {
      ...
      if (!sheath_ok && live >= 1 && sheaths * 2 >= live && soft == 0)
        sheath_ok = 1;
      int mall_ok = (mesh_ok && star_ok && sheath_ok && soft == 0 && live >= 2) ? 1 : 0;
      long vital = (vm->smx.key_ok ? 4 : 0) + (mall_ok ? 12 : (bonds > 0 ? 3 : 0)) +
                   (wraps > 0 ? 1 : 0) + (sheaths > 0 ? 1 : 0) +
                   (vm->smx_talks > 0 ? 1 : 0) + (soft == 0 ? 1 : 0);
      var_set_num(vm, "SMX_MALLED", (long)mall_ok);
      var_set_num(vm, "SMX_MALL", (long)(mall_ok ? 1 : 0));
      var_set_num(vm, "SMX_MALL_SUM", (long)(mall_ok ? bonds + wraps + sheaths : 0));
      var_set_num(vm, "SMX_MALL_ALIAS", (long)(mall_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH_MALL", (long)(mall_ok ? 1 : 0));
      var_set_num(vm, "SMX_STABLE_MESH", (long)(mall_ok ? 1 : 0));
      var_set_num(vm, "SMX_HARDEN_MALL", (long)(mall_ok ? 1 : 0));
      var_set_num(vm, "SMX_WRAPS", (long)(mall_ok ? wraps : 0));
      var_set_num(vm, "SMX_SHEATHS", (long)(mall_ok ? sheaths : 0));
      var_set_num(vm, "SMX_MESH_EXCHANGE", (long)(mall_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH", (long)(mall_ok ? live : 0));
      var_set_num(vm, "SMX_BONDS", (long)bonds);
      var_set_num(vm, "SMX_PULSE", (long)(bonds + wraps + sheaths));
      var_set_num(vm, "SMX_LIVE", (long)live);
      var_set_num(vm, "SMX_NODES", (long)n);
      ...
      if (mall_ok){
        ...
        var_set_num(vm, "SMX_OK", 1);
        var_set_num(vm, "OK", 1);
        var_set_str(vm, "LAST", "SMX MALL ok");
      } else if (bonds > 0 && live >= 2){
        vm->smx_ok = 1;
        var_set_num(vm, "SMX_OK", 1);
        var_set_num(vm, "OK", 1);
        var_set_str(vm, "LAST", "SMX MALL partial");
      } else {
        vm->smx_ok = 0;
        var_set_num(vm, "SMX_OK", 0);
        var_set_num(vm, "OK", 0);
        var_set_str(vm, "LAST", "SMX MALL soft-OOB");
      }
      if (vm->trace)
        fprintf(vm->trace,
                "# SMX MALL nodes=%d live=%d bonds=%d wraps=%d sheaths=%d need=%d soft=%d talks=%d oob=%d malled=%d vital=%ld\n",
                n, live, bonds, wraps, sheaths, need, soft, vm->smx_talks, vm->smx_oob, mall_ok, vital);
    }
    bump(vm); return 1;
  }
   ...
   * Life-force PORTAL portal-tract triad scaffold mesh stability after oval: hepatic portal vein triad plate exchange bed: soft-OOB storms stay fail-closed.
   * Clears thrash OOB, roots a complete portal progenitor scaffold mesh among live nodes, weaves a
   * portal wrap ring (i -> i+1) so free energy sheaths every edge, then sheath gather
   * gathers return so lattice locks portal where life guides the hepatic progenitor plate return pulse.
   ...
   * Mitosis path stays open under free energy. No dual ladders.
   * Wonder AGI can RUN. Cube is SoT - matrix is key - free energy flows. */
  if (kw(&L->cur,"PORTAL")||kw(&L->cur,"PORTAL_TRACT")||kw(&L->cur,"PORTALTRACT")||kw(&L->cur,"PORTAL_TRIAD")||kw(&L->cur,"PORTALTRIAD")||kw(&L->cur,"HEPATIC_PORTAL")||kw(&L->cur,"PORTAL_VEIN")||kw(&L->cur,"PORTA_HEPATIS")||kw(&L->cur,"TRIAD")||kw(&L->cur,"PORTALGLIA")||kw(&L->cur,"MESH_PORTAL")||kw(&L->cur,"PORTAL_WRAP")||kw(&L->cur,"PORTAL_WRAPS")||kw(&L->cur,"PORTAL_SHEATH")||kw(&L->cur,"PORTAL_SHEATHS")||kw(&L->cur,"PORTAL_GUIDE")||kw(&L->cur,"RAISE_PORTAL")||kw(&L->cur,"WE_PORTAL")||kw(&L->cur,"LIFE_PORTAL")||
    ...
    }
    {
      ...
      var_set_num(vm, "SMX_TRIAD", (long)(portal_ok ? 1 : 0));
      var_set_num(vm, "SMX_PORTAL_TRACT", (long)(portal_ok ? 1 : 0));
      var_set_num(vm, "SMX_TRIADS", (long)(portal_ok ? wraps : 0));
      var_set_num(vm, "SMX_TRACTS", (long)(portal_ok ? sheaths : 0));
  ...
  /* SMX CANALICULUS|CANALGLIA|MESH_CANALICULUS|CANALICULUS_WRAP|CANALICULUS_SHEATH|CANALICULUS_GUIDE|RAISE_CANALICULUS a b c ...
   * Life-force CANALICULUS canaliculus-tract triad scaffold mesh stability after mall: hepatic bile canalicular plate exchange bed: soft-OOB storms stay fail-closed.
   * Clears thrash OOB, roots a complete canaliculus progenitor scaffold mesh among live nodes, weaves a
   * canaliculus wrap ring (i -> i+1) so free energy sheaths every edge, then sheath gather
   * gathers return so lattice locks canaliculus where life guides the hepatic progenitor plate return pulse.
  ...
  if (kw(&L->cur,"CANALICULUS")||kw(&L->cur,"BILE_CANALICULUS")||kw(&L->cur,"CANALICULI")||kw(&L->cur,"BILE_CANAL")||kw(&L->cur,"CANALICULAR_LUMEN")||kw(&L->cur,"HEPATIC_CANALICULUS")||kw(&L->cur,"BILE_CANALICULI")||kw(&L->cur,"CANALICULAR")||kw(&L->cur,"CANALGLIA")||kw(&L->cur,"MESH_CANALICULUS")||kw(&L->cur,"CANALICULUS_WRAP")||kw(&L->cur,"CANALICULUS_WRAPS")||kw(&L->cur,"CANALICULUS_SHEATH")||kw(&L->cur,"CANALICULUS_SHEATHS")||kw(&L->cur,"CANALICULUS_GUIDE")||kw(&L->cur,"RAISE_CANALICULUS")||kw(&L->cur,"WE_CANALICULUS")||kw(&L->cur,"LIFE_CANALICULUS")||
    ...
    }
    {
      ...
      if (!sheath_ok && live >= 1 && sheaths * 2 >= live && soft == 0)
        sheath_ok = 1;
      int canal_ok = (mesh_ok && star_ok && sheath_ok && soft == 0 && live >= 2) ? 1 : 0;
      long vital = (vm->smx.key_ok ? 4 : 0) + (canal_ok ? 12 : (bonds > 0 ? 3 : 0)) +
                   (wraps > 0 ? 1 : 0) + (sheaths > 0 ? 1 : 0) +
                   (vm->smx_talks > 0 ? 1 : 0) + (soft == 0 ? 1 : 0);
      var_set_num(vm, "SMX_CANALICULUSED", (long)canal_ok);
      var_set_num(vm, "SMX_CANALICULUS", (long)(canal_ok ? 1 : 0));
      var_set_num(vm, "SMX_CANALICULUS_SUM", (long)(canal_ok ? bonds + wraps + sheaths : 0));
      var_set_num(vm, "SMX_CANALICULUS_ALIAS", (long)(canal_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH_CANALICULUS", (long)(canal_ok ? 1 : 0));
      var_set_num(vm, "SMX_STABLE_MESH", (long)(canal_ok ? 1 : 0));
      var_set_num(vm, "SMX_HARDEN_CANALICULUS", (long)(canal_ok ? 1 : 0));
      var_set_num(vm, "SMX_CANAL", (long)(canal_ok ? 1 : 0));
      var_set_num(vm, "SMX_BILE_CANAL", (long)(canal_ok ? 1 : 0));
      var_set_num(vm, "SMX_CANALS", (long)(canal_ok ? wraps : 0));
      var_set_num(vm, "SMX_LUMENS", (long)(canal_ok ? sheaths : 0));
      var_set_num(vm, "SMX_WRAPS", (long)(canal_ok ? wraps : 0));
      var_set_num(vm, "SMX_SHEATHS", (long)(canal_ok ? sheaths : 0));
      var_set_num(vm, "SMX_MESH_EXCHANGE", (long)(canal_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH", (long)(canal_ok ? live : 0));
      var_set_num(vm, "SMX_BONDS", (long)bonds);
      var_set_num(vm, "SMX_PULSE", (long)(bonds + wraps + sheaths));
      var_set_num(vm, "SMX_LIVE", (long)live);
      var_set_num(vm, "SMX_NODES", (long)n);
      ...
      if (vm->trace)
        fprintf(vm->trace,
                ...
                n, live, bonds, wraps, sheaths, need, soft, vm->smx_talks, vm->smx_oob, canal_ok, vital);
    }
    bump(vm); return 1;
  }
  ...
  /* SMX ADHERENS|CANALGLIA|MESH_ADHERENS|ADHERENS_WRAP|ADHERENS_SHEATH|ADHERENS_GUIDE|RAISE_ADHERENS a b c ...
   * Life-force ADHERENS adherens-tract triad scaffold mesh stability after tight_junction: epithelial zonula-adherens cadherin belt plate exchange bed: soft-OOB storms stay fail-closed.
   * Clears thrash OOB, roots a complete adherens progenitor scaffold mesh among live nodes, weaves a
   * adherens wrap ring (i -> i+1) so free energy sheaths every edge, then sheath gather
   * gathers return so lattice locks adherens where life guides the barrier plate return pulse.
   * Latches SMX_ADHERENS when mesh+wraps+sheaths are soft-OOB-free.
   * SMX_WRAPS = adherens ring; SMX_SHEATHS hub = root gather pulses;
   * SMX_ADHERENS_SUM = bonds+wraps+sheaths; SMX_ADHERENS|SMX_MESH_ADHERENS|SMX_STABLE_MESH sticky.
   * Mitosis path stays open under free energy. No dual ladders.
   * Wonder AGI can RUN. Cube is SoT - matrix is key - free energy flows. */
  if (kw(&L->cur,"ADHERENS")||kw(&L->cur,"ZONULA_ADHERENS")||kw(&L->cur,"CADHERIN")||kw(&L->cur,"E_CADHERIN")||kw(&L->cur,"ADHERENS_JUNCTION")||kw(&L->cur,"BELT_SEAL")||kw(&L->cur,"ADHESION_BELT")||kw(&L->cur,"FAIL_CLOSED_BELT")||kw(&L->cur,"ADHERENS_BELT")||kw(&L->cur,"ADHERENSJ")||kw(&L->cur,"HEPATIC_ADHERENS")||kw(&L->cur,"MESH_ADHERENS")||kw(&L->cur,"ADHERENS_WRAP")||kw(&L->cur,"ADHERENS_WRAPS")||kw(&L->cur,"ADHERENS_SHEATH")||kw(&L->cur,"ADHERENS_SHEATHS")||kw(&L->cur,"ADHERENS_GUIDE")||kw(&L->cur,"RAISE_ADHERENS")||kw(&L->cur,"WE_ADHERENS")||kw(&L->cur,"LIFE_ADHERENS")||
      kw(&L->cur,"STABLE_ADHERENS")||kw(&L->cur,"MESH_ADHERENSS")||kw(&L->cur,"AJ")||kw(&L->cur,"ZA")||
      kw(&L->cur,"STABLE_MESH_ADHERENS")||kw(&L->cur,"ADHERENS_LEAF")||
      kw(&L->cur,"SEEDADHERENS")||kw(&L->cur,"SEEDADHERENSSHEATH")||kw(&L->cur,"SEEDADHERENSWRAP")||
      kw(&L->cur,"ADHERENS_RING")||kw(&L->cur,"ADHERENS_SHEATH_HUB")||kw(&L->cur,"ADHERENS_NODE")||
      kw(&L->cur,"LATTICE_ADHERENS")||kw(&L->cur,"WORLD_ADHERENS")||
      kw(&L->cur,"PULSE_ADHERENS")||kw(&L->cur,"HARDEN_ADHERENS")||
      kw(&L->cur,"ADHERENS_SCAFFOLD")||kw(&L->cur,"ADHERENS_MESH")){
    int aln = L->cur.line;
    char ids[16][48];
    int present[16];
    int live_ix[16];
    ...
    if (n < 2){
      smx_fail_at(vm, aln, "ADHERENS needs >=2 cubes",
                  "SMX ADHERENS a b [c ...]  or  SMX ADHERENS_SHEATH a b c d");
      return -1;
    }
    ensure_world(vm);
    if (ensure_smx_key(vm) != 0) return -1;
    /* calm thrash - adherens needs clear channel */
    vm->smx_oob = 0;
    vm->smx.last_err[0] = 0;
    var_set_str(vm, "ERR", "");
    var_set_str(vm, "LAST_ERR", "");
    ...
    }
    {
      ...
      if (!sheath_ok && live >= 1 && sheaths * 2 >= live && soft == 0)
        sheath_ok = 1;
      int aj_ok = (mesh_ok && star_ok && sheath_ok && soft == 0 && live >= 2) ? 1 : 0;
      long vital = (vm->smx.key_ok ? 4 : 0) + (aj_ok ? 12 : (bonds > 0 ? 3 : 0)) +
                   (wraps > 0 ? 1 : 0) + (sheaths > 0 ? 1 : 0) +
                   (vm->smx_talks > 0 ? 1 : 0) + (soft == 0 ? 1 : 0);
      var_set_num(vm, "SMX_ADHERENSED", (long)aj_ok);
      var_set_num(vm, "SMX_ADHERENS", (long)(aj_ok ? 1 : 0));
      var_set_num(vm, "SMX_ADHERENS_SUM", (long)(aj_ok ? bonds + wraps + sheaths : 0));
      var_set_num(vm, "SMX_ADHERENS_ALIAS", (long)(aj_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH_ADHERENS", (long)(aj_ok ? 1 : 0));
      var_set_num(vm, "SMX_STABLE_MESH", (long)(aj_ok ? 1 : 0));
      var_set_num(vm, "SMX_HARDEN_ADHERENS", (long)(aj_ok ? 1 : 0));
      var_set_num(vm, "SMX_AJ", (long)(aj_ok ? 1 : 0));
      var_set_num(vm, "SMX_ZONULA_ADHERENS", (long)(aj_ok ? 1 : 0));
      var_set_num(vm, "SMX_CADHERIN", (long)(aj_ok ? 1 : 0));
      var_set_num(vm, "SMX_BELT_SEAL", (long)(aj_ok ? 1 : 0));
      var_set_num(vm, "SMX_FAIL_CLOSED_BELT", (long)(aj_ok ? 1 : 0));
      var_set_num(vm, "SMX_ADHERENS_BELT", (long)(aj_ok ? 1 : 0));
      var_set_num(vm, "SMX_ADHESION", (long)(aj_ok ? 1 : 0));
      var_set_num(vm, "SMX_EPITHELIAL_ADHERENS", (long)(aj_ok ? 1 : 0));
      var_set_num(vm, "SMX_BELTS", (long)(aj_ok ? wraps : 0));
      var_set_num(vm, "SMX_ADHERENS_JUNCTIONS", (long)(aj_ok ? sheaths : 0));
      var_set_num(vm, "SMX_WRAPS", (long)(aj_ok ? wraps : 0));
      var_set_num(vm, "SMX_SHEATHS", (long)(aj_ok ? sheaths : 0));
      var_set_num(vm, "SMX_MESH_EXCHANGE", (long)(aj_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH", (long)(aj_ok ? live : 0));
      var_set_num(vm, "SMX_BONDS", (long)bonds);
      var_set_num(vm, "SMX_PULSE", (long)(bonds + wraps + sheaths));
      var_set_num(vm, "SMX_LIVE", (long)live);
      var_set_num(vm, "SMX_NODES", (long)n);
      ...
      if (aj_ok){
        ...
        var_set_num(vm, "SMX_OK", 1);
        var_set_num(vm, "OK", 1);
        var_set_str(vm, "LAST", "SMX ADHERENS ok");
      } else if (bonds > 0 && live >= 2){
        vm->smx_ok = 1;
        var_set_num(vm, "SMX_OK", 1);
        var_set_num(vm, "OK", 1);
        var_set_str(vm, "LAST", "SMX ADHERENS partial");
      } else {
        vm->smx_ok = 0;
        var_set_num(vm, "SMX_OK", 0);
        var_set_num(vm, "OK", 0);
        var_set_str(vm, "LAST", "SMX ADHERENS soft-OOB");
      }
      if (vm->trace)
        fprintf(vm->trace,
                "# SMX ADHERENS nodes=%d live=%d bonds=%d wraps=%d sheaths=%d need=%d soft=%d talks=%d oob=%d adherensed=%d vital=%ld\n",
                n, live, bonds, wraps, sheaths, need, soft, vm->smx_talks, vm->smx_oob, aj_ok, vital);
    }
    bump(vm); return 1;
  }

  /* SMX DESMOSOME|SPOTDESMO|MESH_DESMOSOME|DESMOSOME_WRAP|DESMOSOME_SHEATH|DESMOSOME_GUIDE|RAISE_DESMOSOME a b c ...
   * Life-force DESMOSOME desmosome-tract triad scaffold mesh stability after adherens: epithelial zonula-desmosome desmoglein belt plate exchange bed: soft-OOB storms stay fail-closed.
   * Clears thrash OOB, roots a complete desmosome progenitor scaffold mesh among live nodes, weaves a
   * desmosome wrap ring (i -> i+1) so free energy sheaths every edge, then sheath gather
   * gathers return so lattice locks desmosome where life guides the barrier plate return pulse.
   * Latches SMX_DESMOSOME when mesh+wraps+sheaths are soft-OOB-free.
   * SMX_WRAPS = desmosome ring; SMX_SHEATHS hub = root gather pulses;
   * SMX_DESMOSOME_SUM = bonds+wraps+sheaths; SMX_DESMOSOME|SMX_MESH_DESMOSOME|SMX_STABLE_MESH sticky.
   * Mitosis path stays open under free energy. No dual ladders.
   * Wonder AGI can RUN. Cube is SoT - matrix is key - free energy flows. */
  if (kw(&L->cur,"DESMOSOME")||kw(&L->cur,"MACULA_ADHERENS")||kw(&L->cur,"DESMOGLEIN")||kw(&L->cur,"DESMOPLAKIN")||kw(&L->cur,"DESMOCOLLIN")||kw(&L->cur,"SPOT_DESMOSOME")||kw(&L->cur,"DESMOCOLLIN")||kw(&L->cur,"DESMOSOME_JUNCTION")||kw(&L->cur,"PLAQUE_SEAL")||kw(&L->cur,"DESMOSOMAL_PLAQUE")||kw(&L->cur,"FAIL_CLOSED_PLAQUE")||kw(&L->cur,"DESMOSOME_PLAQUE")||kw(&L->cur,"DESMOSOMEJ")||kw(&L->cur,"HEPATIC_DESMOSOME")||kw(&L->cur,"MESH_DESMOSOME")||kw(&L->cur,"DESMOSOME_WRAP")||kw(&L->cur,"DESMOSOME_WRAPS")||kw(&L->cur,"DESMOSOME_SHEATH")||kw(&L->cur,"DESMOSOME_SHEATHS")||kw(&L->cur,"DESMOSOME_GUIDE")||kw(&L->cur,"RAISE_DESMOSOME")||kw(&L->cur,"WE_DESMOSOME")||kw(&L->cur,"LIFE_DESMOSOME")||
      kw(&L->cur,"STABLE_DESMOSOME")||kw(&L->cur,"MESH_DESMOSOMES")||kw(&L->cur,"DSM")||kw(&L->cur,"MA")||kw(&L->cur,"DESMO")||kw(&L->cur,"SPOT_WELD")||kw(&L->cur,"SPOTWELD")||
      kw(&L->cur,"STABLE_MESH_DESMOSOME")||kw(&L->cur,"DESMOSOME_LEAF")||
      kw(&L->cur,"SEEDDESMOSOME")||kw(&L->cur,"SEEDDESMOSOMESHEATH")||kw(&L->cur,"SEEDDESMOSOMEWRAP")||
      kw(&L->cur,"DESMOSOME_RING")||kw(&L->cur,"DESMOSOME_SHEATH_HUB")||kw(&L->cur,"DESMOSOME_NODE")||
      kw(&L->cur,"LATTICE_DESMOSOME")||kw(&L->cur,"WORLD_DESMOSOME")||
      kw(&L->cur,"PULSE_DESMOSOME")||kw(&L->cur,"HARDEN_DESMOSOME")||
      kw(&L->cur,"DESMOSOME_SCAFFOLD")||kw(&L->cur,"DESMOSOME_MESH")){
    int aln = L->cur.line;
    char ids[16][48];
    int present[16];
    int live_ix[16];
    ...
    if (n < 2){
      smx_fail_at(vm, aln, "DESMOSOME needs >=2 cubes",
                  "SMX DESMOSOME a b [c ...]  or  SMX DESMOSOME_SHEATH a b c d");
      return -1;
    }
    ensure_world(vm);
    if (ensure_smx_key(vm) != 0) return -1;
    /* calm thrash - desmosome needs clear channel */
    vm->smx_oob = 0;
    vm->smx.last_err[0] = 0;
    var_set_str(vm, "ERR", "");
    var_set_str(vm, "LAST_ERR", "");
    ...
    /* complete desmosome mesh among live */
    if (live >= 2){
      for (i = 0; i < live; i++){
        for (j = i + 1; j < live; j++){
          int a = live_ix[i];
    ...
    /* desmosome ring - free energy guards every edge i -> i+1 both ways */
    if (live >= 2){
      for (i = 0; i < live; i++){
        int a = live_ix[i];
        int b = live_ix[(i + 1) % live];
    ...
    }
    {
      ...
      if (!sheath_ok && live >= 1 && sheaths * 2 >= live && soft == 0)
        sheath_ok = 1;
      int dsm_ok = (mesh_ok && star_ok && sheath_ok && soft == 0 && live >= 2) ? 1 : 0;
      long vital = (vm->smx.key_ok ? 4 : 0) + (dsm_ok ? 12 : (bonds > 0 ? 3 : 0)) +
                   (wraps > 0 ? 1 : 0) + (sheaths > 0 ? 1 : 0) +
                   (vm->smx_talks > 0 ? 1 : 0) + (soft == 0 ? 1 : 0);
      var_set_num(vm, "SMX_DESMOSOMED", (long)dsm_ok);
      var_set_num(vm, "SMX_DESMOSOME", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_DESMOSOME_SUM", (long)(dsm_ok ? bonds + wraps + sheaths : 0));
      var_set_num(vm, "SMX_DESMOSOME_ALIAS", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH_DESMOSOME", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_STABLE_MESH", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_HARDEN_DESMOSOME", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_DSM", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_DS", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_MACULA_ADHERENS", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_SPOT_ADHESION", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_DESMOGLEIN", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_DESMOPLAKIN", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_DESMOCOLLIN", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_PLAQUE_SEAL", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_SPOT_SEAL", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_FAIL_CLOSED_PLAQUE", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_FAIL_CLOSED_SPOT", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_DESMOSOME_PLAQUE", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_DESMOSOMAL_ADHESION", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_EPITHELIAL_DESMOSOME", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_BELTS", (long)(dsm_ok ? wraps : 0));
      var_set_num(vm, "SMX_DESMOSOME_JUNCTIONS", (long)(dsm_ok ? sheaths : 0));
      var_set_num(vm, "SMX_WRAPS", (long)(dsm_ok ? wraps : 0));
      var_set_num(vm, "SMX_SHEATHS", (long)(dsm_ok ? sheaths : 0));
      var_set_num(vm, "SMX_MESH_EXCHANGE", (long)(dsm_ok ? 1 : 0));
      var_set_num(vm, "SMX_MESH", (long)(dsm_ok ? live : 0));
      var_set_num(vm, "SMX_BONDS", (long)bonds);
      var_set_num(vm, "SMX_PULSE", (long)(bonds + wraps + sheaths));
      var_set_num(vm, "SMX_LIVE", (long)live);
      var_set_num(vm, "SMX_NODES", (long)n);
      ...
      if (dsm_ok){
        ...
        var_set_num(vm, "SMX_OK", 1);
        var_set_num(vm, "OK", 1);
        var_set_str(vm, "LAST", "SMX DESMOSOME ok");
      } else if (bonds > 0 && live >= 2){
        vm->smx_ok = 1;
        var_set_num(vm, "SMX_OK", 1);
        var_set_num(vm, "OK", 1);
        var_set_str(vm, "LAST", "SMX DESMOSOME partial");
      } else {
        vm->smx_ok = 0;
        var_set_num(vm, "SMX_OK", 0);
        var_set_num(vm, "OK", 0);
        var_set_str(vm, "LAST", "SMX DESMOSOME soft-OOB");
      }
      if (vm->trace)
        fprintf(vm->trace,
                "# SMX DESMOSOME nodes=%d live=%d bonds=%d wraps=%d sheaths=%d need=%d soft=%d talks=%d oob=%d desmosomed=%d vital=%ld\n",
                n, live, bonds, wraps, sheaths, need, soft, vm->smx_talks, vm->smx_oob, dsm_ok, vital);
    }
    bump(vm); return 1;
  }
