...
LDFLAGS ?= -lm -lpthread
SRC = src/cubalc_main.c src/cubalc_core.c src/cubalc_algocube.c src/cubalc_smx.c \
      src/cubalc_cubechain.c src/cubalc_hw.c src/cubalc_lang.c src/cubalc_translate.c \
      src/cubalc_hostops.c src/cubalc_async.c src/cubalc_isa.c src/cubalc_jit.c
HDR = include/cubalc.h include/cubalc_law.h include/cubalc_algocube.h include/cubalc_smx.h \
