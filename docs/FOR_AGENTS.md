...
# STATUS/VARS expose vars_n · vars_max (256) · vars_full — fat boards no silent special drops
...
CUBALC_INCLUDE_PATH=$PWD/mylibs cubalc libs             # catalog + include_path origin
```
