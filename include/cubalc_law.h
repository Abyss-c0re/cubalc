...
#define CUBALC_SMX_F_SOFT_OOB       0x20u  /* soft out-of-band mesh heal */
#define CUBALC_SMX_LIFE_FLOOR      0.35f /* mesh life-force unity floor */
#define CUBALC_SMX_OOB_MAX_GAP     8u    /* max seq gap soft-healed */
...
#define CUBALC_LANG_VERSION "1.5.4-smx-mesh-exchange"
